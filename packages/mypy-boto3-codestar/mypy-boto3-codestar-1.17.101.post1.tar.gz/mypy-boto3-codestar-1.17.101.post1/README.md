...
[boto3.CodeStar 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codestar.html#CodeStar)
...
def get_structure() -> AssociateTeamMemberRequestTypeDef:
    return {
      ...
    }
```
