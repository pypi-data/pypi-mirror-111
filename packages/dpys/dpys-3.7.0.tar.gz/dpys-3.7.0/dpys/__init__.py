...
class rr():
    ...
    async def display(ctx, dir):
        ...
        if number > 0:
            if limit:
                embed.set_footer(text=f"Total Reaction Roles | {number} | One of the reaction roles exceeded Discord's limit. It will still work as normal but all of the data will not be displayed.")
            else:
