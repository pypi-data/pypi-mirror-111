...
class WellsByIds(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True
...
class WellboresByIds(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True
...
class WellIngestion(WellsBaseModel):
    ...
    wellhead: Wellhead
    kb_elevation: Optional[DoubleWithUnit] = Field(None, alias="kbElevation")
    source: AssetSource
...
class WellboreIngestion(WellsBaseModel):
    ...
    name: str
    description: Optional[str] = None
    well_external_id: str = Field(..., alias="wellExternalId", description="Name of the well parent of this wellbore")
    parent_wellbore_external_id: Optional[str] = Field(
        None,
        alias="parentWellboreExternalId",
        description="If this wellbore is below another wellbore, type that out here",
    )
    source: AssetSource
...
class NPT(WellsBaseModel):
    ...
    wellbore_external_id: str = Field(
        ...,
        alias="wellboreExternalId",
        description="parent external Id (either well external id or wellbore external id).",
    )
...
class NPTIngestion(WellsBaseModel):
    ...
    wellbore_external_id: str = Field(
        ...,
        alias="wellboreExternalId",
        description="The CDF External Id of the well bore where the event happened, if any",
    )
    npt_code: Optional[str] = Field(
        None, alias="nptCode", description="The NPT code to identify event.", example="ijiefe3:3463:npt"
    )
...
class Filter(WellsBaseModel):
    ...
    wellbore_external_ids: Optional[List[str]] = Field(None, alias="wellboreExternalIds")
...
class NDS(WellsBaseModel):
    ...
    well_bore_external_id: Optional[str] = Field(None, alias="wellBoreExternalId")
...
class NDSIngestion(WellsBaseModel):
    ...
    wellbore_external_id: str = Field(
        ...,
        alias="wellboreExternalId",
        description="The CDF external id of the wellbore associated with the NDS event, if any",
    )
    source: EventSource
    description: Optional[str] = Field(
        None, description="Textual description of the event.", example="REAM OUT TIGHT HOLE"
...
class Trajectory(WellsBaseModel):
    ...
    external_id: str = Field(..., alias="externalId")
    wellbore_external_id: str = Field(..., alias="wellboreExternalId")
