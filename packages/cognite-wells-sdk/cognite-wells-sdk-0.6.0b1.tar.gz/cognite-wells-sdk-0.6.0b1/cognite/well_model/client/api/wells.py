...
class WellsAPI(BaseAPI):
    def __init__(self, client: APIClient, wellbores_api: WellboresAPI):
        ...
        def wellbores(well) -> WellboreList:
            return self.wellbores_api.retrieve_by_well(well.id)
    ...
    def list(
        ...
        def request(cursor):
            ...
            response: Response = self.client.post(url_path=path, json=well_filter.json(), params={"cursor": cursor})
