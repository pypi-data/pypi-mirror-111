...
# from cognite.well_model.client.api.events import EventsAPI
...
class CogniteWellsClient:
    ...
    def __init__(
        ...
        self.wells = WellsAPI(client=self._api_client, wellbores_api=self.wellbores)
        # self.events = EventsAPI(wells_client=self._api_client)
