...
class EKSClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client)
    ...
    def associate_encryption_config(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.associate_encryption_config)
    ...
    def associate_identity_provider_config(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.associate_identity_provider_config)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.can_paginate)
    ...
    def create_addon(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.create_addon)
    ...
    def create_cluster(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.create_cluster)
    ...
    def create_fargate_profile(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.create_fargate_profile)
    ...
    def create_nodegroup(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.create_nodegroup)
    ...
    def delete_addon(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.delete_addon)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_eks/client.html#delete_addon)
        """

    def delete_cluster(self, *, name: str) -> DeleteClusterResponseResponseTypeDef:
        """
        Deletes the Amazon EKS cluster control plane.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.delete_cluster)
    ...
    def delete_fargate_profile(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.delete_fargate_profile)
    ...
    def delete_nodegroup(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.delete_nodegroup)
    ...
    def describe_addon(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.describe_addon)
    ...
    def describe_addon_versions(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.describe_addon_versions)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_eks/client.html#describe_addon_versions)
        """

    def describe_cluster(self, *, name: str) -> DescribeClusterResponseResponseTypeDef:
        """
        Returns descriptive information about an Amazon EKS cluster.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.describe_cluster)
    ...
    def describe_fargate_profile(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.describe_fargate_profile)
    ...
    def describe_identity_provider_config(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.describe_identity_provider_config)
    ...
    def describe_nodegroup(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.describe_nodegroup)
    ...
    def describe_update(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.describe_update)
    ...
    def disassociate_identity_provider_config(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.disassociate_identity_provider_config)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.generate_presigned_url)
    ...
    def list_addons(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.list_addons)
    ...
    def list_clusters(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.list_clusters)
    ...
    def list_fargate_profiles(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.list_fargate_profiles)
    ...
    def list_identity_provider_configs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.list_identity_provider_configs)
    ...
    def list_nodegroups(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.list_nodegroups)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.list_tags_for_resource)
    ...
    def list_updates(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.list_updates)
    ...
    def tag_resource(self, *, resourceArn: str, tags: Dict[str, str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.tag_resource)
    ...
    def untag_resource(self, *, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.untag_resource)
    ...
    def update_addon(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.update_addon)
    ...
    def update_cluster_config(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.update_cluster_config)
    ...
    def update_cluster_version(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.update_cluster_version)
    ...
    def update_nodegroup_config(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.update_nodegroup_config)
    ...
    def update_nodegroup_version(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Client.update_nodegroup_version)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Paginator.DescribeAddonVersions)
    ...
    def get_paginator(self, operation_name: Literal["list_addons"]) -> ListAddonsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Paginator.ListAddons)
    ...
    def get_paginator(self, operation_name: Literal["list_clusters"]) -> ListClustersPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Paginator.ListClusters)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Paginator.ListFargateProfiles)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Paginator.ListIdentityProviderConfigs)
    ...
    def get_paginator(self, operation_name: Literal["list_nodegroups"]) -> ListNodegroupsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Paginator.ListNodegroups)
    ...
    def get_paginator(self, operation_name: Literal["list_updates"]) -> ListUpdatesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Paginator.ListUpdates)
    ...
    def get_waiter(self, waiter_name: Literal["addon_active"]) -> AddonActiveWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Waiter.AddonActive)
    ...
    def get_waiter(self, waiter_name: Literal["addon_deleted"]) -> AddonDeletedWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Waiter.AddonDeleted)
    ...
    def get_waiter(self, waiter_name: Literal["cluster_active"]) -> ClusterActiveWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Waiter.ClusterActive)
    ...
    def get_waiter(self, waiter_name: Literal["cluster_deleted"]) -> ClusterDeletedWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Waiter.ClusterDeleted)
    ...
    def get_waiter(self, waiter_name: Literal["nodegroup_active"]) -> NodegroupActiveWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Waiter.NodegroupActive)
    ...
    def get_waiter(self, waiter_name: Literal["nodegroup_deleted"]) -> NodegroupDeletedWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/eks.html#EKS.Waiter.NodegroupDeleted)
