...
HOLMES_VERSION_TUPLE = (SYNC_DATE,
                        PATCH_VERSION)
HOLMES_VERSION_STR = f"{SYNC_DATE}.{CORE_VERSION_STR}p{PATCH_VERSION} " \
                     f"(HolmesV)"
...
class VersionManager:
    ...
    def get():
        ...
        return {"coreVersion": HOLMES_VERSION_STR, "enclosureVersion": None}
...
def check_version(version_string):
    ...
    """
    version_tuple = tuple(map(int,
                              version_string.split("p")[0].split(".")[1:]))
