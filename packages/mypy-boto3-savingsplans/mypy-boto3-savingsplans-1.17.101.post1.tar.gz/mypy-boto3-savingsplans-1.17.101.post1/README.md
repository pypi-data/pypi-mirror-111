...
[boto3.SavingsPlans 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/savingsplans.html#SavingsPlans)
...
def get_structure() -> CreateSavingsPlanRequestTypeDef:
    return {
      ...
    }
```
