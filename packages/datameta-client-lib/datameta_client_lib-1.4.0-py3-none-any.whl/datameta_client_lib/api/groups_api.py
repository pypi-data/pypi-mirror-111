...
class GroupsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __group_information_request(
            self,
            id,
            **kwargs
        ):
            ...
            >>> thread = api.group_information_request(id, async_req=True)
            >>> result = thread.get()
        ...
        self.group_information_request = _Endpoint(
            settings={
                ...
                'endpoint_path': '/groups/{id}',
                'operation_id': 'group_information_request',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__group_information_request
        )
