...
from aws_cdk_lib.aws_ecr_assets import DockerImageAsset
...
[wchaws/cdk-ecr-deployment](https://github.com/wchaws/cdk-ecr-deployment), which is able to replicate an image asset from the CDK-controlled ECR repository to a repository of
your choice.

Here an example from the [wchaws/cdk-ecr-deployment](https://github.com/wchaws/cdk-ecr-deployment) project:
