...
class CfnAlias(
    ...
    class AliasRoutingConfigurationProperty:
        def __init__(
            self,
            *,
            additional_version_weights: typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnAlias.VersionWeightProperty", _IResolvable_a771d0ef]]],
        ) -> None:
            '''
...
class CfnEventSourceMapping(
    ...
    def __init__(
        ...
        *,
        ...
        source_access_configurations: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnEventSourceMapping.SourceAccessConfigurationProperty", _IResolvable_a771d0ef]]]] = None,
