...
```python
# Example automatically generated without compilation. See https://github.com/aws/jsii/issues/826
from aws_cdk_lib.aws_appsync import GraphqlType
...
def generate_edge_and_connection(self, base):
...
class CfnGraphQLApi(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        additional_authentication_providers: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnGraphQLApi.AdditionalAuthenticationProviderProperty", _IResolvable_a771d0ef]]]] = None,
...
class ElasticsearchDataSource(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(ElasticsearchDataSource, self, [scope, id, props])
