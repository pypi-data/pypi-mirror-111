...
class BundlingDockerImage(
    ...
    def from_asset(
        ...
        *,
        ...
        :param platform: (experimental) Set platform if server is multi-platform capable. *Requires Docker Engine API v1.38+*. Default: - no platform specified
    ...
    def run(
        ...
        *,
        ...
        :param security_opt: (experimental) `Security configuration <https://docs.docker.com/engine/reference/run/#security-configuration>`_ when running the docker container. Default: - no secutiy options
...
class DockerBuildOptions:
    ...
    def platform(self) -> typing.Optional[builtins.str]:
        '''(experimental) Set platform if server is multi-platform capable.
