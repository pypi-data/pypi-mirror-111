...
class CfnGeofenceCollection(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CfnGeofenceCollection, self, [scope, id, props])
...
class CfnMap(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        configuration: typing.Union["CfnMap.MapConfigurationProperty", _IResolvable_a771d0ef],
        ...
        jsii.create(CfnMap, self, [scope, id, props])
...
class CfnPlaceIndex(
    ...
    def __init__(
        ...
        *,
        ...
        pricing_plan: builtins.str,
        data_source_configuration: typing.Optional[typing.Union["CfnPlaceIndex.DataSourceConfigurationProperty", _IResolvable_a771d0ef]] = None,
        description: typing.Optional[builtins.str] = None,
    ) -> None:
        ...
        jsii.create(CfnPlaceIndex, self, [scope, id, props])
...
class CfnRouteCalculator(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CfnRouteCalculator, self, [scope, id, props])
...
class CfnTracker(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CfnTracker, self, [scope, id, props])
...
class CfnTrackerConsumer(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CfnTrackerConsumer, self, [scope, id, props])
