...
from aws_cdk import Construct, Stage, Stack, StackProps, StageProps
from aws_cdk_lib.pipelines import CdkPipeline
...
class AssetPublishingCommand:
    def __init__(
        ...
        *,
        ...
        :param asset_publishing_role_arn: (experimental) ARN of the IAM Role used to publish this asset.
    ...
    def asset_publishing_role_arn(self) -> builtins.str:
        '''(experimental) ARN of the IAM Role used to publish this asset.
...
class CdkPipeline(
    ...
    def __init__(
        ...
        *,
        ...
        :param asset_pre_install_commands: (experimental) Additional commands to run before installing cdk-assets during the asset publishing step Use this to setup proxies or npm mirrors. Default: -
        ...
        :param single_publisher_per_type: (experimental) Whether this pipeline creates one asset upload action per asset type or one asset upload per asset. Default: false
...
class PublishAssetsAction(
    ...
    def __init__(
        ...
        *,
        ...
        :param create_buildspec_file: (experimental) Use a file buildspec written to the cloud assembly instead of an inline buildspec. This prevents size limitation errors as inline specs have a max length of 25600 characters Default: false
        :param pre_install_commands: (experimental) Additional commands to run before installing cdk-assert Use this to setup proxies or npm mirrors. Default: -
...
class ShellScriptAction(
    ...
    def __init__(
        ...
        *,
        ...
        :param environment: (experimental) The CodeBuild environment where scripts are executed. Default: LinuxBuildImage.STANDARD_5_0
...
class SimpleSynthAction(
    ...
    def __init__(
        ...
        *,
        ...
        :param environment: (experimental) Build environment to use for CodeBuild job. Default: BuildEnvironment.LinuxBuildImage.STANDARD_5_0
        :param environment_variables: (experimental) Environment variables to send into build. NOTE: You may run into the 1000-character limit for the Action configuration if you have a large number of variables or if their names or values are very long. If you do, pass them to the underlying CodeBuild project directly in ``environment`` instead. However, you will not be able to use CodePipeline Variables in this case. Default: - No additional environment variables
        :param project_name: (experimental) Name of the CodeBuild project. Default: - Automatically generated
...
class UpdatePipelineAction(
    ...
    def __init__(
        ...
        *,
        ...
        :param id: -
        :param cloud_assembly_input: (experimental) The CodePipeline artifact that holds the Cloud Assembly.
        :param pipeline_stack_hierarchical_id: (experimental) Hierarchical id of the pipeline stack.
        :param cdk_cli_version: (experimental) Version of CDK CLI to 'npm install'. Default: - Latest version
        :param pipeline_stack_name: (deprecated) Name of the pipeline stack. Default: - none
        :param privileged: (experimental) Whether the build step should run in privileged mode. Default: - false
        :param project_name: (experimental) Name of the CodeBuild project. Default: - Automatically generated
...
class UpdatePipelineActionProps:
    ...
    def pipeline_stack_hierarchical_id(self) -> builtins.str:
        '''(experimental) Hierarchical id of the pipeline stack.
    ...
    def privileged(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Whether the build step should run in privileged mode.
