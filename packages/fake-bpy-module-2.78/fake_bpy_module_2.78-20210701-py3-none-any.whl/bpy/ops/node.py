...
def add_and_link_node(
        settings: typing.
        Union[typing.Dict[str, 'bpy.types.NodeSetting'], typing.
              List['bpy.types.NodeSetting'], 'bpy_prop_collection'] = None,
        type: str = "",
    ...
    :type settings: typing.Union[typing.Dict[str, 'bpy.types.NodeSetting'], typing.List['bpy.types.NodeSetting'], 'bpy_prop_collection']
...
def collapse_hide_unused_toggle():
    ''' Toggle collapsed nodes and hide unused sockets :file: startup/bl_operators/node.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/node.py> _:262
...
def tree_path_parent():
    ''' Go to parent node tree :file: startup/bl_operators/node.py <https://developer.blender.org/diffusion/B/browse/master/release/scripts/ /startup/bl_operators/node.py> _:292
