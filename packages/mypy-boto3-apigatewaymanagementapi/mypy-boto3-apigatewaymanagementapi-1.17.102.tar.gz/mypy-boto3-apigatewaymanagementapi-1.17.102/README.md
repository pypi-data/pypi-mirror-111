...
[boto3.ApiGatewayManagementApi 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi)
...
def get_structure() -> DeleteConnectionRequestTypeDef:
    return {
      ...
    }
```
