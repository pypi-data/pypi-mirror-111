    ...
    """
{
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-lambda-nodejs>=1.104.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.104.0, <2.0.0",
        "aws-cdk.core>=1.104.0, <2.0.0",
        "aws-cdk.custom-resources>=1.104.0, <2.0.0",
