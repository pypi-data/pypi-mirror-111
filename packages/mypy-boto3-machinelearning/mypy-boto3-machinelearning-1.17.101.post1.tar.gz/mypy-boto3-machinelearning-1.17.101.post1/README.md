...
[boto3.MachineLearning 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/machinelearning.html#MachineLearning)
...
def get_structure() -> AddTagsInputTypeDef:
    return {
      ...
    }
```
