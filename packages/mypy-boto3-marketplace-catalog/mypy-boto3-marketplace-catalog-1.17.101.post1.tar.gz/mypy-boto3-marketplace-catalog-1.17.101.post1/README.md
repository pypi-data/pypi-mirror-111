...
[boto3.MarketplaceCatalog 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/marketplace-catalog.html#MarketplaceCatalog)
...
def get_structure() -> CancelChangeSetRequestTypeDef:
    return {
      ...
    }
```
