...
[boto3.TimestreamWrite 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/timestream-write.html#TimestreamWrite)
...
def get_structure() -> CreateDatabaseRequestTypeDef:
    return {
      ...
    }
```
