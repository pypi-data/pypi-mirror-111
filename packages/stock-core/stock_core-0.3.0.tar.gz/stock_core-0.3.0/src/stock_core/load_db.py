...
from stock_core.nfscrapy import scraper
...
class MI:
    ...
    <<구조>>
    데이터베이스 - mi
    컬렉션 - aud, chf, gbond3y, gold, kosdaq, kospi, sp500, usdkrw, wti, avgper, yieldgap, silver
    도큐멘트 - date, value
    """
    col_list = ('aud', 'chf', 'gbond3y', 'gold', 'silver', 'kosdaq', 'kospi', 'sp500', 'usdkrw', 'wti', 'avgper', 'yieldgap')
