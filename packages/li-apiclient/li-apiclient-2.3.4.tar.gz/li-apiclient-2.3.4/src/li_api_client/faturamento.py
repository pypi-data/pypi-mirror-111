...
class ApiFaturamento(ApiClientBase):
    ...
    def plano_vigente_api(self, chave_api, **kwargs):
        path = '/contas/{}/plano/vigente/api'.format(chave_api)
        return self.to_dict(path, method="get", meta=True, **kwargs)
    ...
    def simular_proximo_ciclo(self, conta_id, plano_id, **kwargs):
        path = '/contas/{}/planos/{}/simular_proximo_ciclo/?months={}&discount={}'.format(conta_id, plano_id, kwargs.get('months', '1'), kwargs.get('discount', '0'))
        return self.to_dict(path, method="get", meta=True)

    def assinar(self, conta_id, plano_id, method="post", **kwargs):
        path = '/contas/{}/planos/{}/assinar/?months={}&discount={}'.format(conta_id, plano_id, kwargs.get('months', '1'), kwargs.get('discount', '0'))
