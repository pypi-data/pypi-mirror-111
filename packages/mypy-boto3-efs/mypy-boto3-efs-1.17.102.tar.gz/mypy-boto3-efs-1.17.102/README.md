...
[boto3.EFS 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/efs.html#EFS)
...
def get_structure() -> AccessPointDescriptionResponseTypeDef:
    return {
      ...
    }
```
