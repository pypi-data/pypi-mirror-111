...
import subprocess, os, sys, shutil, signal, logging, copy, json
...
def run(epid, compose_name, items=None, anchors=None, clean=False, object_mods=None, jobpath=None, dont_track=None):
