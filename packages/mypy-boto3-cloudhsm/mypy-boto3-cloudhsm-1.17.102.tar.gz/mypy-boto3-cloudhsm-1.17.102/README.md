...
[boto3.CloudHSM 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/cloudhsm.html#CloudHSM)
...
def get_structure() -> AddTagsToResourceRequestTypeDef:
    return {
      ...
    }
```
