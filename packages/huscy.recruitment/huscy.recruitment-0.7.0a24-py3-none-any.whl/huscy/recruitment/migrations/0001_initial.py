    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute_filterset', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='participationrequests', to='recruitment.attributefilterset')),
            ],
        ),
        migrations.CreateModel(
            name='SubjectGroup',
