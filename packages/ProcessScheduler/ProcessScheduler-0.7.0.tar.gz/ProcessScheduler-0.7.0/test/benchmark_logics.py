...
all_logics = ["QF_LRA", "HORN", "QF_LIA", "QF_RDL", "QF_IDL", "QF_AUFLIA",
              "QF_ALIA", "QF_AUFLIRA", "QF_AUFNIA", "QF_AUFNIRA",
              "QF_ANIA", "QF_LIRA", "QF_UFLIA", "QF_UFLRA",
              "QF_UFIDL", "QF_UFRDL",
              "QF_NIRA", "QF_UFNRA", "QF_UFNIA", "QF_UFNIRA",
              "QF_S",
              "QF_SLIA", "UFIDL", "HORN", "QF_FPLRA"]
              # skipped: "QF_NIA",
...
def get_problem():
    ...
    ts_team_migration = [ps.FixedDurationTask('DevTeam_%i' % (i + 1), duration=1, priority=i%3+1) for i in range(num_dev_teams)]
...
for logics in all_logics:
    ...
    solver = ps.SchedulingSolver(digital_transformation, logics=logics, random_seed=False ,parallel=False, max_time=20)
