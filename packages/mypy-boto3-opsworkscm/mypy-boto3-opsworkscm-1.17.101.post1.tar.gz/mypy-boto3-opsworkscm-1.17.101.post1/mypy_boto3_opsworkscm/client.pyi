...
class OpsWorksCMClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client)
    ...
    def associate_node(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.associate_node)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.can_paginate)
    ...
    def create_backup(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.create_backup)
    ...
    def create_server(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.create_server)
    ...
    def delete_backup(self, *, BackupId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.delete_backup)
    ...
    def delete_server(self, *, ServerName: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.delete_server)
    ...
    def describe_account_attributes(self) -> DescribeAccountAttributesResponseResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.describe_account_attributes)
    ...
    def describe_backups(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.describe_backups)
    ...
    def describe_events(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.describe_events)
    ...
    def describe_node_association_status(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.describe_node_association_status)
    ...
    def describe_servers(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.describe_servers)
    ...
    def disassociate_node(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.disassociate_node)
    ...
    def export_server_engine_attribute(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.export_server_engine_attribute)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.generate_presigned_url)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.list_tags_for_resource)
    ...
    def restore_server(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.restore_server)
    ...
    def start_maintenance(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.start_maintenance)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: List["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.untag_resource)
    ...
    def update_server(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.update_server)
    ...
    def update_server_engine_attributes(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Client.update_server_engine_attributes)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Paginator.DescribeBackups)
    ...
    def get_paginator(self, operation_name: Literal["describe_events"]) -> DescribeEventsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Paginator.DescribeEvents)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Paginator.DescribeServers)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Paginator.ListTagsForResource)
    ...
    def get_waiter(self, waiter_name: Literal["node_associated"]) -> NodeAssociatedWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/opsworkscm.html#OpsWorksCM.Waiter.NodeAssociated)
