...
[boto3.GuardDuty 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/guardduty.html#GuardDuty)
...
def get_structure() -> AcceptInvitationRequestTypeDef:
    return {
      ...
    }
```
