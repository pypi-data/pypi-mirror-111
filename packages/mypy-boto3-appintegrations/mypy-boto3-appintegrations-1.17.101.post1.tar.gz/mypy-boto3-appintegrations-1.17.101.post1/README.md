...
[boto3.AppIntegrationsService 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/appintegrations.html#AppIntegrationsService)
...
def get_structure() -> CreateEventIntegrationRequestTypeDef:
    return {
      ...
    }
```
