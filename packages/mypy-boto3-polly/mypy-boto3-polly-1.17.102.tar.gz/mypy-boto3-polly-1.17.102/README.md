...
[boto3.Polly 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/polly.html#Polly)
...
def get_structure() -> DeleteLexiconInputTypeDef:
    return {
      ...
    }
```
