...
class StatusException(RsInstrException):
	...
	def __init__(self, rsrc_name: str, message: str, first_error: Exception = None):
...
def get_instrument_status_errors(rsrc_name: str, errors: list, context: str = '') -> str or None:
...
def assert_no_instrument_status_errors(rsrc_name: str, errors: list, context: str = '', first_error=None) -> None:
	...
	if msg:
		raise StatusException(rsrc_name, msg, first_error=first_error)
