...
from minerl_patched.data.util.constants import (
    MERGED_DIR,
    BLACKLIST_TXT,
    PARSE_COMMAND,
    Z7_COMMAND,
...
from minerl_patched.data.util.constants import OUTPUT_DIR as WORKING_DIR
from minerl_patched.data.util.constants import DOWNLOAD_DIR as DOWNLOADED_DIR
