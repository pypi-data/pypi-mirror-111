from minerl_patched.data.data_pipeline import DataPipeline
from minerl_patched.data.download import download
import os

from minerl_patched.data.version import DATA_VERSION, FILE_PREFIX, VERSION_FILE_NAME

import minerl_patched.data.version
...
def make(environment=None, data_dir=None, num_workers=4, worker_batch_size=32, minimum_size_to_dequeue=32,
    ...
    minerl_patched.data.version.assert_version(data_dir)
