...
from minerl_patched.viewer import get_parser
from minerl_patched.viewer.trajectory_display_controller import TrajectoryDisplayController
...
def main(opts):
    ...
    data = minerl_patched.data.make(opts.environment)
