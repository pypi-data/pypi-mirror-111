...
import json
import logging
from minerl_patched.env.comms import retry
from minerl_patched.env.exceptions import MissionInitException
import os
from minerl_patched.herobraine.wrapper import EnvWrapper
import struct
from minerl_patched.env.malmo import InstanceManager, MinecraftInstance, launch_queue_logger_thread, malmo_version
import uuid
import coloredlogs
import gym
import re
...
from minerl_patched.env import comms
import xmltodict
from concurrent.futures import ThreadPoolExecutor

from minerl_patched.herobraine.env_spec import EnvSpec
...
class _MultiAgentEnv(gym.Env):
    ...
    USE ENV SPEC.
        ...
        Example:
            ...
            literal blocks::
                ...
                env = gym.make('MineRLTreechop-v0') # Makes a minerl_patched environment.
    ...
    def make_interactive(self, port, max_players=10, realtime=True):
        ...
        and then run the `minerl_patched.interactor.`
        ...
        .. code-block:: bash
            ...
            python3 -m minerl_patched.interactor 6666 # replace with the port above.
    ...
    def _renderObs(self, obs, ac=None):
        ...
        for agent in self.task.agent_names:
            if agent not in self.viewers:
                from minerl_patched.viewer.trajectory_display import HumanTrajectoryDisplay, VectorTrajectoryDisplay
