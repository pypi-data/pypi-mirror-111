...
[boto3.MediaStoreData 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/mediastore-data.html#MediaStoreData)
...
def get_structure() -> DeleteObjectRequestTypeDef:
    return {
      ...
    }
```
