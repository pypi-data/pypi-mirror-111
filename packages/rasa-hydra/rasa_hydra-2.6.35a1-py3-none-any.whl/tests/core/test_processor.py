...
async def test_default_redaction_1(default_processor: MessageProcessor):
    from rasa.core.trackers import DialogueStateTracker
    ...
    assert logged_event.text_redacted == "****************"

async def test_default_redaction_2(default_processor: MessageProcessor):
    from rasa.core.trackers import DialogueStateTracker
...
async def test_default_redaction_3(default_processor: MessageProcessor):
    from rasa.core.trackers import DialogueStateTracker
