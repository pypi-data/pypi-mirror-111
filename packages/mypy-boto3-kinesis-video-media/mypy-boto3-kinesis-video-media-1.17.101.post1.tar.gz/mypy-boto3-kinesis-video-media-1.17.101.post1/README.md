...
[boto3.KinesisVideoMedia 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/kinesis-video-media.html#KinesisVideoMedia)
...
def get_structure() -> GetMediaInputTypeDef:
    return {
      ...
    }
```
