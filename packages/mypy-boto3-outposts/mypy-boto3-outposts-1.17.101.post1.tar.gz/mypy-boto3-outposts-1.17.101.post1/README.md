...
[boto3.Outposts 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/outposts.html#Outposts)
...
def get_structure() -> CreateOutpostInputTypeDef:
    return {
      ...
    }
```
