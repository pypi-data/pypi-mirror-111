...
class DLL_EXPORT not_initialized_exception : public std::runtime_error
{
public:
    not_initialized_exception() : std::runtime_error("SPARSE_STATUS_NOT_INITIALIZED") {}
};

class DLL_EXPORT allocation_failed_exception : public std::runtime_error
{
public:
    allocation_failed_exception() : std::runtime_error("SPARSE_STATUS_ALLOC_FAILED") {}
};

class DLL_EXPORT invalid_value_exception : public std::runtime_error
{
public:
    invalid_value_exception() : std::runtime_error("SPARSE_STATUS_INVALID_VALUE") {}
};

class DLL_EXPORT execution_failed_exception : public std::runtime_error
{
public:
    execution_failed_exception() : std::runtime_error("SPARSE_STATUS_EXECUTION_FAILED") {}
};

class DLL_EXPORT internal_error_exception : public std::runtime_error
{
public:
    internal_error_exception() : std::runtime_error("SPARSE_STATUS_INTERNAL_ERROR") {}
};

class DLL_EXPORT not_supported_exception : public std::runtime_error
{
public:
...
DLL_EXPORT void release_matrix_handle(matrix_handle_t *handle,
...
DLL_EXPORT void optimize_gemv(cl::sycl::queue &queue, transpose transpose_flag, matrix_handle_t handle);

DLL_EXPORT cl::sycl::event optimize_gemv(cl::sycl::queue &queue,
                              transpose transpose_flag,
                              matrix_handle_t handle,
                              const cl::sycl::vector_class<cl::sycl::event> &dependencies);
...
DLL_EXPORT cl::sycl::event optimize_trmv(cl::sycl::queue &queue,
                              uplo uplo_flag,
                              transpose transpose_flag,
                              diag diag_val,
                              matrix_handle_t handle,
...
DLL_EXPORT cl::sycl::event optimize_trsv(cl::sycl::queue &queue,
                              uplo uplo_flag,
                              transpose transpose_flag,
                              diag diag_val,
                              matrix_handle_t handle,
...
DLL_EXPORT cl::sycl::event gemvdot(cl::sycl::queue &queue,
                        transpose transpose_flag,
                        const float alpha,
                        matrix_handle_t handle,
                        float *x,
