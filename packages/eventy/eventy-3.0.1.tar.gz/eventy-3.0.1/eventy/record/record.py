...
class Record(ABC):
    ...
    def __init__(
        ...
        :param trace_id: Trace / correlation ID for trace_id. Default: auto-generated
        ...
        self.trace_id = trace_id  # type: ignore
    ...
    def __repr__(self):
        return f"{self.type} {self.schema} v{self.version} uuid={self.uuid} trace_id={self.trace_id} key={self.partition_key}"
