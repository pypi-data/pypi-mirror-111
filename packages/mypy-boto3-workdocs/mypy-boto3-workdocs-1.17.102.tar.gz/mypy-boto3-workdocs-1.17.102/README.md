...
[boto3.WorkDocs 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/workdocs.html#WorkDocs)
...
def get_structure() -> AbortDocumentVersionUploadRequestTypeDef:
    return {
      ...
    }
```
