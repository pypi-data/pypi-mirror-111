...
class BackupClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.can_paginate)
    ...
    def create_backup_plan(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.create_backup_plan)
    ...
    def create_backup_selection(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.create_backup_selection)
    ...
    def create_backup_vault(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.create_backup_vault)
    ...
    def delete_backup_plan(self, *, BackupPlanId: str) -> DeleteBackupPlanOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.delete_backup_plan)
    ...
    def delete_backup_selection(self, *, BackupPlanId: str, SelectionId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.delete_backup_selection)
    ...
    def delete_backup_vault(self, *, BackupVaultName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.delete_backup_vault)
    ...
    def delete_backup_vault_access_policy(self, *, BackupVaultName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.delete_backup_vault_access_policy)
    ...
    def delete_backup_vault_notifications(self, *, BackupVaultName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.delete_backup_vault_notifications)
    ...
    def delete_recovery_point(self, *, BackupVaultName: str, RecoveryPointArn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.delete_recovery_point)
    ...
    def describe_backup_job(self, *, BackupJobId: str) -> DescribeBackupJobOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.describe_backup_job)
    ...
    def describe_backup_vault(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.describe_backup_vault)
    ...
    def describe_copy_job(self, *, CopyJobId: str) -> DescribeCopyJobOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.describe_copy_job)
    ...
    def describe_global_settings(self) -> DescribeGlobalSettingsOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.describe_global_settings)
    ...
    def describe_protected_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.describe_protected_resource)
    ...
    def describe_recovery_point(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.describe_recovery_point)
    ...
    def describe_region_settings(self) -> DescribeRegionSettingsOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.describe_region_settings)
    ...
    def describe_restore_job(self, *, RestoreJobId: str) -> DescribeRestoreJobOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.describe_restore_job)
    ...
    def disassociate_recovery_point(self, *, BackupVaultName: str, RecoveryPointArn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.disassociate_recovery_point)
    ...
    def export_backup_plan_template(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.export_backup_plan_template)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.generate_presigned_url)
    ...
    def get_backup_plan(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.get_backup_plan)
    ...
    def get_backup_plan_from_json(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.get_backup_plan_from_json)
    ...
    def get_backup_plan_from_template(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.get_backup_plan_from_template)
    ...
    def get_backup_selection(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.get_backup_selection)
    ...
    def get_backup_vault_access_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.get_backup_vault_access_policy)
    ...
    def get_backup_vault_notifications(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.get_backup_vault_notifications)
    ...
    def get_recovery_point_restore_metadata(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.get_recovery_point_restore_metadata)
    ...
    def get_supported_resource_types(self) -> GetSupportedResourceTypesOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.get_supported_resource_types)
    ...
    def list_backup_jobs(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_backup_jobs)
    ...
    def list_backup_plan_templates(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_backup_plan_templates)
    ...
    def list_backup_plan_versions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_backup_plan_versions)
    ...
    def list_backup_plans(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_backup_plans)
    ...
    def list_backup_selections(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_backup_selections)
    ...
    def list_backup_vaults(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_backup_vaults)
    ...
    def list_copy_jobs(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_copy_jobs)
    ...
    def list_protected_resources(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_protected_resources)
    ...
    def list_recovery_points_by_backup_vault(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_recovery_points_by_backup_vault)
    ...
    def list_recovery_points_by_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_recovery_points_by_resource)
    ...
    def list_restore_jobs(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_restore_jobs)
    ...
    def list_tags(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.list_tags)
    ...
    def put_backup_vault_access_policy(self, *, BackupVaultName: str, Policy: str = None) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.put_backup_vault_access_policy)
    ...
    def put_backup_vault_notifications(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.put_backup_vault_notifications)
    ...
    def start_backup_job(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.start_backup_job)
    ...
    def start_copy_job(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.start_copy_job)
    ...
    def start_restore_job(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.start_restore_job)
    ...
    def stop_backup_job(self, *, BackupJobId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.stop_backup_job)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: Dict[str, str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeyList: List[str]) -> None:
        ...
        **Request Syntax** response = client.untag_reso...
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.untag_resource)
    ...
    def update_backup_plan(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.update_backup_plan)
    ...
    def update_global_settings(self, *, GlobalSettings: Dict[str, str] = None) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.update_global_settings)
    ...
    def update_recovery_point_lifecycle(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.update_recovery_point_lifecycle)
    ...
    def update_region_settings(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/backup.html#Backup.Client.update_region_settings)
