...
from script_client.common.common_method import save_script,upload_script,get_tree
...
class GetTreeHandler(tornado.web.RequestHandler):
    def post(self):
        try:
            d = {'tree':get_tree()}
            print(d)
