...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.31.1-alpha.1625163309+b4bdb269'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.31.1-alpha.1625163309+b4bdb269`
                """)
            else:
                raise
