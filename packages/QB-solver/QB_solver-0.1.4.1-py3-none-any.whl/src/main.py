...
cube_menu_model = Entity(model=load_model(name='cubetest'), color=color.rgb(200, 200, 200, 255), texture="Models/RubiksTex", shader=lit_with_shadows_shader, scale=(2,2,2), position = (0,2))
