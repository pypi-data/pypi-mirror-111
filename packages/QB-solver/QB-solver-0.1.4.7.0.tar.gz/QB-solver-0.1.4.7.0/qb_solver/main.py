...
def updateCurrentHint(hintText, hintPicture, next_piece):
    ...
    if hintPicture != None:
        if hintPicture == 'qb_solver/hints/rotate.png' or hintPicture == 'cross-solved.png':
            hintSpecific.icon.scale = (.33, .396)
        elif hintPicture == 'qb_solver/hints/top.png':
            hintSpecific.icon.scale=(.33*2, .396*2)
        elif hintPicture == 'qb_solver/hints/middleV2.png':
            hintSpecific.icon.scale=(.33*2, .396*2)
...
resetButton = Button(text='Reset', color=color.red, scale=.1, position=(-.81, -.18, 0), on_click=Func(resetCube),
                     enabled=False)
rotateRButton = Button(text='', icon='qb_solver/Models/rotateR', color=color.white, highlight_color=color.light_gray, scale=.1, position=(-.69, .18, 0),
                       on_click=Func(rotateD), enabled=False)
rotateLButton = Button(text='', icon='qb_solver/Models/rotateL', color=color.white, highlight_color=color.light_gray, scale=.1, position=(-.81, .18, 0),
                       on_click=Func(rotateU), enabled=False)
rotateUButton = Button(text='', icon='qb_solver/Models/rotateU', color=color.white, highlight_color=color.light_gray, scale=.1, position=(-.81, .3, 0),
                       on_click=Func(rotateR), enabled=False)
rotateDButton = Button(text='', icon='qb_solver/Models/rotateD', color=color.white, highlight_color=color.light_gray, scale=.1, position=(-.69, .3, 0),
                       on_click=Func(rotateL), enabled=False)
rotateZRButton = Button(text='', icon='qb_solver/Models/rotateZL', color=color.white, highlight_color=color.light_gray, scale=.1, position=(-.69, .06, 0),
                       on_click=Func(rotateZR), enabled=False)
rotateZLButton = Button(text='', icon='qb_solver/Models/rotateZR', color=color.white, highlight_color=color.light_gray, scale=.1, position=(-.81, .06, 0),
...
# hints============
notationButton = Button(text='', text_color = color.black, icon='qb_solver/Models/ShowNotation', color=color.gray, scale=.095, position=(-.69, -.43, 0), on_click=Func(displayNotation))
hintButton = Button(text='Hints', text_color = color.black, color=color.gray, scale=.095, position=(-.81, -.43, 0), on_click=Func(openHints))
hintDisplay = Button(text='', icon='qb_solver/Models/hint1', color=color.gray, highlight_color=color.gray, pressed_color=color.gray,
...
hintDetail = Button(text='', icon='qb_solver/Models/HintDetail1', color=color.gray, highlight_color=color.gray, pressed_color=color.gray,
...
hintSpecific = Button(text='We need to flip the %s %s piece\n'       
                           ...
                           'Then perform R Di F D', icon='qb_solver/hints/flip-1', color=color.gray, highlight_color=color.gray, pressed_color=color.gray,
