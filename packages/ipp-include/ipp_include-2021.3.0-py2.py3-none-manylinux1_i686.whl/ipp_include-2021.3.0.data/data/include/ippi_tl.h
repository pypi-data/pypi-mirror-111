...
/* /////////////////////////////////////////////////////////////////////////////
//                     Median filter functions with Border
// /////////////////////////////////////////////////////////////////////////////
...
//   ippStsNumChannelsErr Indicates an error when numChannels has an illegal value.
*/
IPPAPI(IppStatus, ippiFilterMedianBorderGetBufferSize_T,(IppiSize dstRoiSize, IppiSize maskSize, IppDataType dataType, int numChannels, int* pBufferSize))
...
//   ippStsBorderErr    Indicates an error when borderType has illegal value.
*/
IPPAPI(IppStatus, ippiFilterMedianBorder_8u_C1R_T, (const Ipp8u* pSrc, int srcStep, Ipp8u* pDst, int dstStep, IppiSize dstRoiSize, IppiSize maskSize, IppiBorderType borderType, Ipp8u borderValue, Ipp8u* pBuffer))
IPPAPI(IppStatus, ippiFilterMedianBorder_8u_C3R_T, (const Ipp8u* pSrc, int srcStep, Ipp8u* pDst, int dstStep, IppiSize dstRoiSize, IppiSize maskSize, IppiBorderType borderType, Ipp8u borderValue[3], Ipp8u* pBuffer))
IPPAPI(IppStatus, ippiFilterMedianBorder_8u_AC4R_T, (const Ipp8u* pSrc, int srcStep, Ipp8u* pDst, int dstStep, IppiSize dstRoiSize, IppiSize maskSize, IppiBorderType borderType, Ipp8u borderValue[3], Ipp8u* pBuffer))
IPPAPI(IppStatus, ippiFilterMedianBorder_8u_C4R_T, (const Ipp8u* pSrc, int srcStep, Ipp8u* pDst, int dstStep, IppiSize dstRoiSize, IppiSize maskSize, IppiBorderType borderType, Ipp8u borderValue[4], Ipp8u* pBuffer))
...
IPPAPI(IppStatus, ippiFilterILSGetBufferSize_T, (IppiFilterILSType filter, IppiSize dstRoiSize, IppDataType dataType, int numChannels, int *pSpecSize, int* pBufInitSize, int *pBufferSize))
IPPAPI(IppStatus, ippiFilterILSInit_T,          (IppiFilterILSType filter, IppiSize dstRoiSize, IppDataType dataType, int numChannels, Ipp64f lambda, Ipp64f eps, Ipp64f pow, Ipp64f gamma, IppiFilterILSSpec *pSpec, Ipp8u* pBufInit))
IPPAPI(IppStatus, ippiFilterILS_8u_C1R_T,       (const Ipp8u *pSrc, int srcStep, Ipp8u *pDst, int dstStep, IppiSize dstRoiSize, int nIter, IppiFilterILSSpec *pSpec, Ipp8u* pBuffer))
IPPAPI(IppStatus, ippiFilterILS_8u_C3R_T,       (const Ipp8u *pSrc, int srcStep, Ipp8u *pDst, int dstStep, IppiSize dstRoiSize, int nIter, IppiFilterILSSpec *pSpec, Ipp8u* pBuffer))
