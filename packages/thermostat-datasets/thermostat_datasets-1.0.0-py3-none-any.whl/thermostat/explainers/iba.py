...
class IBAExplainer(ExplainerAutoModelInitializer):
    def __init__(self, model, estim: Estimator, beta=10, steps=10, lr=1, batch_size=10, progbar=False):
        ...
        self.sequential = IBASequential(self.original_layer, self.bottleneck)
        self.ce_loss = []
        self.info_loss = []
        self.total_loss = []
        self.pred = []
    ...
    def from_config(cls, config):
        ...
        res.explainer = InformationBottleneck(forward_func=res.forward_func)
        return res
