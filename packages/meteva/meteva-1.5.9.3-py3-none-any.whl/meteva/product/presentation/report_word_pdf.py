...
if __name__ == "__main__":
    ...
    traverse(path, 1, "1")
    doc_path = r'H:\task\project\department\202004-检验系统研发\doc5.doc'
    doc.save(doc_path)   
    
    output_pdf = r'H:\task\project\department\202004-检验系统研发\doc5.pdf'
    ...
    input1 = PdfFileReader(open(output_pdf,'rb'))
    ...
    print(output)
    output.write(open('./pdf_test1.pdf', 'wb'))
