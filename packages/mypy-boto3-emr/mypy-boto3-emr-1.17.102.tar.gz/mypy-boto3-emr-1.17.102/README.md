...
[boto3.EMR 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/emr.html#EMR)
...
def get_structure() -> AddInstanceFleetInputTypeDef:
    return {
      ...
    }
```
