...
[boto3.MWAA 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/mwaa.html#MWAA)
...
def get_structure() -> CreateCliTokenRequestTypeDef:
    return {
      ...
    }
```
