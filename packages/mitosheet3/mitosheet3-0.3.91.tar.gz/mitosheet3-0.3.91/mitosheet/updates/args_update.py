...
from mitosheet.steps.import_steps.simple_import import get_dataframe_names
...
def execute_args_update(
    ...
    if len(args) > 0:
        ...
        str_df_names = get_dataframe_names(str_args, [])
        ...
        wsc.curr_step['df_names'] = final_names[:len(wsc.curr_step['dfs'])]
