...
[boto3.AppRunner 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/apprunner.html#AppRunner)
...
def get_structure() -> AssociateCustomDomainRequestTypeDef:
    return {
      ...
    }
```
