...
class PhEC2Init(object):
    ...
    def init_conf():
        ...
        # 下载config.json文件
        cp_configJson_cmd = "sudo curl https://ph-platform.s3.cn-northwest-1.amazonaws.com.cn/2020-11-11/emr/remoteConfig/"+cluster_id+"/sparkmagic/config.json -o /home/hbzhao/PycharmProjects/pythonProject/phdagcommand/config.json"
