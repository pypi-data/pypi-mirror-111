...
class WebsiteResource(object):
    ...
    def search_conversations(self, website_id, page_number, search_query="", search_type="", search_operator="",
                             include_empty="", filter_unread="", filter_resolved="", filter_not_resolved="",
    ...
    def search_people_profiles(self, website_id, page_number, search_filter):
        return self.parent.get(
            self.__url_website(website_id, f"/people/profiles/{page_number}?search_filter={search_filter}")
        )
