...
[boto3.Shield 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/shield.html#Shield)
...
def get_structure() -> AssociateDRTLogBucketRequestTypeDef:
    return {
      ...
    }
```
