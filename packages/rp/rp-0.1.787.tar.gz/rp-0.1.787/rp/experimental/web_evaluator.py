...
class Client:
    ...
    def evaluate(self,code:str='',**vars):
        ...
        assert not isinstance(result,bytes),'Client.evaluate: Bad response...please make sure the server and client are running on the same version of python and rp. Result: '+str(result)[:200]
        return result
