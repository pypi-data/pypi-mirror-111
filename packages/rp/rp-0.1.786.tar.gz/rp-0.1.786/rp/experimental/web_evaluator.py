...
class Client:
    ...
    def evaluate(self,code:str,**vars):
        #TODO: Write examples: Image streaming, cyclegan, canny etc
        #
        #EXAMPLE:
        #    while True:
        ...
        assert isinstance(result,Evaluation),'Client.evaluate: Bad response...please make sure the server and client are running on the same version of python and rp'
        return result
