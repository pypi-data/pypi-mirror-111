...
alias_map_list = [
  ...
  ["profile", "profile"],
  [["profileColumns", "profile.columns"], "profile.columns"],
  [["profileStats", "profile.stats"], "profile.stats"],
  ...
  ["report", "cols.report"],
  [["selectColumns", "select", "cols.select"], "cols.select"],
  [["copyColumns", "copy", "cols.copy"], "cols.copy"],
  [["dropColumns", "drop", "cols.drop"], "cols.drop"],
  [["keepColumns", "keep", "cols.keep"], "cols.keep"],
  [["renameColumns", "cols.rename"], "cols.rename"],
  [["names", "columnNames", "columns"], "cols.names"],
  [["datatypes", "dtypes", "cols.dtypes"], "cols.dtypes"],
  ...
  [["countByDtypes", "count_by_dtypes"], "cols.count_by_dtypes"],
  ["quality", "cols.quality"],
  [
    ["inferProfilerDtypes", "infer_profiler_dtypes"],
    "cols.infer_profiler_dtypes",
  ],
  ...
  [["setColumn", "set", "cols.set"], "cols.set"],
  [["castColumn", "cast", "cols.cast"], "cols.cast"],
  [
    ["setDatatype", "setDtype", "set_dtype", "cols.set_dtype"],
    "cols.set_dtype",
  ],
  [
    ["unsetDatatype", "unsetDtype", "unset_dtype", "cols.unset_dtype"],
    "cols.unset_dtype",
  ],
