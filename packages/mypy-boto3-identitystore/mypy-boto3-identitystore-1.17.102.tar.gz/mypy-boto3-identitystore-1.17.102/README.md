...
[boto3.IdentityStore 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/identitystore.html#IdentityStore)
...
def get_structure() -> DescribeGroupRequestTypeDef:
    return {
      ...
    }
```
