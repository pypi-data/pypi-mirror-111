...
if sys.version_info < (3, 7):
    print("vectice-python requires Python 3 version >= 3.7.", file=sys.stderr)
    sys.exit(1)
...
setup(
    ...
    maintainer="Vectice Inc",
    maintainer_email="sdk@vectice.com",
    ...
    extras_require={
        ...
        "doc": ["sphinx", "recommonmark", "nbsphinx", "sphinx-rtd-theme", "pypandoc"],
    },
    classifiers=[
        "Topic :: Internet",
