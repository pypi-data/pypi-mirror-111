...
class EconomyIncreaseIndex:
    ...
    def draw_picture_CCFI(self, compare_index=None):
...
if __name__ == '__main__':
    # CurrencyIndex(end_date='20210610').draw_picture_loan(compare_index='HS300')
    ...
    # StockStyleFactor('20210501', '20210517').draw_picture_cum_return()
    ...
    BondTradingIndex('20200123', '20200615').draw_picture()