...
if __name__ == '__main__':
    # 公募样例：110011
    # res = StyleAttribution(fund_id='110011', fund_type='mutual', start_date='20181120', end_date='20210120',
    #                        factor_type='style_allo', benchmark_id='000300', nav_frequency='day').get_all(processed=False)
    # 私募样例
    # res = StyleAttribution(fund_id='110011', fund_type='mutual', start_date='20190220', end_date='20210120',
    #                        factor_type='sector', benchmark_id='000300', nav_frequency='day').get_all()
    res = StyleAttribution(fund_id='001861', fund_type='mutual', start_date='20151220', end_date='20210630',
                           factor_type='sector', benchmark_id='000985', nav_frequency='day').get_all(processed=False)
