...
[boto3.QLDB 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/qldb.html#QLDB)
...
def get_structure() -> CancelJournalKinesisStreamRequestTypeDef:
    return {
      ...
    }
```
