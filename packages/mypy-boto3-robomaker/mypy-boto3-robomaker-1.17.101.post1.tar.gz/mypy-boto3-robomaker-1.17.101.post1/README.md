...
[boto3.RoboMaker 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/robomaker.html#RoboMaker)
...
def get_structure() -> BatchDeleteWorldsRequestTypeDef:
    return {
      ...
    }
```
