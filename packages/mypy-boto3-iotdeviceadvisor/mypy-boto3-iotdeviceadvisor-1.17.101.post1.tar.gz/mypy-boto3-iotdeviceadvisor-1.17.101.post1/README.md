...
[boto3.IoTDeviceAdvisor 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/iotdeviceadvisor.html#IoTDeviceAdvisor)
...
def get_structure() -> CreateSuiteDefinitionRequestTypeDef:
    return {
      ...
    }
```
