...
class SysamSP5(Sysam4Methodes):
    def raz_sorties(self):
        print("raz_sorties")
        self.sysam.config_sortie(1, 1, np.zeros(10), 0)
        self.sysam.config_sortie(2, 1, np.zeros(10), 0)
        self.sysam.declencher_sorties(1, 1)
    ...
    def __init__(self, liste_signaux, affichage = True):
        ...
        if "synchrone" in self.chaine_mode:
            ...
            xmin, xmax = self.axe_x_base_entrees.lire_liste_xmin_xmax()
