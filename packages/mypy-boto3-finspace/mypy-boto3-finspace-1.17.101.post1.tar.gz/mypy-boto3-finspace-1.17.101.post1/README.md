...
[boto3.finspace 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/finspace.html#finspace)
...
def get_structure() -> CreateEnvironmentRequestTypeDef:
    return {
      ...
    }
```
