...
set_target_properties(HELICS::helicsSharedLib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhelicsSharedLib.2.7.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhelicsSharedLib.2.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS HELICS::helicsSharedLib )
list(APPEND _IMPORT_CHECK_FILES_FOR_HELICS::helicsSharedLib "${_IMPORT_PREFIX}/lib/libhelicsSharedLib.2.7.1.dylib" )
