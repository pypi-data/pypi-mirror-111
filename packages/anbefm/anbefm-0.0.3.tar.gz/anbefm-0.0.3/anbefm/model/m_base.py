...
class MBaseWhereT():
    ...
    def get_where_params(self, mt):
        ...
        for field_name in self.field_names:
            if hasattr(mt, field_name) and field_name in fields:
                ...
                params.append((field_name, predicate, v))
    ...
    def parse_where_sql(self, params):
        ...
        for field_name, predicate, v in params:
            if predicate == MPredicate.LIKE:
                wherelist.append(f'{field_name} like "%{str(v)}%"')

            elif predicate == MPredicate.EQUAL:
                wherelist.append(f'{field_name} = \'{str(v)}\'')
                ...
                wherelist.append(f'{field_name} in ({v})')
