...
[boto3.Macie 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/macie.html#Macie)
...
def get_structure() -> AssociateMemberAccountRequestTypeDef:
    return {
      ...
    }
```
