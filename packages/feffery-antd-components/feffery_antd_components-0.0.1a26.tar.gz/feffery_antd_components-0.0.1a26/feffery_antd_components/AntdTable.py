...
- style (dict; optional)"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, columns=Component.UNDEFINED, data=Component.UNDEFINED, sortOptions=Component.UNDEFINED, pagination=Component.UNDEFINED, autoIgnorePagination=Component.UNDEFINED, bordered=Component.UNDEFINED, maxHeight=Component.UNDEFINED, currentData=Component.UNDEFINED, recentlyChangedRow=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'autoIgnorePagination', 'bordered', 'className', 'columns', 'currentData', 'data', 'loading_state', 'maxHeight', 'pagination', 'recentlyChangedRow', 'sortOptions', 'style']
        self._type = 'AntdTable'
        self._namespace = 'feffery_antd_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'autoIgnorePagination', 'bordered', 'className', 'columns', 'currentData', 'data', 'loading_state', 'maxHeight', 'pagination', 'recentlyChangedRow', 'sortOptions', 'style']
