...
class NimuMessageProcessorOld(MessageProcessorBase):
    ...
    MSG_HANDLERS = {
        0x000: {'name': 'sync', 'sensor': SensorModel.NotApplicable, 'type': None, 'frequency': 1, 'is_extended': False, 'parser': None, 'priority': 1},
        ...
        0x140: {'name': 'dcm', 'sensor': SensorModel.NotApplicable, 'type': SensorDataType.Pose, 'frequency': 1, 'is_extended': False, 'parser': parse_fixpoint, 'priority': 7},
...
class NimuMessageProcessor(NimuMessageProcessorOld):
    ...
    MSG_HANDLERS = {
        ...
        0x300: {'name': 'dcm', 'sensor': SensorModel.NotApplicable, 'type': SensorDataType.Pose, 'frequency': 1, 'is_extended': False, 'parser': parse_fixpoint, 'priority': 11},
