...
from .type_defs import ListContainersOutputResponseTypeDef, PaginatorConfigTypeDef
...
class ListContainersPaginator(Boto3Paginator):
    ...
    ) -> Iterator[ListContainersOutputResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/mediastore.html#MediaStore.Paginator.ListContainers.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mediastore/paginators.html#listcontainerspaginator)
        """
