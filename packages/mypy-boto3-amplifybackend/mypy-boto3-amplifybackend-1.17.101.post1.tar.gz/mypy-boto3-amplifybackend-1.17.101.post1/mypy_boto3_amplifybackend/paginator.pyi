...
from .type_defs import ListBackendJobsResponseResponseTypeDef, PaginatorConfigTypeDef
...
class ListBackendJobsPaginator(Boto3Paginator):
    ...
    ) -> Iterator[ListBackendJobsResponseResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/amplifybackend.html#AmplifyBackend.Paginator.ListBackendJobs.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_amplifybackend/paginators.html#listbackendjobspaginator)
        """
