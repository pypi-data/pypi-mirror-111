...
[boto3.DataPipeline 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/datapipeline.html#DataPipeline)
...
def get_structure() -> ActivatePipelineInputTypeDef:
    return {
      ...
    }
```
