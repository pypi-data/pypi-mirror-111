...
[boto3.ACM 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/acm.html#ACM)
...
def get_structure() -> AddTagsToCertificateRequestTypeDef:
    return {
      ...
    }
```
