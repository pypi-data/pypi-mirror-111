...
[boto3.ElasticBeanstalk 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/elasticbeanstalk.html#ElasticBeanstalk)
...
def get_structure() -> AbortEnvironmentUpdateMessageTypeDef:
    return {
      ...
    }
```
