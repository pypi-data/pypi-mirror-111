...
class ElasticBeanstalkClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client)
    ...
    def abort_environment_update(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.abort_environment_update)
    ...
    def apply_environment_managed_action(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.apply_environment_managed_action)
    ...
    def associate_environment_operations_role(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.associate_environment_operations_role)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.can_paginate)
    ...
    def check_dns_availability(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.check_dns_availability)
    ...
    def compose_environments(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.compose_environments)
    ...
    def create_application(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.create_application)
    ...
    def create_application_version(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.create_application_version)
    ...
    def create_configuration_template(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.create_configuration_template)
    ...
    def create_environment(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.create_environment)
    ...
    def create_platform_version(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.create_platform_version)
        ...
        """
    def create_storage_location(self) -> CreateStorageLocationResultMessageResponseTypeDef:
        """
        Creates a bucket in Amazon S3 to store application versions, logs, and other
        files used by Elastic Beanstalk environments.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.create_storage_location)
    ...
    def delete_application(self, *, ApplicationName: str, TerminateEnvByForce: bool = None) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.delete_application)
    ...
    def delete_application_version(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.delete_application_version)
    ...
    def delete_configuration_template(self, *, ApplicationName: str, TemplateName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.delete_configuration_template)
    ...
    def delete_environment_configuration(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.delete_environment_configuration)
    ...
    def delete_platform_version(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.delete_platform_version)
        ...
        """
    def describe_account_attributes(self) -> DescribeAccountAttributesResultResponseTypeDef:
        """
        Returns attributes related to AWS Elastic Beanstalk that are associated with the
        calling AWS account.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_account_attributes)
    ...
    def describe_application_versions(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_application_versions)
    ...
    def describe_applications(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_applications)
    ...
    def describe_configuration_options(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_configuration_options)
    ...
    def describe_configuration_settings(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_configuration_settings)
    ...
    def describe_environment_health(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_environment_health)
    ...
    def describe_environment_managed_action_history(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_environment_managed_action_history)
    ...
    def describe_environment_managed_actions(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_environment_managed_actions)
    ...
    def describe_environment_resources(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_environment_resources)
    ...
    def describe_environments(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_environments)
    ...
    def describe_events(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_events)
    ...
    def describe_instances_health(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_instances_health)
    ...
    def describe_platform_version(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.describe_platform_version)
    ...
    def disassociate_environment_operations_role(self, *, EnvironmentName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.disassociate_environment_operations_role)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.generate_presigned_url)
    ...
    def list_available_solution_stacks(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.list_available_solution_stacks)
    ...
    def list_platform_branches(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.list_platform_branches)
    ...
    def list_platform_versions(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.list_platform_versions)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.list_tags_for_resource)
    ...
    def rebuild_environment(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.rebuild_environment)
    ...
    def request_environment_info(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.request_environment_info)
    ...
    def restart_app_server(self, *, EnvironmentId: str = None, EnvironmentName: str = None) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.restart_app_server)
    ...
    def retrieve_environment_info(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.retrieve_environment_info)
    ...
    def swap_environment_cnames(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.swap_environment_cnames)
    ...
    def terminate_environment(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.terminate_environment)
    ...
    def update_application(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.update_application)
    ...
    def update_application_resource_lifecycle(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.update_application_resource_lifecycle)
    ...
    def update_application_version(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.update_application_version)
    ...
    def update_configuration_template(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.update_configuration_template)
    ...
    def update_environment(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.update_environment)
    ...
    def update_tags_for_resource(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.update_tags_for_resource)
    ...
    def validate_configuration_settings(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Client.validate_configuration_settings)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Paginator.DescribeApplicationVersions)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Paginator.DescribeEnvironmentManagedActionHistory)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Paginator.DescribeEnvironments)
    ...
    def get_paginator(self, operation_name: Literal["describe_events"]) -> DescribeEventsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Paginator.DescribeEvents)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Paginator.ListPlatformVersions)
    ...
    def get_waiter(self, waiter_name: Literal["environment_exists"]) -> EnvironmentExistsWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Waiter.EnvironmentExists)
    ...
    def get_waiter(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Waiter.EnvironmentTerminated)
    ...
    def get_waiter(self, waiter_name: Literal["environment_updated"]) -> EnvironmentUpdatedWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Waiter.EnvironmentUpdated)
