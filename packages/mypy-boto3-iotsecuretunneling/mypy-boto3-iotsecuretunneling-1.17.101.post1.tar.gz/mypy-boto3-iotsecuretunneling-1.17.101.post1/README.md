...
[boto3.IoTSecureTunneling 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/iotsecuretunneling.html#IoTSecureTunneling)
...
def get_structure() -> CloseTunnelRequestTypeDef:
    return {
      ...
    }
```
