...
[boto3.IoT1ClickProjects 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/iot1click-projects.html#IoT1ClickProjects)
...
def get_structure() -> AssociateDeviceWithPlacementRequestTypeDef:
    return {
      ...
    }
```
