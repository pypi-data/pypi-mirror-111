...
class ECRClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client)
    ...
    def batch_check_layer_availability(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.batch_check_layer_availability)
    ...
    def batch_delete_image(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.batch_delete_image)
    ...
    def batch_get_image(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.batch_get_image)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.can_paginate)
    ...
    def complete_layer_upload(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.complete_layer_upload)
    ...
    def create_repository(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.create_repository)
    ...
    def delete_lifecycle_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.delete_lifecycle_policy)
    ...
    def delete_registry_policy(self) -> DeleteRegistryPolicyResponseResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.delete_registry_policy)
    ...
    def delete_repository(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.delete_repository)
    ...
    def delete_repository_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.delete_repository_policy)
    ...
    def describe_image_scan_findings(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.describe_image_scan_findings)
    ...
    def describe_images(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.describe_images)
    ...
    def describe_registry(self) -> DescribeRegistryResponseResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.describe_registry)
    ...
    def describe_repositories(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.describe_repositories)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.generate_presigned_url)
    ...
    def get_authorization_token(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.get_authorization_token)
    ...
    def get_download_url_for_layer(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.get_download_url_for_layer)
    ...
    def get_lifecycle_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.get_lifecycle_policy)
    ...
    def get_lifecycle_policy_preview(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.get_lifecycle_policy_preview)
    ...
    def get_registry_policy(self) -> GetRegistryPolicyResponseResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.get_registry_policy)
    ...
    def get_repository_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.get_repository_policy)
    ...
    def initiate_layer_upload(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.initiate_layer_upload)
    ...
    def list_images(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.list_images)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.list_tags_for_resource)
    ...
    def put_image(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.put_image)
    ...
    def put_image_scanning_configuration(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.put_image_scanning_configuration)
    ...
    def put_image_tag_mutability(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.put_image_tag_mutability)
    ...
    def put_lifecycle_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.put_lifecycle_policy)
    ...
    def put_registry_policy(self, *, policyText: str) -> PutRegistryPolicyResponseResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.put_registry_policy)
    ...
    def put_replication_configuration(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.put_replication_configuration)
    ...
    def set_repository_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.set_repository_policy)
    ...
    def start_image_scan(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.start_image_scan)
    ...
    def start_lifecycle_policy_preview(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.start_lifecycle_policy_preview)
    ...
    def tag_resource(self, *, resourceArn: str, tags: List["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.tag_resource)
    ...
    def untag_resource(self, *, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.untag_resource)
    ...
    def upload_layer_part(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Client.upload_layer_part)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Paginator.DescribeImageScanFindings)
    ...
    def get_paginator(self, operation_name: Literal["describe_images"]) -> DescribeImagesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Paginator.DescribeImages)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Paginator.DescribeRepositories)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Paginator.GetLifecyclePolicyPreview)
    ...
    def get_paginator(self, operation_name: Literal["list_images"]) -> ListImagesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Paginator.ListImages)
    ...
    def get_waiter(self, waiter_name: Literal["image_scan_complete"]) -> ImageScanCompleteWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Waiter.ImageScanComplete)
    ...
    def get_waiter(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ecr.html#ECR.Waiter.LifecyclePolicyPreviewComplete)
