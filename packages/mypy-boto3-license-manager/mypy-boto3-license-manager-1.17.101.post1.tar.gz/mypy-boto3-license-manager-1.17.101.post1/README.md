...
[boto3.LicenseManager 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/license-manager.html#LicenseManager)
...
def get_structure() -> AcceptGrantRequestTypeDef:
    return {
      ...
    }
```
