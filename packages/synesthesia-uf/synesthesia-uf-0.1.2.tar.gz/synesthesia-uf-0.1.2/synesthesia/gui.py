...
class Window(QWidget):
    def __init__(self):
        ...
        # set the logo
        # url_data = urllib.urlopen("https://raw.githubusercontent.com/cbaddeley/Synesthesia/d17641714e1f5978bf894684c8604c6ef320754a/src/synesthesia/images/main_logo.svg").read()
        # pixmap = QPixmap()
        # pixmap.loadFromData(url_data)
        # lbl.setPixmap(pixmap)
        logo_file = QPixmap('synesthesia.images/main_logo.svg')
