...
def get_image_block(
    session: Session, assets_folder: str, oxa_path: str, local_path: str
):
    url = oxa_path_to_api_url(session.api_url, oxa_path, BlockFormat.tex)
    ...
    if content_type == "image/gif":
        ...
        local_path_with_extension = convert_gif(assets_folder, local_path_with_extension)
