...
from .type_defs import DescribeReportDefinitionsResponseResponseTypeDef, PaginatorConfigTypeDef
...
class DescribeReportDefinitionsPaginator(Boto3Paginator):
    ...
    ) -> Iterator[DescribeReportDefinitionsResponseResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/cur.html#CostandUsageReportService.Paginator.DescribeReportDefinitions.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_cur/paginators.html#describereportdefinitionspaginator)
        """
