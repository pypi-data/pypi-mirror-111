...
class OcrStandardController(ServiceInterface):
    def __init__(self, check_result, service_path):
        ...
        self.semantic_correct_src = path_join(self.data_dir, "semantic_correct")
        self.semantic_correct_remote = path_join(self.deploy_dir, "semantic_correct")
        self.unet_table_src = path_join(self.data_dir, "unit-table")
        self.unet_table_remote = path_join(self.deploy_dir, "unit-table")
