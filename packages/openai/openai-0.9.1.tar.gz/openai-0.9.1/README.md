# (Internal-only) Before you start
[Open this gDoc](https://docs.google.com/document/d/1rWk2cXhisbaiqhGwsLgbxHtf3Y8pkEI-i1CZHbhmDbY) and install this repo with those instructions. You need to progress through **Step 0** before you can use `openai-python-internal` for API development.
