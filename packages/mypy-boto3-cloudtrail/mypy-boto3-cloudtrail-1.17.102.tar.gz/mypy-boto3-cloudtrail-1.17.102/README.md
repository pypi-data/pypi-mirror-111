...
[boto3.CloudTrail 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/cloudtrail.html#CloudTrail)
...
def get_structure() -> AddTagsRequestTypeDef:
    return {
      ...
    }
```
