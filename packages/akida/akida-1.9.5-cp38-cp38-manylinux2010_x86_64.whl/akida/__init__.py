from .core import (BackendType, ConvolutionMode, PoolingType, LearningType,
                   LayerType, HwVersion, NP, MeshMapper, Layer, Device,
                   HardwareDevice, devices, NSoC_v1, NSoC_v2, Logger, Sequence,
                   __version__)
