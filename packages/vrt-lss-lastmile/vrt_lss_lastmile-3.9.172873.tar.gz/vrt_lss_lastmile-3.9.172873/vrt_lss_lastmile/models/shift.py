...
"""
    ...
    The version of the OpenAPI document: 3.9.172873
...
class Shift(object):
    ...
    def __init__(self, key=None, shift_type=None, resource_key=None, availability_time=None, working_time=None, start_location_key=None, finish_location_key=None, max_locations=0, max_stops=0, tariff=None, attributes=[], local_vars_configuration=None):  # noqa: E501
