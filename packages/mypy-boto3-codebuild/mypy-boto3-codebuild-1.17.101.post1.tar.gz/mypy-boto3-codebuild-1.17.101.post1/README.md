...
[boto3.CodeBuild 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codebuild.html#CodeBuild)
...
def get_structure() -> BatchDeleteBuildsInputTypeDef:
    return {
      ...
    }
```
