...
[boto3.CognitoSync 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/cognito-sync.html#CognitoSync)
...
def get_structure() -> BulkPublishRequestTypeDef:
    return {
      ...
    }
```
