...
[boto3.ResourceGroups 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/resource-groups.html#ResourceGroups)
...
def get_structure() -> CreateGroupInputTypeDef:
    return {
      ...
    }
```
