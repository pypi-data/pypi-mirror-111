...
[boto3.AutoScaling 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/autoscaling.html#AutoScaling)
...
def get_structure() -> ActivitiesTypeResponseTypeDef:
    return {
      ...
    }
```
