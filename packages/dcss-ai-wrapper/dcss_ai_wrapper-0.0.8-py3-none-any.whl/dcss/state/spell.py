...
class Spell:
    ...
    def __hash__(self):
        return hash("{}{}".format(self.spellname, self.fail_chance))

    def __eq__(self, other):
        return self.spellname == other.spellname and self.fail_chance == other.fail_chance
