...
from .type_defs import ListEndpointsResultResponseTypeDef, PaginatorConfigTypeDef
...
class ListEndpointsPaginator(Boto3Paginator):
    ...
    ) -> Iterator[ListEndpointsResultResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/s3outposts.html#S3Outposts.Paginator.ListEndpoints.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_s3outposts/paginators.html#listendpointspaginator)
        """
