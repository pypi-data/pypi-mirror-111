...
[boto3.GlueDataBrew 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/databrew.html#GlueDataBrew)
...
def get_structure() -> BatchDeleteRecipeVersionRequestTypeDef:
    return {
      ...
    }
```
