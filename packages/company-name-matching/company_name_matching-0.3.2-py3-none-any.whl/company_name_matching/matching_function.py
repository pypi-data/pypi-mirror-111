...
print("Accenture France + ", "Accenture: ", matching_object.match("Accenture France", "Accenture").score)

print("Groupe BPCE + ", "BPCE, score: ", matching_object.match("Groupe BPCE", "BPCE").score)

print("Groupe crédit agricole cva + ", "crédit agricole gesellschaft, score:", matching_object.match("Groupe crédit agricole cva", "crédit agricole gesellschaft").score)
...
print("accenture limitee + ", "accenture ltd, score:", matching_object.match("accenture limitee", "accenture ltd").score)
...
print("accenture cooperative + ", "accenture coop, score:", matching_object.match("accenture cooperative", "accenture coop").score)