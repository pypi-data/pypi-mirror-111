...
[boto3.SageMakerRuntime 1.17.104](https://boto3.amazonaws.com/v1/documentation/api/1.17.104/reference/services/sagemaker-runtime.html#SageMakerRuntime)
...
def get_structure() -> InvokeEndpointInputRequestTypeDef:
    return {
      ...
    }
```
