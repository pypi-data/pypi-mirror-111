...
[boto3.Glacier 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/glacier.html#Glacier)
...
def get_structure() -> AbortMultipartUploadInputTypeDef:
    return {
      ...
    }
```
