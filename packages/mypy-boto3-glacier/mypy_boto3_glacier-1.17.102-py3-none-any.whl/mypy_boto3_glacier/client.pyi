...
class GlacierClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client)
    ...
    def abort_multipart_upload(self, *, accountId: str, vaultName: str, uploadId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.abort_multipart_upload)
    ...
    def abort_vault_lock(self, *, accountId: str, vaultName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.abort_vault_lock)
    ...
    def add_tags_to_vault(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.add_tags_to_vault)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.can_paginate)
    ...
    def complete_multipart_upload(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.complete_multipart_upload)
    ...
    def complete_vault_lock(self, *, accountId: str, vaultName: str, lockId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.complete_vault_lock)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_glacier/client.html#complete_vault_lock)
        """
    def create_vault(self, *, accountId: str, vaultName: str) -> CreateVaultOutputResponseTypeDef:
        """
        This operation creates a new vault with the specified name.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.create_vault)
    ...
    def delete_archive(self, *, accountId: str, vaultName: str, archiveId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.delete_archive)
    ...
    def delete_vault(self, *, accountId: str, vaultName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.delete_vault)
    ...
    def delete_vault_access_policy(self, *, accountId: str, vaultName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.delete_vault_access_policy)
    ...
    def delete_vault_notifications(self, *, accountId: str, vaultName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.delete_vault_notifications)
    ...
    def describe_job(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.describe_job)
    ...
    def describe_vault(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.describe_vault)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.generate_presigned_url)
    ...
    def get_data_retrieval_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.get_data_retrieval_policy)
    ...
    def get_job_output(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.get_job_output)
    ...
    def get_vault_access_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.get_vault_access_policy)
    ...
    def get_vault_lock(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.get_vault_lock)
    ...
    def get_vault_notifications(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.get_vault_notifications)
    ...
    def initiate_job(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.initiate_job)
    ...
    def initiate_multipart_upload(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.initiate_multipart_upload)
    ...
    def initiate_vault_lock(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.initiate_vault_lock)
    ...
    def list_jobs(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.list_jobs)
    ...
    def list_multipart_uploads(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.list_multipart_uploads)
    ...
    def list_parts(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.list_parts)
    ...
    def list_provisioned_capacity(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.list_provisioned_capacity)
    ...
    def list_tags_for_vault(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.list_tags_for_vault)
    ...
    def list_vaults(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.list_vaults)
    ...
    def purchase_provisioned_capacity(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.purchase_provisioned_capacity)
    ...
    def remove_tags_from_vault(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.remove_tags_from_vault)
    ...
    def set_data_retrieval_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.set_data_retrieval_policy)
    ...
    def set_vault_access_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.set_vault_access_policy)
    ...
    def set_vault_notifications(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.set_vault_notifications)
    ...
    def upload_archive(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.upload_archive)
    ...
    def upload_multipart_part(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Client.upload_multipart_part)
    ...
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Paginator.ListJobs)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Paginator.ListMultipartUploads)
    ...
    def get_paginator(self, operation_name: Literal["list_parts"]) -> ListPartsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Paginator.ListParts)
    ...
    def get_paginator(self, operation_name: Literal["list_vaults"]) -> ListVaultsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Paginator.ListVaults)
    ...
    def get_waiter(self, waiter_name: Literal["vault_exists"]) -> VaultExistsWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Waiter.VaultExists)
    ...
    def get_waiter(self, waiter_name: Literal["vault_not_exists"]) -> VaultNotExistsWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/glacier.html#Glacier.Waiter.VaultNotExists)
