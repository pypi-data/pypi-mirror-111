...
"""
    ...
    The version of the OpenAPI document: 0.0.1273
...
class CreateDomainRequest(object):
    ...
    def domain(self, domain):
        ...
        if domain is not None and len(domain) > 25:
        ...
        if (domain is not None and not re.search(r'^[a-zA-Z][a-zA-Z0-9-]*$', domain)):  # noqa: E501
    ...
    def company_name(self, company_name):
        ...
        if (company_name is not None and not re.search(r'^[\s\S]*$', company_name)):  # noqa: E501
