...
[boto3.MarketplaceMetering 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/meteringmarketplace.html#MarketplaceMetering)
...
def get_structure() -> BatchMeterUsageRequestTypeDef:
    return {
      ...
    }
```
