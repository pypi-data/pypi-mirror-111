...
class Salesman:
    ...
    def simulate(self, time: float):
        ...
        if np.allclose(self.loc, self.next_city.loc):
            ...
            self.tour.append(self.next_city.loc)
    ...
    @classmethod
    def from_state_dict(cls, state_dict, cur_city, next_city_idx, next_city):
        salesman = cls(idx=state_dict['idx'],
                       first_city=cur_city)
        salesman.next_city = next_city
        salesman.next_city_idx = next_city_idx
