...
class mTSPenv:
    ...
    TODO: Adjust event index properly.
    """
    ...
    def step(self, action):
        ...
        return self.observation_func(self), reward, self.done
    ...
    def get_action_space(self):
        ...
        if self.allow_early_return:
            ...
            print(self.manager.salesmen[self.manager.target_agent].tour_length)
            print(early_returning_cond, zero_tour_cond)
            if early_returning_cond and zero_tour_cond:
                action_space += [0]
        print(action_space)
        return action_space
