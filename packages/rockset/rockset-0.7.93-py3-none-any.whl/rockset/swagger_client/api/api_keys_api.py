...
class APIKeysApi(object):
    ...
    def get(self, name, **kwargs):  # noqa: E501
        ...
        Get a particular API key for the authenticated user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/orgs/self/users/self/apikeys/{name}', 'GET',
            body_params,
            path_params,
            query_params,
            header_params,
    ...
    def get_0(self, user, name, **kwargs):  # noqa: E501
        """Get any API Key  # noqa: E501

        Get a particular API key for any user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_0(user, name, async=True)
        >>> result = thread.get()

        :param async_req bool
        :param str user: email of the api key owner (required)
        :param str name: name of the API key (required)
        :return: GetApiKeyResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_0_with_http_info(user, name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_0_with_http_info(user, name, **kwargs)  # noqa: E501
            return data

    def get_0_with_http_info(self, user, name, **kwargs):  # noqa: E501
        """Get any API Key  # noqa: E501

        Get a particular API key for any user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_0_with_http_info(user, name, async_req=True)
        >>> result = thread.get()
        ...
        if ('user' not in params or
                params['user'] is None):
            raise ValueError("Missing the required parameter `user` when calling `get_0`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_0`")  # noqa: E501
