...
general = {
    ...
    "create()": ["num p=1", "A program accepting user input to create and store a matrix for use while in the command prompt. p will change the matrix print to rational if ==2, and will suppress printing if ==0.", "create"],
...
def modulehelp(rep=0):
    if(rep == 0):
        print("This is the Matrix Module V0.0.4, a package created by Elliott Walker. Type 'funcs' for a list of available functions, 'details' for a more detailed list including parameters, or 'exit' to exit this help function.")
    else:
