...
from .type_defs import ListRepositoryAssociationsResponseResponseTypeDef, PaginatorConfigTypeDef
...
class ListRepositoryAssociationsPaginator(Boto3Paginator):
    ...
    ) -> Iterator[ListRepositoryAssociationsResponseResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codeguru-reviewer.html#CodeGuruReviewer.Paginator.ListRepositoryAssociations.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_codeguru_reviewer/paginators.html#listrepositoryassociationspaginator)
        """
