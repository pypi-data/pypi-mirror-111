...
[boto3.CodeGuruReviewer 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codeguru-reviewer.html#CodeGuruReviewer)
...
def get_structure() -> AssociateRepositoryRequestTypeDef:
    return {
      ...
    }
```
