...
[boto3.Honeycode 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/honeycode.html#Honeycode)
...
def get_structure() -> BatchCreateTableRowsRequestTypeDef:
    return {
      ...
    }
```
