...
[boto3.Textract 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/textract.html#Textract)
...
def get_structure() -> AnalyzeDocumentRequestTypeDef:
    return {
      ...
    }
```
