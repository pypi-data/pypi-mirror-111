...
text of any its children widgets is fully visible/displayed.
...
class SimpleAutoTickerBehavior:
    ...
    the number of characters that can be displayed completely in this widget. this is done with an kivy animation. the
