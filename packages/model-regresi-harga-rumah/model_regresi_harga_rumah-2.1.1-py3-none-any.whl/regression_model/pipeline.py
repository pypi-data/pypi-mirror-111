...
price_pipe = Pipeline(
    [
        # ===== Mengisi Nilai NA (Imputation) =====
        # Mengganti variabel kategori dengan string missing
        (
            "missing_imputation",
            CategoricalImputer(
        ...
        # Melakukan encoding variabel kategori dengan rataan variabel target
        (
            "categorical_encoder",
            OrdinalEncoder(
