...
# api endpoints - TODO: move to "internal" module!
...
API_PATH_USAGE = '%s/usage' % API_PATH_PLANS
...
localstack_config.CONFIG_ENV_VARS += [
    ...
    'REQUIRE_PRO', 'AZURE', 'BIGDATA_DOCKER_FLAGS', 'LOG_LICENSE_ISSUES', 'KUBE_ENDPOINT'
]
