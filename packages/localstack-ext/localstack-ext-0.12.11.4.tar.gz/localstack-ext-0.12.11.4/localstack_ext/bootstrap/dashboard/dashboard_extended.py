...
from localstack_ext.bootstrap.aws_models import (
    RDSDatabase, RDSCluster, AppSyncAPI, AmplifyApp, ElastiCacheCluster, TransferServer,
    CloudFrontDistribution, CodeCommitRepository)
...
def get_graph(*args, **kwargs):
    ...
    resources = {
        'rds_db': databases,
        'rds_cluster': rds_clusters,
        'appsync_api': appsync_apis,
        'amplify_app': amplify_apps,
        'elasticache_cluster': elasticache_clusters,
        'transfer_server': transfer_servers,
        'cloudfront_distr': cloudfront_distributions,
        'codecommit_repo': codecommit_repos
    }
