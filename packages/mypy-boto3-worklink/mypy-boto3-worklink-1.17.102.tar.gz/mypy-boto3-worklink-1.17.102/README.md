...
[boto3.WorkLink 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/worklink.html#WorkLink)
...
def get_structure() -> AssociateDomainRequestTypeDef:
    return {
      ...
    }
```
