...
def codetranslate(code):
    ...
    codedict=pd.DataFrame([
        ...
        ['1398.HK','工商银行港股'],['0939.HK','建设银行港股'],
        ['1288.HK','农业银行港股'],['0857.HK','中国石油港股'],
        ...
        ['0883.HK','中国海油港股'],['601808.SS','中海油服A股'],
        ['2883.HK','中海油服港股'],['600583.SS','海油工程A股'],['600968.SS','海油发展A股'],
        
        ['600028.SS','中国石化A股'],['0386.HK','中国石化港股'],
        ['600871.SS','石化油服A股'],['1033.HK','石化油服港股'],
        ...
        #股票：教育、视频
        ['BILI','哔哩哔哩'],['TAL','好未来'],['EDU','新东方'],        
        ['IQ','爱奇艺'],['HUYA','虎牙'],['1024.HK','快手港股'],
        ...
        ['0992.HK','港股联想'],['LENOVO GROUP','联想集团'],
        ['1810.HK','港股小米'],
        ['1166.HK','港股星凯控股'],['0273.HK','港股茂宸集团'],
        ...
        ['IMOEX.ME','MOEX俄罗斯指数'], ['^VIX','VIX恐慌指数'],
