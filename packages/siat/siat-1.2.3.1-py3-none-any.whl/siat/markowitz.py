...
def cumulative_returns_plot(retgroup,name_list,titletxt,ylabeltxt,xlabeltxt):
    ...
    for name in name_list:
        ...
        CumulativeReturns.plot(label=ectranslate(name),ls=thisls)
...
def portfolio_es(pf_info,simulation=1000):
    ...
    # 循环模拟n次随机的投资组合
    print("\nCalculating portfolio efficient sets, please wait ...")    
