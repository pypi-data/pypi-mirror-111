...
class BundlesCollectionsApi(object):
    ...
    def collections_of_a_bundle(self, lidvid, **kwargs):  # noqa: E501
        """get collections belonging to a given bundle  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.collections_of_a_bundle(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        return self.collections_of_a_bundle_with_http_info(lidvid, **kwargs)  # noqa: E501

    def collections_of_a_bundle_with_http_info(self, lidvid, **kwargs):  # noqa: E501
        """get collections belonging to a given bundle  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.collections_of_a_bundle_with_http_info(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method collections_of_a_bundle" % key
                )
        ...
        if self.api_client.client_side_validation and ('lidvid' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `lidvid` when calling `collections_of_a_bundle`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/bundles/{lidvid}/collections', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
