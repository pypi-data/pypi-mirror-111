...
class BundlesApi(object):
    ...
    def bundle_by_lidvid(self, lidvid, **kwargs):  # noqa: E501
        """bundle URN resolver for lidvid, get one bundle  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bundle_by_lidvid(lidvid, async_req=True)
        >>> result = thread.get()
    ...
    def bundle_by_lidvid_with_http_info(self, lidvid, **kwargs):  # noqa: E501
        """bundle URN resolver for lidvid, get one bundle  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bundle_by_lidvid_with_http_info(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method bundle_by_lidvid" % key
                )
        ...
        if self.api_client.client_side_validation and ('lidvid' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `lidvid` when calling `bundle_by_lidvid`")  # noqa: E501
