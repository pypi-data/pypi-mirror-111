...
class ProductContainingCollectionsApi(object):
    ...
    def collections_containing_product(self, lidvid, **kwargs):  # noqa: E501
        """get collections containing product  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.collections_containing_product(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        return self.collections_containing_product_with_http_info(lidvid, **kwargs)  # noqa: E501

    def collections_containing_product_with_http_info(self, lidvid, **kwargs):  # noqa: E501
        """get collections containing product  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.collections_containing_product_with_http_info(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method collections_containing_product" % key
                )
        ...
        if self.api_client.client_side_validation and ('lidvid' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `lidvid` when calling `collections_containing_product`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/products/{lidvid}/collections', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
