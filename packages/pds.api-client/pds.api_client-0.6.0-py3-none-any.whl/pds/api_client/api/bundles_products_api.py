...
class BundlesProductsApi(object):
    ...
    def products_of_a_bundle(self, lidvid, **kwargs):  # noqa: E501
        """get products belonging to a given bundle  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.products_of_a_bundle(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        return self.products_of_a_bundle_with_http_info(lidvid, **kwargs)  # noqa: E501

    def products_of_a_bundle_with_http_info(self, lidvid, **kwargs):  # noqa: E501
        """get products belonging to a given bundle  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.products_of_a_bundle_with_http_info(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('lidvid' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `lidvid` when calling `products_of_a_bundle`")  # noqa: E501
