...
class CollectionsContainingBundlesApi(object):
    ...
    def bundles_containing_collection(self, lidvid, **kwargs):  # noqa: E501
        """get bundles containing this given collection  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bundles_containing_collection(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        return self.bundles_containing_collection_with_http_info(lidvid, **kwargs)  # noqa: E501

    def bundles_containing_collection_with_http_info(self, lidvid, **kwargs):  # noqa: E501
        """get bundles containing this given collection  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bundles_containing_collection_with_http_info(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method bundles_containing_collection" % key
                )
        ...
        if self.api_client.client_side_validation and ('lidvid' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `lidvid` when calling `bundles_containing_collection`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/collections/{lidvid}/bundles', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
