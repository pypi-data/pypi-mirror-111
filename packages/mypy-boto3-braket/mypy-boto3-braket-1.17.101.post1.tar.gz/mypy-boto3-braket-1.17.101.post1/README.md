...
[boto3.Braket 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/braket.html#Braket)
...
def get_structure() -> CancelQuantumTaskRequestTypeDef:
    return {
      ...
    }
```
