...
class AuxCodonDicts():
    '''
    This class contains auxillery codon dependency dictionaries, for use as rates / k elongation 
    calculations.
    ...
    hg19 tRNA Gene Copy Numbers (GCN):
        ...
        Nucleic Acids Research (online) 2015 Dec 15 - 2016 Jan4; 44(Database issue) D184-D189
    ...
    def __init__(self):
        ...
        human_avtRNA_gene_number_anticodon_IBEN2015 = {'AGC': 36.23, 'CGC':4.68,
                                         'UGC':10.07, 'ACG': 6.87,
                                         'CCG':3.71, 'CCU': 5.48,
                                         'UCG':6.18, 'UCU':6.42,
                                         'AUU':1.71, 'GUU':31.70,
        ...
        human_stdtRNA_gene_number_anticodon_IBEN2015 = {'AGC': 2.68, 'CGC':0.65,
                                             'UGC':1.02, 'ACG': .66,
                                             'CCG':.4, 'CCU': .59,
                                             'UCG':.39, 'UCU': .60,
                                             'AUU':.25, 'GUU':4.47,
        ...
        hg19_trna_gene_number_anticodon = {'AGC': 33, 'CGC':5,
                                             'UGC':11, 'ACG': 8, 'GGC':2,
                                             'CCG':4, 'CCU': 8,
                                             'UCG':6, 'UCU': 6,
                                             'AUU':2, 'GUU':36,
        ...
        self.Human_codon_freq_nakumura =   {'TTT': 17.6, 'TCT': 15.2, 'TAT': 12.2, 'TGT': 10.6, 'TTC': 20.3,
                                    ...
                                    'GTG': 28.1, 'GCG': 7.4, 'GAG': 39.6, 'GGG': 16.5}  # Frequncy per thousdand
        ...
        self.Human_codon_freq_HIVE =   {'TTT': 17.22, 'TCT': 16.96, 'TAT': 12.15, 'TGT': 10.47, 'TTC': 17.51,
                                    ...
                                    'GTG': 25.75, 'GCG': 5.94, 'GAG': 39.4, 'GGG': 15.26 } # Frequncy per thousdand
        
        self.Human_codon_freq_HIVE = self.__add_other_keys(self.Human_codon_freq_HIVE)
            
    def __add_other_keys(self,dictionary, u_or_t = 't'):
