...
from Extre.utils import admin_cmd, load_module, remove_plugin, sudo_cmd
from Extre.utils import edit_or_reply as eor

DELETE_TIMEOUT = 3
thumb_image_path = "https://telegra.ph/file/75520b56df7b9159438cb.jpg"
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "EXTREMEPRO USERBOT"
...
async def unload(event):
    ...
    try:
        ...
        await qwe.edit(
            "EXTREME PRO USERBOT has Successfully unloaded {shortname}\n{}".format(shortname, str(e))
        )
...
async def load(event):
    ...
    try:
        ...
        await qwe.edit(
            f"EXTREMEPRO USERBOT could not load {shortname} because of the following error.\n{str(e)}"
        )