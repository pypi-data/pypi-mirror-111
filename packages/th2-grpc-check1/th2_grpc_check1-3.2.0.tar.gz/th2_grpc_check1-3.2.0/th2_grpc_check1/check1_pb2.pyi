...
class CheckRuleRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"chain_id",b"chain_id",u"checkpoint",b"checkpoint",u"connectivity_id",b"connectivity_id",u"filter",b"filter",u"kind",b"kind",u"parent_event_id",b"parent_event_id",u"root_filter",b"root_filter"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"chain_id",b"chain_id",u"checkpoint",b"checkpoint",u"connectivity_id",b"connectivity_id",u"description",b"description",u"direction",b"direction",u"filter",b"filter",u"kind",b"kind",u"parent_event_id",b"parent_event_id",u"root_filter",b"root_filter",u"timeout",b"timeout"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"kind",b"kind"]) -> typing_extensions.Literal["filter","root_filter"]: ...
...
class CheckSequenceRuleRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"chain_id",b"chain_id",u"check_order",b"check_order",u"checkpoint",b"checkpoint",u"connectivity_id",b"connectivity_id",u"description",b"description",u"direction",b"direction",u"message_filters",b"message_filters",u"parent_event_id",b"parent_event_id",u"pre_filter",b"pre_filter",u"root_message_filters",b"root_message_filters",u"timeout",b"timeout"]) -> None: ...
