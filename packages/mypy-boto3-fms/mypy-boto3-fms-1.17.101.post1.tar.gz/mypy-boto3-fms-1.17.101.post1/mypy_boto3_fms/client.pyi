...
class FMSClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client)
    ...
    def associate_admin_account(self, *, AdminAccount: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.associate_admin_account)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.can_paginate)
    ...
    def delete_apps_list(self, *, ListId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.delete_apps_list)
    ...
    def delete_notification_channel(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.delete_notification_channel)
    ...
    def delete_policy(self, *, PolicyId: str, DeleteAllPolicyResources: bool = None) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.delete_policy)
    ...
    def delete_protocols_list(self, *, ListId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.delete_protocols_list)
    ...
    def disassociate_admin_account(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.disassociate_admin_account)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.generate_presigned_url)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_fms/client.html#generate_presigned_url)
        """
    def get_admin_account(self) -> GetAdminAccountResponseResponseTypeDef:
        """
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.get_admin_account)
    ...
    def get_apps_list(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.get_apps_list)
    ...
    def get_compliance_detail(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.get_compliance_detail)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_fms/client.html#get_compliance_detail)
        """
    def get_notification_channel(self) -> GetNotificationChannelResponseResponseTypeDef:
        """
        Information about the Amazon Simple Notification Service (SNS) topic that is
        used to record AWS Firewall Manager SNS logs.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.get_notification_channel)
        ...
        """
    def get_policy(self, *, PolicyId: str) -> GetPolicyResponseResponseTypeDef:
        """
        Returns information about the specified AWS Firewall Manager policy.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.get_policy)
    ...
    def get_protection_status(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.get_protection_status)
    ...
    def get_protocols_list(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.get_protocols_list)
    ...
    def get_violation_details(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.get_violation_details)
    ...
    def list_apps_lists(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.list_apps_lists)
    ...
    def list_compliance_status(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.list_compliance_status)
    ...
    def list_member_accounts(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.list_member_accounts)
    ...
    def list_policies(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.list_policies)
    ...
    def list_protocols_lists(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.list_protocols_lists)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.list_tags_for_resource)
    ...
    def put_apps_list(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.put_apps_list)
    ...
    def put_notification_channel(self, *, SnsTopicArn: str, SnsRoleName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.put_notification_channel)
    ...
    def put_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.put_policy)
    ...
    def put_protocols_list(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.put_protocols_list)
    ...
    def tag_resource(self, *, ResourceArn: str, TagList: List["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Client.untag_resource)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Paginator.ListComplianceStatus)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Paginator.ListMemberAccounts)
    ...
    def get_paginator(self, operation_name: Literal["list_policies"]) -> ListPoliciesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/fms.html#FMS.Paginator.ListPolicies)
