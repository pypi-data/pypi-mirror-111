...
class Args:
    ...
    num_his = 4
    dataset = 'ped1'
    train_folder = '/tmp/project/data/datasets/ped1/training/frames'
    test_folder = '/tmp/project/data/datasets/ped1/testing/frames'
    config = '/tmp/project/training_hyper_params/hyper_params.ini'
    snapshot_dir = '/tmp/project'
    summary_dir = '/tmp/project'
    psnr_dir = '/tmp/project'
    evaluate = 'compute_auc'

    # def __init__(dataset=dataset,train_folder='/tmp/project/data/datasets/ped1/training/frames',
    #              test_folder='/tmp/project/data/datasets/ped1/testing/frames'):
...
const.HEIGHT = 256
const.WIDTH = 256
const.FLOWNET_CHECKPOINT = '/tmp/project/checkpoints/pretrains/flownet-SD.ckpt-0'
