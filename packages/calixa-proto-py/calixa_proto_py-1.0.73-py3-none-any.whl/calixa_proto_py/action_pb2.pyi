...
class ActionParams(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"charge_refund_params",b"charge_refund_params",u"coupon_apply_params",b"coupon_apply_params",u"custom_params",b"custom_params",u"opportunity_create_params",b"opportunity_create_params",u"params",b"params",u"subscription_trial_update_params",b"subscription_trial_update_params"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"charge_refund_params",b"charge_refund_params",u"coupon_apply_params",b"coupon_apply_params",u"custom_params",b"custom_params",u"force",b"force",u"opportunity_create_params",b"opportunity_create_params",u"params",b"params",u"subscription_trial_update_params",b"subscription_trial_update_params"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"params",b"params"]) -> typing_extensions___Literal["charge_refund_params","subscription_trial_update_params","coupon_apply_params","opportunity_create_params","custom_params"]: ...
...
class DisplayField(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"display",b"display",u"field_type",b"field_type",u"initial_value",b"initial_value",u"key",b"key",u"options",b"options",u"placeholder",b"placeholder",u"properties",b"properties",u"render_when",b"render_when",u"required",b"required"]) -> None: ...
