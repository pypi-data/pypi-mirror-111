...
_ignore_functions = [
    ...
    "bagua.torch_api.tensor.base",
    "bagua.torch_api.tensor.decorator_data",
    "bagua.torch_api.globals",
    "bagua.torch_api.distributed.base",
    "bagua.torch_api.distributed.decorator_data",
