...
class Actor:
    ...
    def __init__(self, image, pos=POS_TOPLEFT,_angle = 0,Size = 100,anchor=ANCHOR_CENTER, **kwargs):
    ...
    def out_of_edge(self):
        self._bounds = game.screen.bounds()
        return not(0-self._w < self.x < self._bounds[2]+self._w and 0-self._h < self.y < self._bounds[3]+self._h)
    @property
    def Size(self):
        return self._size
    @Size.setter
