...
[boto3.HealthLake 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/healthlake.html#HealthLake)
...
def get_structure() -> CreateFHIRDatastoreRequestTypeDef:
    return {
      ...
    }
```
