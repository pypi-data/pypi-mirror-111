...
class AssemblyDatasetStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Sleep = channel.unary_unary(
                '/ncbi.datasets.v1alpha1.AssemblyDataset/Sleep',
                request_serializer=ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepRequest.SerializeToString,
                response_deserializer=ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepReply.FromString,
                )
        self.SleepStream = channel.unary_stream(
                '/ncbi.datasets.v1alpha1.AssemblyDataset/SleepStream',
                request_serializer=ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepRequest.SerializeToString,
                response_deserializer=ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepReply.FromString,
                )
...
def add_AssemblyDatasetServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Sleep': grpc.unary_unary_rpc_method_handler(
                    servicer.Sleep,
                    request_deserializer=ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepRequest.FromString,
                    response_serializer=ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepReply.SerializeToString,
            ),
...
class AssemblyDataset(object):
    ...
    def Sleep(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ncbi.datasets.v1alpha1.AssemblyDataset/Sleep',
            ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepRequest.SerializeToString,
            ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SleepStream(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/ncbi.datasets.v1alpha1.AssemblyDataset/SleepStream',
            ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepRequest.SerializeToString,
            ncbi_dot_datasets_dot_v1alpha1_dot_datasets__pb2.SleepReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class VirusDownloadStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetVirusDatasetStream = channel.unary_stream(
                '/ncbi.datasets.v1alpha1.VirusDownload/GetVirusDatasetStream',
        ...
        self.GetSars2ProteinDatasetStream = channel.unary_stream(
                '/ncbi.datasets.v1alpha1.VirusDownload/GetSars2ProteinDatasetStream',
...
def add_VirusDownloadServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ncbi.datasets.v1alpha1.VirusDownload', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class VirusDownload(object):
    ...
    def GetVirusDatasetStream(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/ncbi.datasets.v1alpha1.VirusDownload/GetVirusDatasetStream',
    ...
    def GetSars2ProteinDatasetStream(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/ncbi.datasets.v1alpha1.VirusDownload/GetSars2ProteinDatasetStream',
...
class DatasetDownloadServicer(object):
    ...
    def CheckAssemblyAvailability(self, request, context):
        ...
        BABY-1392: This provides error messages for invalid accessions, which is not available in GetAssemblyMetadata.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
