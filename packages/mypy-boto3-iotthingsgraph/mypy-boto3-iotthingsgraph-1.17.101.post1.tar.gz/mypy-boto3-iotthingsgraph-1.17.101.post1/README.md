...
[boto3.IoTThingsGraph 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/iotthingsgraph.html#IoTThingsGraph)
...
def get_structure() -> AssociateEntityToThingRequestTypeDef:
    return {
      ...
    }
```
