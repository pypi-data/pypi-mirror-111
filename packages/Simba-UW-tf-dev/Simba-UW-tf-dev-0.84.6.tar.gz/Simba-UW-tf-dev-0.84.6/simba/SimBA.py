...
class project_config:
    ...
    def __init__(self):
        ...
        self.filetype = DropDownMenu(self.label_import_csv,'File type',['CSV (DLC/DeepPoseKit)','JSON (BENTO)','H5 (multi-animal DLC)','SLP (SLEAP)', 'TRK (multi-animal APT)'],'12',com=self.fileselected)
        ...
        self.interpolation = DropDownMenu(self.labelmethod,'Interpolation',['None','Nearest', 'Linear', 'Quadratic'],'12')
    ...
    def import_singlecsv(self):
        ...
        interpolate_body_parts = Interpolate(self.configinifile,csvfile)
...
class loadprojectini:
    def __init__(self,configini):
        ...
        filetype = DropDownMenu(self.label_import_csv,'File type',['CSV (DLC/DeepPoseKit)','JSON (BENTO)','H5 (multi-animal DLC)','SLP (SLEAP)', 'TRK (multi-animal APT)'],'15',com=self.fileselected)
