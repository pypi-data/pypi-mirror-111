...
def export_resultado_final_nacional(alto=0.75,medio=0.5,grupos_grados=None,lista_mr=None,path="resultado",
    ...
    for key, grupo_grado  in grupos_grados.items():
        ...
        for macro_region in lista_mr:
            ...
            if delta_path is None:
                ...
                specific_url = '{}/{}/{}/{}/{}'.format(PATH_RESULT,delta_path,key,macro_region,"X_t_mas_1.csv")
    ...
    if delta_path is None:
        ...
        df_nacional[cls_export].to_stata("{}/{}/nacional_{}.dta".format(PATH_RESULT,delta_path,dt_string))
    return df_nacional
