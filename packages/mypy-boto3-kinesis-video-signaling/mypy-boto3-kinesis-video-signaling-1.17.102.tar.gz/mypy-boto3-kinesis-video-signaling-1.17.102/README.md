...
[boto3.KinesisVideoSignalingChannels 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/kinesis-video-signaling.html#KinesisVideoSignalingChannels)
...
def get_structure() -> GetIceServerConfigRequestTypeDef:
    return {
      ...
    }
```
