(self["webpackChunk_quetz_frontend_app"] = self["webpackChunk_quetz_frontend_app"] || []).push([["packages_menu-extension_lib_index_js"],{

/***/ "../../packages/menu-extension/style/img/avatar-icon.svg":
/*!***************************************************************!*\
  !*** ../../packages/menu-extension/style/img/avatar-icon.svg ***!
  \***************************************************************/
...
/* harmony import */ var _quetz_frontend_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @quetz-frontend/menu */ "webpack/sharing/consume/default/@quetz-frontend/menu/@quetz-frontend/menu");
/* harmony import */ var _quetz_frontend_menu__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_quetz_frontend_menu__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _quetz_frontend_apputils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @quetz-frontend/apputils */ "webpack/sharing/consume/default/@quetz-frontend/apputils/@quetz-frontend/apputils");
/* harmony import */ var _quetz_frontend_apputils__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_quetz_frontend_apputils__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _style_img_quetz_logo_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../style/img/quetz-logo.svg */ "../../packages/menu-extension/style/img/quetz-logo.svg");
/* harmony import */ var _style_img_avatar_icon_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../style/img/avatar-icon.svg */ "../../packages/menu-extension/style/img/avatar-icon.svg");
...
const menu = {
    id: CommandIDs.menu,
    autoStart: true,
    provides: _quetz_frontend_menu__WEBPACK_IMPORTED_MODULE_4__.IMainMenu,
    activate: toolbar,
};
/**
...
const login = {
    ...
    autoStart: true,
    requires: [_jupyterlab_application__WEBPACK_IMPORTED_MODULE_0__.IRouter],
    provides: _quetz_frontend_menu__WEBPACK_IMPORTED_MODULE_4__.ILogInMenu,
    activate: logInMenu,
};
 ...
 */
class LogInMenu extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    constructor(router) {
        super();
    ...
    render() {
        if (this._profile) {
            return (react__WEBPACK_IMPORTED_MODULE_6__.createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_6__.createElement("a", { onClick: this._onClick },
                    react__WEBPACK_IMPORTED_MODULE_6__.createElement("img", { className: "user-img", src: this._profile.avatar_url, alt: "avatar" })),
                react__WEBPACK_IMPORTED_MODULE_6__.createElement("div", { className: `login-menu ${this._isActive ? 'active' : 'inactive'}` },
                    react__WEBPACK_IMPORTED_MODULE_6__.createElement("ul", null,
                        react__WEBPACK_IMPORTED_MODULE_6__.createElement("li", { key: this._profile.name },
                            react__WEBPACK_IMPORTED_MODULE_6__.createElement("a", null,
                                react__WEBPACK_IMPORTED_MODULE_6__.createElement("span", null,
                                    "Signed in as ",
                                    this._profile.user.username))),
                        react__WEBPACK_IMPORTED_MODULE_6__.createElement("hr", null),
                        this._items.map((value) => {
                            if (value.loggedIn) {
                                return (react__WEBPACK_IMPORTED_MODULE_6__.createElement("li", { key: value.id },
                                    react__WEBPACK_IMPORTED_MODULE_6__.createElement("a", { onClick: () => this._route(value.api) },
                                        react__WEBPACK_IMPORTED_MODULE_6__.createElement("span", null, value.label))));
                            }
                        }),
                        react__WEBPACK_IMPORTED_MODULE_6__.createElement("hr", null),
                        react__WEBPACK_IMPORTED_MODULE_6__.createElement("li", { key: "signout" },
                            react__WEBPACK_IMPORTED_MODULE_6__.createElement("a", { onClick: () => this._logIn('/auth/logout') },
                                react__WEBPACK_IMPORTED_MODULE_6__.createElement("span", null, "Sign out")))))));
        }
        else {
            const avatar = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon({
                name: 'avatar_icon',
                svgstr: _style_img_avatar_icon_svg__WEBPACK_IMPORTED_MODULE_7__.default,
            });
            return (react__WEBPACK_IMPORTED_MODULE_6__.createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_6__.createElement("a", { onClick: this._onClick },
                    react__WEBPACK_IMPORTED_MODULE_6__.createElement(avatar.react, { className: "user-img", tag: "span", width: "28px", height: "28px" })),
                react__WEBPACK_IMPORTED_MODULE_6__.createElement("div", { className: `login-menu ${this._isActive ? 'active' : 'inactive'}` },
                    react__WEBPACK_IMPORTED_MODULE_6__.createElement("ul", null, this._items.map((value) => {
                        if (!value.loggedIn) {
                            return (react__WEBPACK_IMPORTED_MODULE_6__.createElement("li", { key: value.id },
                                react__WEBPACK_IMPORTED_MODULE_6__.createElement("a", { onClick: () => this._logIn(value.api) },
                                    react__WEBPACK_IMPORTED_MODULE_6__.createElement("span", null, value.label))));
                        }
                    })))));
        }
...
class SearchWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    constructor(router) {
        super();
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_6__.createElement("div", { className: "topbar-search-wrapper" },
            react__WEBPACK_IMPORTED_MODULE_6__.createElement(_quetz_frontend_apputils__WEBPACK_IMPORTED_MODULE_5__.SearchBox, { onSubmit: this.onSearch })));
    }
}
/**
 * @param app
...
function quetzTitle(app, router) {
    ...
    const logo = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_3__.Widget({ node: link });
    const logo_icon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon({
        name: 'quetz_logo',
        svgstr: _style_img_quetz_logo_svg__WEBPACK_IMPORTED_MODULE_8__.default,
    });
    logo_icon.element({
        container: logo.node,
...
function toolbar(app) {
    const menu = new _quetz_frontend_menu__WEBPACK_IMPORTED_MODULE_4__.MainMenu();
...
//# sourceMappingURL=packages_menu-extension_lib_index_js.bundle.js.map