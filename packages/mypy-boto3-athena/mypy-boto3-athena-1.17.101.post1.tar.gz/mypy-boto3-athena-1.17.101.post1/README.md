...
[boto3.Athena 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena)
...
def get_structure() -> BatchGetNamedQueryInputTypeDef:
    return {
      ...
    }
```
