...
class AthenaClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client)
    ...
    def batch_get_named_query(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.batch_get_named_query)
    ...
    def batch_get_query_execution(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.batch_get_query_execution)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.can_paginate)
    ...
    def create_data_catalog(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.create_data_catalog)
    ...
    def create_named_query(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.create_named_query)
    ...
    def create_prepared_statement(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.create_prepared_statement)
    ...
    def create_work_group(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.create_work_group)
    ...
    def delete_data_catalog(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.delete_data_catalog)
    ...
    def delete_named_query(self, *, NamedQueryId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.delete_named_query)
    ...
    def delete_prepared_statement(self, *, StatementName: str, WorkGroup: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.delete_prepared_statement)
    ...
    def delete_work_group(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.delete_work_group)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.generate_presigned_url)
    ...
    def get_data_catalog(self, *, Name: str) -> GetDataCatalogOutputResponseTypeDef:
        """
        Returns the specified data catalog.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.get_data_catalog)
    ...
    def get_database(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.get_database)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_athena/client.html#get_database)
        """

    def get_named_query(self, *, NamedQueryId: str) -> GetNamedQueryOutputResponseTypeDef:
        """
        Returns information about a single query.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.get_named_query)
    ...
    def get_prepared_statement(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.get_prepared_statement)
    ...
    def get_query_execution(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.get_query_execution)
    ...
    def get_query_results(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.get_query_results)
    ...
    def get_table_metadata(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.get_table_metadata)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_athena/client.html#get_table_metadata)
        """

    def get_work_group(self, *, WorkGroup: str) -> GetWorkGroupOutputResponseTypeDef:
        """
        Returns information about the workgroup with the specified name.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.get_work_group)
    ...
    def list_data_catalogs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.list_data_catalogs)
    ...
    def list_databases(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.list_databases)
    ...
    def list_engine_versions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.list_engine_versions)
    ...
    def list_named_queries(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.list_named_queries)
    ...
    def list_prepared_statements(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.list_prepared_statements)
    ...
    def list_query_executions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.list_query_executions)
    ...
    def list_table_metadata(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.list_table_metadata)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.list_tags_for_resource)
    ...
    def list_work_groups(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.list_work_groups)
    ...
    def start_query_execution(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.start_query_execution)
    ...
    def stop_query_execution(self, *, QueryExecutionId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.stop_query_execution)
    ...
    def tag_resource(self, *, ResourceARN: str, Tags: List["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceARN: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.untag_resource)
    ...
    def update_data_catalog(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.update_data_catalog)
    ...
    def update_prepared_statement(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.update_prepared_statement)
    ...
    def update_work_group(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Client.update_work_group)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Paginator.GetQueryResults)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Paginator.ListDataCatalogs)
    ...
    def get_paginator(self, operation_name: Literal["list_databases"]) -> ListDatabasesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Paginator.ListDatabases)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Paginator.ListNamedQueries)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Paginator.ListQueryExecutions)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Paginator.ListTableMetadata)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/athena.html#Athena.Paginator.ListTagsForResource)
