...
setup(
    ...
    url='https://github.com/alireza95jalili',  # Provide either the link to your github or to your website
    download_url='https://github.com/alireza95jalili/r1_strg_sdk/archive/refs/tags/2.1.0.tar.gz',  # I explain this later on
