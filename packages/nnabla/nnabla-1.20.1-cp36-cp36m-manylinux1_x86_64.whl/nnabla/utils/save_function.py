...
def _create_function_nntxt(f, name, function):
    ...
    if f.type == 'Affine':
        ...
        f.fused_convolution_param.nonlinearity_args.extend(function['args']['nonlinearity_args'])
        pass
        ...
        f.softplus_param.beta = function['args']['beta']
        pass
        ...
        f.cumsum_param.axis = function['args']['axis']
        f.cumsum_param.exclusive = bool(function['args']['exclusive'])
        f.cumsum_param.reverse = bool(function['args']['reverse'])
        pass
    elif f.type == 'Mean':
        ...
        f.cumprod_param.axis = function['args']['axis']
        f.cumprod_param.exclusive = bool(function['args']['exclusive'])
        f.cumprod_param.reverse = bool(function['args']['reverse'])
        pass
        ...
        pass
    elif f.type == 'SearchSorted':
        f.searchsorted_param.right = bool(function['args']['right'])
        pass
        ...
        pass
    elif f.type == 'Meshgrid':
        f.meshgrid_param.ij_indexing = bool(function['args']['ij_indexing'])
        pass
        ...
        f.dropout_param.output_mask = bool(function['args']['output_mask'])
        pass
        ...
        f.random_erase_param.area_ratios.extend(function['args']['area_ratios'])
        f.random_erase_param.aspect_ratios.extend(function['args']['aspect_ratios'])
        f.random_erase_param.replacements.extend(function['args']['replacements'])
