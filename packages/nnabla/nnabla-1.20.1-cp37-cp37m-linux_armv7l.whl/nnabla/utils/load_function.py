...
def _create_function_instance(ctx, f):
    ...
    if f.type == 'Affine':
        ...
        function = F.CumSum(
            ctx,
            axis=f.cumsum_param.axis,
            exclusive=f.cumsum_param.exclusive,
            reverse=f.cumsum_param.reverse,
            )
    elif f.type == 'Mean':
        function = F.Mean(
            ctx,
        ...
        function = F.CumProd(
            ctx,
            axis=f.cumprod_param.axis,
            exclusive=f.cumprod_param.exclusive,
            reverse=f.cumprod_param.reverse,
            )
        ...
        function = F.SearchSorted(
            ctx,
            right=f.searchsorted_param.right,
            )
        ...
        function = F.Meshgrid(
            ctx,
            ij_indexing=f.meshgrid_param.ij_indexing,
            )
        ...
        function = F.Dropout(
            ...
            output_mask=f.dropout_param.output_mask,
            )
