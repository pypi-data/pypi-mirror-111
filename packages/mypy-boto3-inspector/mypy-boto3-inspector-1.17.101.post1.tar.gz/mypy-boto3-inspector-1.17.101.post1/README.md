...
[boto3.Inspector 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/inspector.html#Inspector)
...
def get_structure() -> AddAttributesToFindingsRequestTypeDef:
    return {
      ...
    }
```
