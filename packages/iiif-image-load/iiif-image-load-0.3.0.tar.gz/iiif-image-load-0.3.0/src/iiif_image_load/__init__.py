...
async def __download_manager(url: str, headers: dict, x: int = None, y: int = None, width: int = None, height: int = None, proxy: str = None, username: str = None, password: str = None) -> ndarray:
...
def iiif_image_from_url(url: str, headers: dict={}, x: int = None, y: int = None, width: int = None, height: int = None, proxy: str = None, username: str = None, password: str = None) -> ndarray:
    ...
    return loop.run_until_complete(__download_manager(url, headers, x, y, width, height, proxy, username, password))
