...
class SyntheticsClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.can_paginate)
    ...
    def create_canary(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.create_canary)
    ...
    def delete_canary(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.delete_canary)
    ...
    def describe_canaries(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.describe_canaries)
    ...
    def describe_canaries_last_run(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.describe_canaries_last_run)
    ...
    def describe_runtime_versions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.describe_runtime_versions)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.generate_presigned_url)
    ...
    def get_canary(self, *, Name: str) -> GetCanaryResponseResponseTypeDef:
        """
        Retrieves complete information about one canary.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.get_canary)
    ...
    def get_canary_runs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.get_canary_runs)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.list_tags_for_resource)
    ...
    def start_canary(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.start_canary)
    ...
    def stop_canary(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.stop_canary)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: Dict[str, str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.untag_resource)
    ...
    def update_canary(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/synthetics.html#Synthetics.Client.update_canary)
