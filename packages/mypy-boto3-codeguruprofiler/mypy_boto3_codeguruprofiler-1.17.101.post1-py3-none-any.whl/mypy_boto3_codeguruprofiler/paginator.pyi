...
from .type_defs import ListProfileTimesResponseResponseTypeDef, PaginatorConfigTypeDef
...
class ListProfileTimesPaginator(Boto3Paginator):
    ...
    ) -> Iterator[ListProfileTimesResponseResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codeguruprofiler.html#CodeGuruProfiler.Paginator.ListProfileTimes.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_codeguruprofiler/paginators.html#listprofiletimespaginator)
        """
