...
[boto3.CodeGuruProfiler 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codeguruprofiler.html#CodeGuruProfiler)
...
def get_structure() -> AddNotificationChannelsRequestTypeDef:
    return {
      ...
    }
```
