...
class RunSettings(WorkspaceTelemetryMixin):
    ...
    def validate(self, raise_error=False, process_error=None):
        """
        ...
        return self._validate(all_settings, raise_error, process_error)

    def _validate(self, all_settings, raise_error=False, process_error=None):
        errors = []
        ...
        for section in self._sections_mapping.values():
            section._validate(all_settings, raise_error, process_error)
        return errors
