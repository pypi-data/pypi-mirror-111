...
class PipelineComponentOperations(object):
    ...
    def get_pipeline_component_graph(
            self, subscription_id, resource_group_name, workspace_name, graph_id=None, graph_draft_id=None, include_run_setting_params=True, has_namespace_concept=True, skip_dataset_load=False, custom_headers=None, raw=False, **operation_config):
        """
