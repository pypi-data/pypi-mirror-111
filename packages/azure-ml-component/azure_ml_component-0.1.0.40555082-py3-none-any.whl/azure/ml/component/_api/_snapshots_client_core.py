...
from azureml._restclient.constants import SNAPSHOT_MAX_FILES, ONE_MB, SNAPSHOT_MAX_SIZE_BYTES
...
TIMEOUT = 30
AZUREML_SNAPSHOT_DEFAULT_TIMEOUT = 600


"""
THIS CLIENT IS COPIED FROM azureml._restclient.snapshot_client.py TO RESOLVE POTENTIAL DEPENDENCY ISSUE.
WE NEED TO KEEP MERGE WITH THE ORIGINAL FILE.
