        ...
        def wrapper(*wrapper_args) -> List[float]:
            ...
            if is_first_call:
                ...
                if selected_controller is MabController:
                    params = OrderedDict(
                        {
                            "cover": list(range(1, 50)),
                            "mab_weight_epsilon": [i / 100 for i in range(1, 70)],
                            "mab_weight_bandwidth": list(range(1, 70)),
                        }
                    )
                else:
                    ...
                    params = OrderedDict(
                        {
                            "nth_nearest": list(range(1, 15)),
                            "mab_epsilon": [i / 100 for i in range(1, 70)],
                            "mab_bandwidth": list(range(1, 70)),
                            "mab_weight_epsilon": [i / 100 for i in range(1, 70)],
                            "mab_weight_bandwidth": list(range(1, 70)),
                        }
                    )
