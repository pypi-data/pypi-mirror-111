        ...
        def wrapper(*wrapper_args) -> List[float]:
            ...
            if is_first_call:
                ...
                if selected_controller is MabController:
                    params = OrderedDict(
                        {
                            "cover": list(range(3, 10)),
                            "mab_weight_epsilon": [i / 100 for i in range(1, 21)],
                            "mab_weight_bandwidth": list(range(3, 10)),
                        }
                    )
                else:
                    params = OrderedDict(
                        {
                            ...
                            "mab_epsilon": [i / 100 for i in range(1, 21)],
                            "mab_bandwidth": list(range(1, 6)),
                            "mab_weight_epsilon": [i / 100 for i in range(1, 21)],
                            "mab_weight_bandwidth": list(range(1, 6)),
                        }
                    )
