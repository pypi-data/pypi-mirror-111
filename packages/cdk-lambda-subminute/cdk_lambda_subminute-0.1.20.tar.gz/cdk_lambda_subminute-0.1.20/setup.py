    ...
    """
{
    ...
    "package_data": {
        "cdk_lambda_subminute._jsii": [
            "cdk-lambda-subminute@0.1.20.jsii.tgz"
        ],
        "cdk_lambda_subminute": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-nodejs>=1.110.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.110.0, <2.0.0",
        "aws-cdk.aws-logs>=1.110.0, <2.0.0",
        "aws-cdk.aws-stepfunctions-tasks>=1.110.0, <2.0.0",
        "aws-cdk.aws-stepfunctions>=1.110.0, <2.0.0",
