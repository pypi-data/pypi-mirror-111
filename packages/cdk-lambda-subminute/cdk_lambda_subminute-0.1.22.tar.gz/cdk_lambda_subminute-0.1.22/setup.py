    ...
    """
{
    ...
    "package_data": {
        "cdk_lambda_subminute._jsii": [
            "cdk-lambda-subminute@0.1.22.jsii.tgz"
        ],
        "cdk_lambda_subminute": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-events-targets>=1.110.1, <2.0.0",
        "aws-cdk.aws-events>=1.110.1, <2.0.0",
        "aws-cdk.aws-iam>=1.110.1, <2.0.0",
        "aws-cdk.aws-lambda-nodejs>=1.110.1, <2.0.0",
        "aws-cdk.aws-lambda>=1.110.1, <2.0.0",
        "aws-cdk.aws-logs>=1.110.1, <2.0.0",
        "aws-cdk.aws-stepfunctions-tasks>=1.110.1, <2.0.0",
        "aws-cdk.aws-stepfunctions>=1.110.1, <2.0.0",
