...
def parse_args():
    parser = argparse.ArgumentParser(description='A command line tool to poll modbus registers')
    ...
    parser.add_argument('--timeout', default=1.0, type=float, help='Response time-out for MODBUS devices')
