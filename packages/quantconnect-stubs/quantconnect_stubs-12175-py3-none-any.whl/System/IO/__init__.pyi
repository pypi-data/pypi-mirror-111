...
class Stream(System.MarshalByRefObject, System.IDisposable, System.IAsyncDisposable, metaclass=abc.ABCMeta):
    ...
    def CreateWaitHandle(self) -> System.Threading.WaitHandle:
        ...
        """
        warnings.warn("CreateWaitHandle will be removed eventually.  Please use \"new ManualResetEvent(false)\" instead.", DeprecationWarning)
...
class FileStream(System.IO.Stream):
    ...
    def Handle(self) -> System.IntPtr:
        ...
        warnings.warn("This property has been deprecated.  Please use FileStream's SafeFileHandle property instead.  https://go.microsoft.com/fwlink/?linkid=14202", DeprecationWarning)
...
class RandomAccess(System.Object):
    ...
    @staticmethod
    @typing.overload
    def Write(handle: Microsoft.Win32.SafeHandles.SafeFileHandle, buffer: System.ReadOnlySpan[int], fileOffset: int) -> int:
        """
        ...
        :returns: The total number of bytes written into the file. This can be less than the number of bytes provided in the buffer and it's not an error.
        """
        ...

    @staticmethod
    @typing.overload
    def Write(handle: Microsoft.Win32.SafeHandles.SafeFileHandle, buffers: System.Collections.Generic.IReadOnlyList[System.ReadOnlyMemory[int]], fileOffset: int) -> int:
        """
        ...
        :param fileOffset: The file position to write to.
        :returns: The total number of bytes written into the file. This can be less than the number of bytes provided in the buffers and it's not an error.
        """
        ...

    @staticmethod
    @typing.overload
    def WriteAsync(handle: Microsoft.Win32.SafeHandles.SafeFileHandle, buffer: System.ReadOnlyMemory[int], fileOffset: int, cancellationToken: System.Threading.CancellationToken = ...) -> System.Threading.Tasks.ValueTask[int]:
        """
        Writes a sequence of bytes from given buffer to given file at given offset.
    ...
    @staticmethod
    @typing.overload
    def WriteAsync(handle: Microsoft.Win32.SafeHandles.SafeFileHandle, buffers: System.Collections.Generic.IReadOnlyList[System.ReadOnlyMemory[int]], fileOffset: int, cancellationToken: System.Threading.CancellationToken = ...) -> System.Threading.Tasks.ValueTask[int]:
        """
        Writes a sequence of bytes from given buffers to given file at given offset.
