...
class LeanData(System.Object):
    ...
    @staticmethod
    def TryParseSecurityType(fileName: str, securityType: typing.Optional[QuantConnect.SecurityType]) -> typing.Union[bool, QuantConnect.SecurityType]:
        """
        Parses file name into a Security and DateTime
...
class CurrencyPairUtil(System.Object):
    ...
    @staticmethod
    def DecomposeCurrencyPair(currencyPair: typing.Union[QuantConnect.Symbol, str], baseCurrency: typing.Optional[str], quoteCurrency: typing.Optional[str]) -> typing.Union[None, str, str]:
        """
