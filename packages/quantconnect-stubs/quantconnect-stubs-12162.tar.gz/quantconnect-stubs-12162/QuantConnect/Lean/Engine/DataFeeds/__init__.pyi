...
class ZipEntryNameSubscriptionDataSourceReader(System.Object, QuantConnect.Lean.Engine.DataFeeds.ISubscriptionDataSourceReader):
    ...
    def __init__(self, dataProvider: QuantConnect.Interfaces.IDataProvider, config: QuantConnect.Data.SubscriptionDataConfig, date: typing.Union[datetime.datetime, datetime.date], isLiveMode: bool) -> None:
        """
...
class ApiDataProvider(QuantConnect.Lean.Engine.DataFeeds.DefaultDataProvider):
    ...
    def DownloadData(self, filePath: str) -> System.IO.FileStream:
        """
