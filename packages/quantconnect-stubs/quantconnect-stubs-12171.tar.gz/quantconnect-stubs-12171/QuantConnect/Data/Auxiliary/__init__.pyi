...
class FactorFileRow(System.Object):
    ...
    @staticmethod
    def Read(file: System.IO.Stream, factorFileMinimumDate: typing.Optional[typing.Optional[datetime.datetime]]) -> typing.Union[System.Collections.Generic.IEnumerable[QuantConnect.Data.Auxiliary.FactorFileRow], typing.Optional[datetime.datetime]]:
...
class FactorFile(System.Object, typing.Iterable[QuantConnect.Data.Auxiliary.FactorFileRow]):
    ...
    @staticmethod
    def Read(permtick: str, file: System.IO.Stream) -> QuantConnect.Data.Auxiliary.FactorFile:
...
class FactorFileZipHelper(System.Object):
    ...
    @staticmethod
    def ReadFactorFileZip(file: System.IO.Stream, mapFileResolver: QuantConnect.Data.Auxiliary.MapFileResolver, market: str) -> System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[QuantConnect.Symbol, QuantConnect.Data.Auxiliary.FactorFile]]:
        """Reads the zip bytes as text and parses as FactorFileRows to create FactorFiles"""
        ...

    @staticmethod
    def SafeRead(filename: str, contents: System.Collections.Generic.IEnumerable[str]) -> QuantConnect.Data.Auxiliary.FactorFile:
...
class MapFileZipHelper(System.Object):
    ...
    @staticmethod
    def GetMapFileZipFileName(market: str, date: typing.Union[datetime.datetime, datetime.date]) -> str:
        """Gets the mapfile zip filename for the specified date"""
        ...

    @staticmethod
    def ReadMapFileZip(file: System.IO.Stream) -> System.Collections.Generic.IEnumerable[QuantConnect.Data.Auxiliary.MapFile]:
