...
class LeanDataWriter(System.Object):
    ...
    @typing.overload
    def __init__(self, resolution: QuantConnect.Resolution, symbol: typing.Union[QuantConnect.Symbol, str], dataDirectory: str, tickType: QuantConnect.TickType = ...) -> None:
        """
    ...
    @typing.overload
    def __init__(self, dataDirectory: str, resolution: QuantConnect.Resolution, securityType: QuantConnect.SecurityType, tickType: QuantConnect.TickType) -> None:
        """
        Create a new lean data writer to this base data directory.
