...
[boto3.MediaConnect 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/mediaconnect.html#MediaConnect)
...
def get_structure() -> AddFlowMediaStreamsRequestTypeDef:
    return {
      ...
    }
```
