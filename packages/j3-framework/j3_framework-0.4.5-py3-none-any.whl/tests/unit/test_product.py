...
def test_prefers_warehouse_batches_to_shipments():
    ...
    product = Product(sku="RETRO-CLOCK", items=[in_stock_batch, shipment_batch])
...
def test_returns_allocated_batch_ref():
    ...
    product = Product(sku="HIGHBROW-POSTER", items=[in_stock_batch, shipment_batch])
...
def test_increments_version_number():
    ...
    product = Product(
        sku="SCANDI-PEN", items=[Batch("b1", "SCANDI-PEN", 100, eta=None)]
    )
