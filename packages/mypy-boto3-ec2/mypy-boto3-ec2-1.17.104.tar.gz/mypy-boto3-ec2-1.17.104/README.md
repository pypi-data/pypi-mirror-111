...
[boto3.EC2 1.17.104](https://boto3.amazonaws.com/v1/documentation/api/1.17.104/reference/services/ec2.html#EC2)
...
def get_structure() -> AcceptReservedInstancesExchangeQuoteRequestRequestTypeDef:
    return {
      ...
    }
```
