...
[boto3.LakeFormation 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/lakeformation.html#LakeFormation)
...
def get_structure() -> AddLFTagsToResourceRequestTypeDef:
    return {
      ...
    }
```
