    ...
    """
{
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-certificatemanager>=1.109.0, <2.0.0",
        "aws-cdk.aws-cloudfront-origins>=1.109.0, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.109.0, <2.0.0",
        ...
        "aws-cdk.aws-iam>=1.109.0, <2.0.0",
        "aws-cdk.aws-lambda-event-sources>=1.109.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.109.0, <2.0.0",
        "aws-cdk.aws-logs>=1.109.0, <2.0.0",
        "aws-cdk.aws-route53-targets>=1.109.0, <2.0.0",
        "aws-cdk.aws-route53>=1.109.0, <2.0.0",
        "aws-cdk.aws-s3-deployment>=1.109.0, <2.0.0",
        "aws-cdk.aws-s3>=1.109.0, <2.0.0",
        "aws-cdk.aws-sns>=1.109.0, <2.0.0",
        "aws-cdk.aws-sqs>=1.109.0, <2.0.0",
        "aws-cdk.core>=1.109.0, <2.0.0",
        "aws-cdk.cx-api>=1.109.0, <2.0.0",
        "cdk-watchful>=0.5.154, <0.6.0",
