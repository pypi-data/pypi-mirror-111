...
[boto3.PersonalizeRuntime 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/personalize-runtime.html#PersonalizeRuntime)
...
def get_structure() -> GetPersonalizedRankingRequestTypeDef:
    return {
      ...
    }
```
