...
class PatchedmavenMavenRemote(object):
    ...
    def max_retries(self):
        """Gets the max_retries of this PatchedmavenMavenRemote.  # noqa: E501

        Maximum number of retry attempts after a download failure. If not set then the default value (3) will be used.  # noqa: E501

        :return: The max_retries of this PatchedmavenMavenRemote.  # noqa: E501
        :rtype: int
        """
    ...
    def max_retries(self, max_retries):
        """Sets the max_retries of this PatchedmavenMavenRemote.

        Maximum number of retry attempts after a download failure. If not set then the default value (3) will be used.  # noqa: E501

        :param max_retries: The max_retries of this PatchedmavenMavenRemote.  # noqa: E501
        :type: int
        """
