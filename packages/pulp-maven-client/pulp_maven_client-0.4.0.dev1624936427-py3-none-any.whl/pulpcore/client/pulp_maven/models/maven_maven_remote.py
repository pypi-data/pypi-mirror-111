...
class MavenMavenRemote(object):
    ...
    def max_retries(self, max_retries):
        """Sets the max_retries of this MavenMavenRemote.

        Maximum number of retry attempts after a download failure. If not set then the default value (3) will be used.  # noqa: E501

        :param max_retries: The max_retries of this MavenMavenRemote.  # noqa: E501
        :type: int
        """
