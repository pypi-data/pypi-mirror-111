...
def set_one_by_year(params, folder, data_irrig = None):
    ...
    first_year = int(params["general"]["first_year"])
    last_year = int(params["general"]["last_year"])
    ...
    for year in range(first_year, last_year + 1):
        ...
        correct_date_start = get_correct_date_start(year, first_year, params["controls"])

        x.set_controls(sim_start = params["controls"]["sim_start"],
                       date_start = correct_date_start,
...
def get_correct_date_start(current_year, first_year, controls_params):
    original_date_start = date.fromisoformat(controls_params["date_start"])
    original_years_difference = first_year - original_date_start.year
    current_date_start_year = current_year - original_years_difference 
    current_date_start = date(current_date_start_year, original_date_start.month, original_date_start.day)
    return current_date_start.isoformat()