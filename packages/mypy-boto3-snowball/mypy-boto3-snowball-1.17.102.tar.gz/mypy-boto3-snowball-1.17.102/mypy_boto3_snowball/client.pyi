...
class SnowballClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.can_paginate)
    ...
    def cancel_cluster(self, *, ClusterId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.cancel_cluster)
    ...
    def cancel_job(self, *, JobId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.cancel_job)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_snowball/client.html#cancel_job)
        """
    def create_address(self, *, Address: "AddressTypeDef") -> CreateAddressResultResponseTypeDef:
        """
        Creates an address for a Snow device to be shipped to.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.create_address)
    ...
    def create_cluster(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.create_cluster)
    ...
    def create_job(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.create_job)
    ...
    def create_long_term_pricing(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.create_long_term_pricing)
    ...
    def create_return_shipping_label(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.create_return_shipping_label)
        ...
        """
    def describe_address(self, *, AddressId: str) -> DescribeAddressResultResponseTypeDef:
        """
        Takes an `AddressId` and returns specific details about that address in the form
        of an `Address` object.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.describe_address)
    ...
    def describe_addresses(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.describe_addresses)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_snowball/client.html#describe_addresses)
        """
    def describe_cluster(self, *, ClusterId: str) -> DescribeClusterResultResponseTypeDef:
        """
        Returns information about a specific cluster including shipping information,
        cluster status, and other important metadata.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.describe_cluster)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_snowball/client.html#describe_cluster)
        """
    def describe_job(self, *, JobId: str) -> DescribeJobResultResponseTypeDef:
        """
        Returns information about a specific job including shipping information, job
        status, and other important metadata.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.describe_job)
    ...
    def describe_return_shipping_label(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.describe_return_shipping_label)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.generate_presigned_url)
        ...
        """
    def get_job_manifest(self, *, JobId: str) -> GetJobManifestResultResponseTypeDef:
        """
        Returns a link to an Amazon S3 presigned URL for the manifest file associated
        with the specified `JobId` value.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.get_job_manifest)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_snowball/client.html#get_job_manifest)
        """
    def get_job_unlock_code(self, *, JobId: str) -> GetJobUnlockCodeResultResponseTypeDef:
        """
        Returns the `UnlockCode` code value for the specified job.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.get_job_unlock_code)
        ...
        """
    def get_snowball_usage(self) -> GetSnowballUsageResultResponseTypeDef:
        """
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.get_snowball_usage)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_snowball/client.html#get_snowball_usage)
        """
    def get_software_updates(self, *, JobId: str) -> GetSoftwareUpdatesResultResponseTypeDef:
        """
        Returns an Amazon S3 presigned URL for an update file associated with a
        specified `JobId` .

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.get_software_updates)
    ...
    def list_cluster_jobs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.list_cluster_jobs)
    ...
    def list_clusters(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.list_clusters)
    ...
    def list_compatible_images(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.list_compatible_images)
    ...
    def list_jobs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.list_jobs)
    ...
    def list_long_term_pricing(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.list_long_term_pricing)
    ...
    def update_cluster(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.update_cluster)
    ...
    def update_job(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.update_job)
    ...
    def update_job_shipment_state(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.update_job_shipment_state)
    ...
    def update_long_term_pricing(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Client.update_long_term_pricing)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Paginator.DescribeAddresses)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Paginator.ListClusterJobs)
    ...
    def get_paginator(self, operation_name: Literal["list_clusters"]) -> ListClustersPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Paginator.ListClusters)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Paginator.ListCompatibleImages)
    ...
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/snowball.html#Snowball.Paginator.ListJobs)
