...
[boto3.CustomerProfiles 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/customer-profiles.html#CustomerProfiles)
...
def get_structure() -> AddProfileKeyRequestTypeDef:
    return {
      ...
    }
```
