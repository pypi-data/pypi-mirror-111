...
[boto3.IoTDataPlane 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/iot-data.html#IoTDataPlane)
...
def get_structure() -> DeleteThingShadowRequestTypeDef:
    return {
      ...
    }
```
