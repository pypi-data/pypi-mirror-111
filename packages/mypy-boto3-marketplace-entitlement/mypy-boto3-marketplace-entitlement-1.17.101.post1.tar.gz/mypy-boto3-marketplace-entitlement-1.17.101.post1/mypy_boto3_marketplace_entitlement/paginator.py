...
from .type_defs import GetEntitlementsResultResponseTypeDef, PaginatorConfigTypeDef
...
class GetEntitlementsPaginator(Boto3Paginator):
    ...
    ) -> Iterator[GetEntitlementsResultResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService.Paginator.GetEntitlements.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_marketplace_entitlement/paginators.html#getentitlementspaginator)
        """
