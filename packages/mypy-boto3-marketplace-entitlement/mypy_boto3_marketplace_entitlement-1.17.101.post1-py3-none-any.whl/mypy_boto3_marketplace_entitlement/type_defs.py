...
_RequiredGetEntitlementsRequestTypeDef = TypedDict(
    "_RequiredGetEntitlementsRequestTypeDef",
    {
        "ProductCode": str,
    },
)
_OptionalGetEntitlementsRequestTypeDef = TypedDict(
    "_OptionalGetEntitlementsRequestTypeDef",
    {
...
class GetEntitlementsRequestTypeDef(
    _RequiredGetEntitlementsRequestTypeDef, _OptionalGetEntitlementsRequestTypeDef
):
    pass


GetEntitlementsResultResponseTypeDef = TypedDict(
    "GetEntitlementsResultResponseTypeDef",
    {
