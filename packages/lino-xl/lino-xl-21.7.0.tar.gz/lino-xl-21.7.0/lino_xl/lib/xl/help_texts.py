...
follows:"""),
    ...
    'lino_xl.lib.ledger.PaymentMethod.journal' : _("""Which journal to use."""),
...
tax office."""),
    ...
    'lino_xl.lib.working.WorkedHours' : _("""Shows a summary of your work sessions of the last seven
days, one row per day."""),
    'lino_xl.lib.working.ServiceReport' : _("""Django model representing a service report."""),
