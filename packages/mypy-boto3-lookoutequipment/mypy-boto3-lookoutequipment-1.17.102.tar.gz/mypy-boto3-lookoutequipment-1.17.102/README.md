...
[boto3.LookoutEquipment 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/lookoutequipment.html#LookoutEquipment)
...
def get_structure() -> CreateDatasetRequestTypeDef:
    return {
      ...
    }
```
