...
class Gauge():
    ...
    @calibration.setter
    def calibration(self, channel, value):
    ...
    @property
    def offset_correction(self, channel):
    ...
    def offset_correction(self, channel, value):
    ...
    @property
    def offset_display(self, channel):
        """Return offset display factor of specified gauge.
        """
        ofd = self.query('OFD').split(',')[channel-1]
        return ofd

    @offset_display.setter
    def offset_display(self, channel, value):
    ...
    @property
    def switching_function_status(self):
...
class GaugeSerial(Gauge):
    ...
    def __init__(self, port=None, baudrate=None, bytesize=None,
        ...
        super().__init__()
        self._ser = serial.Serial(bytesize=bytesize,
                                  parity=parity,
                                  stopbits=stopbits,
                                  timeout=timeout)
        self.port = port
