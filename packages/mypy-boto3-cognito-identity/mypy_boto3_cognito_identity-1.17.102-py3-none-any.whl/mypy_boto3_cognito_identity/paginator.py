...
from .type_defs import ListIdentityPoolsResponseResponseTypeDef, PaginatorConfigTypeDef
...
class ListIdentityPoolsPaginator(Boto3Paginator):
    ...
    ) -> Iterator[ListIdentityPoolsResponseResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/cognito-identity.html#CognitoIdentity.Paginator.ListIdentityPools.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_cognito_identity/paginators.html#listidentitypoolspaginator)
        """
