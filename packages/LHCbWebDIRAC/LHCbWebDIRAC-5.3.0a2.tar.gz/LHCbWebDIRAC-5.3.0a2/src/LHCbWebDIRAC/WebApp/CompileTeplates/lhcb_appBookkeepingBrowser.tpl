  ...
  {% autoescape None %}
    ...
    <script type="text/javascript">
     ...
     Ext.Loader.setPath({
        ...
        Ext.require('LHCbDIRAC.BookkeepingBrowser.classes.BookkeepingBrowser');
...
sencha -sdk /opt/dirac/WebPrototype/WebAppDIRAC/WebApp/static/extjs/ext-4.2.1.883/src compile -classpath=/opt/dirac/WebPrototype/WebAppDIRAC/WebApp/static/core/js/utils,/opt/dirac/WebPrototype/WebAppDIRAC/WebApp/static/core/js/core,/opt/dirac/WebPrototype/WebAppDIRAC/WebApp/static/extjs/ext-4.2.1.883/examples/ux/form,/opt/dirac/WebPrototype/WebAppDIRAC/WebApp/static/core/js/views,/opt/dirac/WebPrototype/LHCbWebDIRAC/WebApp/static/LHCbDIRAC/BookkeepingBrowser/classes -debug=true page -name=page -in /opt/dirac/WebPrototype/LHCbWebDIRAC/WebApp/CompileTeplates/lhcb_appBookkeepingBrowser.tpl -out /opt/dirac/WebPrototype/LHCbWebDIRAC/WebApp/static/LHCbDIRAC/BookkeepingBrowser/build/index.html and restore page and exclude -not -namespace Ext.dirac.*,DIRAC.*,LHCbDIRAC.* and concat -yui /opt/dirac/WebPrototype/LHCbWebDIRAC/WebApp/static/LHCbDIRAC/BookkeepingBrowser/build/BookkeepingBrowser.js
