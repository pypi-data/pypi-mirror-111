...
AssociateCertificateRequestTypeDef = TypedDict(
    "AssociateCertificateRequestTypeDef",
    {
        "Arn": str,
    },
...
DescribeEndpointsRequestTypeDef = TypedDict(
    "DescribeEndpointsRequestTypeDef",
    {
        "MaxResults": int,
...
DisassociateCertificateRequestTypeDef = TypedDict(
    "DisassociateCertificateRequestTypeDef",
    {
        "Arn": str,
    },
...
GetJobTemplateRequestTypeDef = TypedDict(
    "GetJobTemplateRequestTypeDef",
    {
        "Name": str,
    },
...
GetJobTemplateResponseResponseTypeDef = TypedDict(
    "GetJobTemplateResponseResponseTypeDef",
    {
        "JobTemplate": "JobTemplateTypeDef",
        "ResponseMetadata": "ResponseMetadataTypeDef",
...
GetPresetRequestTypeDef = TypedDict(
    "GetPresetRequestTypeDef",
    {
        "Name": str,
    },
...
GetPresetResponseResponseTypeDef = TypedDict(
    "GetPresetResponseResponseTypeDef",
    {
        "Preset": "PresetTypeDef",
        "ResponseMetadata": "ResponseMetadataTypeDef",
...
GetQueueRequestTypeDef = TypedDict(
    "GetQueueRequestTypeDef",
    {
        "Name": str,
    },
...
GetQueueResponseResponseTypeDef = TypedDict(
    "GetQueueResponseResponseTypeDef",
    {
        "Queue": "QueueTypeDef",
        "ResponseMetadata": "ResponseMetadataTypeDef",
...
_RequiredUpdateJobTemplateRequestTypeDef = TypedDict(
    "_RequiredUpdateJobTemplateRequestTypeDef",
    {
        "Name": str,
    },
)
_OptionalUpdateJobTemplateRequestTypeDef = TypedDict(
    "_OptionalUpdateJobTemplateRequestTypeDef",
    {
        "AccelerationSettings": "AccelerationSettingsTypeDef",
        "Category": str,
        "Description": str,
...
class UpdateJobTemplateRequestTypeDef(
    _RequiredUpdateJobTemplateRequestTypeDef, _OptionalUpdateJobTemplateRequestTypeDef
):
    pass


UpdateJobTemplateResponseResponseTypeDef = TypedDict(
    "UpdateJobTemplateResponseResponseTypeDef",
    {
        "JobTemplate": "JobTemplateTypeDef",
        "ResponseMetadata": "ResponseMetadataTypeDef",
...
_RequiredUpdatePresetRequestTypeDef = TypedDict(
    "_RequiredUpdatePresetRequestTypeDef",
    {
        "Name": str,
    },
)
_OptionalUpdatePresetRequestTypeDef = TypedDict(
    "_OptionalUpdatePresetRequestTypeDef",
    {
        "Category": str,
        "Description": str,
        "Settings": "PresetSettingsTypeDef",
...
class UpdatePresetRequestTypeDef(
    _RequiredUpdatePresetRequestTypeDef, _OptionalUpdatePresetRequestTypeDef
):
    pass


UpdatePresetResponseResponseTypeDef = TypedDict(
    "UpdatePresetResponseResponseTypeDef",
    {
        "Preset": "PresetTypeDef",
        "ResponseMetadata": "ResponseMetadataTypeDef",
...
_RequiredUpdateQueueRequestTypeDef = TypedDict(
    "_RequiredUpdateQueueRequestTypeDef",
    {
        "Name": str,
    },
)
_OptionalUpdateQueueRequestTypeDef = TypedDict(
    "_OptionalUpdateQueueRequestTypeDef",
    {
        "Description": str,
        "ReservationPlanSettings": "ReservationPlanSettingsTypeDef",
        "Status": QueueStatusType,
...
class UpdateQueueRequestTypeDef(
    _RequiredUpdateQueueRequestTypeDef, _OptionalUpdateQueueRequestTypeDef
):
    pass


UpdateQueueResponseResponseTypeDef = TypedDict(
    "UpdateQueueResponseResponseTypeDef",
    {
        "Queue": "QueueTypeDef",
        "ResponseMetadata": "ResponseMetadataTypeDef",
