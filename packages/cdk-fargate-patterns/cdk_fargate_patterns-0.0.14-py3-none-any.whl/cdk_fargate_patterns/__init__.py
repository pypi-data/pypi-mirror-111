...
class FargateTaskProps:
    def __init__(
        ...
        *,
        ...
        internal_only: typing.Optional[builtins.bool] = None,
        ...
        :param internal_only: Internal only. Do not expose the service on the internet-facing load balancer. Default: false
        ...
        if internal_only is not None:
            self._values["internal_only"] = internal_only
    ...
    @builtins.property
    def internal_only(self) -> typing.Optional[builtins.bool]:
        '''Internal only.

        Do not expose the service on the internet-facing load balancer.

        :default: false
        '''
        result = self._values.get("internal_only")
        return typing.cast(typing.Optional[builtins.bool], result)
