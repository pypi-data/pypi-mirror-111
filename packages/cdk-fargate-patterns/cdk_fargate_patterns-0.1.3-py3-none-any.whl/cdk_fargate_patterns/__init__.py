...
class FargateTaskProps:
    def __init__(
        ...
        *,
        ...
        :param listener_port: 
        :param task: 
        :param accessibility: Register the service to internal ALB, external ALB or both. Default: both
...
@jsii.enum(jsii_type="cdk-fargate-patterns.LoadBalancerAccessibility")
