...
class COPASISolver(WhiteBoxSolver):
    ...
    def build_copasi_optimisation_problem(self, model: Model, opt_problem: COPASI.COptProblem):
    ...
    def _change_starting_point(self, opt_problem: COPASI.COptProblem, treatment: Dict[str, float]):
    ...
    def _simulation_config_for_sub_task(self, model: Model, horizon: float):
        data_model: COPASI.CDataModel = model.instance.model_obj
    ...
    def _run_and_get_output(self, model: Model, opt_task: COPASI.COptTask, opt_problem: COPASI.COptProblem) \
        ...
        statistics: Dict[str, Union[float, list]] = {
            'failed_func_evaluations': opt_problem.getFunctionEvaluations(),
    ...
    def set_restart_configuration(self, n_restarts, restart_treatments):
    ...
    def solve(self, model: Model, H: float, sim_engine: SimulationEngine,
        ...
        if self.n_restarts > 0:
            ...
            sampler = Sampler(model, sim_engine, H)
