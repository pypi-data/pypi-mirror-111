...
[boto3.ServiceDiscovery 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/servicediscovery.html#ServiceDiscovery)
...
def get_structure() -> CreateHttpNamespaceRequestTypeDef:
    return {
      ...
    }
```
