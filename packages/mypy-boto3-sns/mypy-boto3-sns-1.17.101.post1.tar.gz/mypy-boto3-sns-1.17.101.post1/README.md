...
[boto3.SNS 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/sns.html#SNS)
...
def get_structure() -> AddPermissionInputTopicTypeDef:
    return {
      ...
    }
```
