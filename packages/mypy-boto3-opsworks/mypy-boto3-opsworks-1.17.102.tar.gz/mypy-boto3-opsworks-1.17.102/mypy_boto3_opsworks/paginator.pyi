...
from .type_defs import DescribeEcsClustersResultResponseTypeDef, PaginatorConfigTypeDef
...
class DescribeEcsClustersPaginator(Boto3Paginator):
    ...
    ) -> Iterator[DescribeEcsClustersResultResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/opsworks.html#OpsWorks.Paginator.DescribeEcsClusters.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_opsworks/paginators.html#describeecsclusterspaginator)
        """
