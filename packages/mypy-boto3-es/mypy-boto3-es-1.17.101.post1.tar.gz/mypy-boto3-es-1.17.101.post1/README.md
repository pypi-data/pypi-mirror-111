...
[boto3.ElasticsearchService 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/es.html#ElasticsearchService)
...
def get_structure() -> AcceptInboundCrossClusterSearchConnectionRequestTypeDef:
    return {
      ...
    }
```
