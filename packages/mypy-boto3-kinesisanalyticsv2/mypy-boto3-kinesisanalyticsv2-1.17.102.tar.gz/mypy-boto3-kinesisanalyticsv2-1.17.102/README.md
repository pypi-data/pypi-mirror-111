...
[boto3.KinesisAnalyticsV2 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/kinesisanalyticsv2.html#KinesisAnalyticsV2)
...
def get_structure() -> AddApplicationCloudWatchLoggingOptionRequestTypeDef:
    return {
      ...
    }
```
