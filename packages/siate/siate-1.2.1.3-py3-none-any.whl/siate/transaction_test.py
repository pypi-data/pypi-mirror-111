...
from siate import *
#==============================================================================
compare_security(['000906.SS','000300.SS'],"Close","2004-1-1","2020-12-31",twinx=True)

compare_security(['000906.SS','000300.SS'],"Close","2021-3-1","2021-6-26",twinx=True)

compare_security(['000001.SS','000300.SS'],"Close","2021-1-1","2021-6-26",twinx=True)

compare_security(['000905.SS','000300.SS'],"Close","2021-1-1","2021-6-26",twinx=True)

compare_security(['000688.SS','000300.SS'],"Close","2020-1-1","2021-6-26",twinx=True)
compare_security(['000688.SS','000001.SS'],"Close","2021-1-1","2021-6-26",twinx=True)
compare_security(['000688.SS','000300.SS'],"Close","2020-1-1","2021-6-26",twinx=True)
compare_security(['000688.SS','000001.SS'],"Close","2020-1-1","2021-6-26",twinx=True)

compare_security(['000043.SS','000045.SS'],"Close","2020-1-1","2021-6-26",twinx=True)
#==============================================================================
market_profile_china('SSE')
market_profile_china('SZSE')

#==============================================================================
from siate.bond import *
#==============================================================================
