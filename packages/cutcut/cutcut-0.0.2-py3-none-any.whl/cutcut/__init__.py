...
def _input_fn(str_list, batch_size):
    #预处理
    vocab_file_path = _get_module_datapath('data/vocab.txt')
...
class Cutcut(object):
    ...
    def __init__(self):
        self.wordIndexMap = []
        self.tagIndexMap = {}
        self.model_path = _get_module_datapath('savedModel')
    ...
    def lcut(self, str):
        ...
        batch_size = 1
        res = []
        dataset = _input_fn(str_list, batch_size)
