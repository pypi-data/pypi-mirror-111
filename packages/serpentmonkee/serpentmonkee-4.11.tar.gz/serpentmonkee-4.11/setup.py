...
setup(
    ...
    version='4.11',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/anthromorphic-ai/serpentmonkee/archive/4.11.tar.gz',
