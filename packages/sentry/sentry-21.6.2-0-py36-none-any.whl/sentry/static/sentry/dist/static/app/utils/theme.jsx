...
var dataCategory = (_a = {},
    _a[DataCategory.ERRORS] = CHART_PALETTE[4][3],
    _a[DataCategory.TRANSACTIONS] = CHART_PALETTE[4][2],
    _a[DataCategory.ATTACHMENTS] = CHART_PALETTE[4][1],
    _a[DataCategory.DEFAULT] = CHART_PALETTE[4][0],
    _a);
...
var commonTheme = __assign(__assign({ breakpoints: ['800px', '992px', '1200px', '1440px', '2560px'] }, colors), { iconSizes: iconSizes, iconDirections: {
    ...
    fontSizeRelativeSmall: '0.9em', fontSizeExtraSmall: '11px', fontSizeSmall: '12px', fontSizeMedium: '14px', fontSizeLarge: '16px', fontSizeExtraLarge: '18px', headerFontSize: '22px', settings: {
        ...
        lineHeightBody: '1.4',
    }, dataCategory: dataCategory, tag: tag, level: level, charts: {
    ...
    // used as a gradient,
    businessIconColors: ['#EA5BC2', '#6148CE'], demo: {
        headerSize: '70px',
    } });
var darkAliases = __assign(__assign({}, lightAliases), { bodyBackground: colors.black, headerBackground: colors.gray500, background: colors.black, backgroundSecondary: colors.gray500, border: colors.gray400, innerBorder: colors.gray500, modalBorder: "1px solid " + colors.gray400, modalBoxShadow: '0 15px 40px 0 rgb(67 62 75 / 30%), 0 1px 15px 0 rgb(67 61 74 / 15%)', textColor: colors.white, subText: colors.gray200, linkColor: colors.blue200, linkHoverColor: colors.blue300, disabled: colors.gray400, active: colors.pink300, focus: colors.gray500, inactive: colors.gray200, error: colors.red300, success: colors.green300, primaryButtonBorder: colors.purple200, primaryButtonBorderActive: colors.purple200, secondaryButtonText: colors.purple200, secondaryButtonBorder: colors.purple200, sidebarGradient: 'linear-gradient(6.01deg, #0A090F -8.44%, #1B0921 85.02%)', formPlaceholder: colors.gray400, formText: colors.white, formInputBorder: colors.gray400, rowBackground: colors.gray500, chartLineColor: colors.gray500, chartLabel: colors.gray400, progressBar: colors.purple200, progressBackground: colors.gray400, badgeBackground: colors.gray400, alertBackgroundAlpha: 0.1, overlayBackgroundAlpha: 'rgba(18, 9, 23, 0.7)', tagBarHover: colors.purple300, tagBar: colors.gray400, businessIconColors: [colors.pink100, colors.pink300], badgeText: colors.black, searchTokenBackground: '#1F1A3D', searchTokenBorder: '#554E80', buttonCountActive: colors.gray100, buttonCount: colors.gray400 });
export var lightTheme = __assign(__assign(__assign({}, commonTheme), lightAliases), { alert: generateAlertTheme(lightAliases), badge: generateBadgeTheme(lightAliases), button: generateButtonTheme(lightAliases) });
