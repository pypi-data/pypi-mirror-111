...
_filters_ex['bike'] = {'highway':{'footway','steps','corridor','elevator','escalator','motor','motorway','motorway_link'},
                       'bicycle':{'no'},
                       'service':{'private'},
                       'access':{'private'}}

_filters_ex['walk'] = {'highway':{'cycleway','motor','motorway','motorway_link'},
                       'foot':{'no'},
                       'service':{'private'},
                       'access':{'private'}}
