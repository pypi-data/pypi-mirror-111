...
[boto3.SecurityHub 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/securityhub.html#SecurityHub)
...
def get_structure() -> AcceptAdministratorInvitationRequestTypeDef:
    return {
      ...
    }
```
