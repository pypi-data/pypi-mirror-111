...
[boto3.RAM 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/ram.html#RAM)
...
def get_structure() -> AcceptResourceShareInvitationRequestTypeDef:
    return {
      ...
    }
```
