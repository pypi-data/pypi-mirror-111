...
from .. import (
    ...
    DependenciesUpgradeMechanism as _DependenciesUpgradeMechanism_51d564de,
...
from ..release import BranchOptions as _BranchOptions_13663d08
...
class NextJsProject(
    ...
    def __init__(
        ...
        *,
        ...
        deps_upgrade: typing.Optional[_DependenciesUpgradeMechanism_51d564de] = None,
        ...
        :param dependabot: (deprecated) Include dependabot configuration. Default: false
        :param dependabot_options: (deprecated) Options for dependabot. Default: - default options
        :param deps_upgrade: (experimental) How to handle dependency upgrades. Default: - DependenciesUpgradeMechanism.dependabot if dependabot is true, otherwise a DependenciesUpgradeMechanism.githubWorkflow configured from other passed-in NodeProjectOptions
...
class NextJsProjectOptions(NextJsCommonProjectOptions, _NodeProjectOptions_0a6b3d0f):
    ...
    @builtins.property
    def deps_upgrade(self) -> typing.Optional[_DependenciesUpgradeMechanism_51d564de]:
        ...
        return typing.cast(typing.Optional[_DependenciesUpgradeMechanism_51d564de], result)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_TypeScriptProjectOptions_f9217422, ReactRewireOptions],
    name_mapping={
        "mergify": "mergify",
        "name": "name",
        "auto_approve_options": "autoApproveOptions",
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_NodeProjectOptions_0a6b3d0f, ReactRewireOptions],
    name_mapping={
        "mergify": "mergify",
        "name": "name",
        "auto_approve_options": "autoApproveOptions",
...
class ReactProjectOptions(_NodeProjectOptions_0a6b3d0f, ReactRewireOptions):
    def __init__(
        self,
        *,
        mergify: typing.Optional[builtins.bool] = None,
