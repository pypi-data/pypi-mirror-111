...
def run_ema_main(microT_root_path, intermediate_file_save_path, decrypt_password, delete_raw, date):
    ...
    # watch preprocessing
    run_uema_main(microT_root_path, intermediate_file_save_path, delete_raw, date, date)
