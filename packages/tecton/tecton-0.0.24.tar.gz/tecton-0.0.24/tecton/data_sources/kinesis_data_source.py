...
class KinesisDSConfig(BaseStreamDataSource):
    ...
    def __init__(
        ...
        :param region: AWS region of the stream, e.g: "aws-west".
        :param raw_stream_translator: Python user defined function f(DF) -> DF that takes in raw
        ...
        :param default_initial_stream_position: Initial position in stream, e.g: "latest" or "trim_horizon".
                                                More information available in `AWS Kinesis Documentation`_.
        :param default_watermark_delay_threshold: Watermark time interval, e.g: "30 minutes"
        :param deduplication_columns: (Optional) Columns the stream data that uniquely identify data records.
        ...
        .. _AWS Kinesis Documentation: https://sublime-and-sphinx-guide.readthedocs.io/en/latest/references.html`
        """
