...
class HiveDSConfig(BaseBatchDataSource):
    """
    ...
    def __init__(
        ...
        :param timestamp_column_name: (Optional) Name of timestamp column. Only required if timestamp_format is specified.
    ...
    def _merge_batch_args(self, virtual_data_source_args: virtual_data_source_pb2.VirtualDataSourceArgs):
        virtual_data_source_args.hive_ds_config.CopyFrom(self._args)
