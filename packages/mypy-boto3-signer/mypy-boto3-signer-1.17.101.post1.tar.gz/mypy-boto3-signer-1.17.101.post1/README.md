...
[boto3.signer 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/signer.html#signer)
...
def get_structure() -> AddProfilePermissionRequestTypeDef:
    return {
      ...
    }
```
