...
[boto3.IoTJobsDataPlane 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/iot-jobs-data.html#IoTJobsDataPlane)
...
def get_structure() -> DescribeJobExecutionRequestTypeDef:
    return {
      ...
    }
```
