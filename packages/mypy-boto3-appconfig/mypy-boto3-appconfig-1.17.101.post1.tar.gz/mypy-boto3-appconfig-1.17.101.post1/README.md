...
[boto3.AppConfig 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/appconfig.html#AppConfig)
...
def get_structure() -> ApplicationResponseTypeDef:
    return {
      ...
    }
```
