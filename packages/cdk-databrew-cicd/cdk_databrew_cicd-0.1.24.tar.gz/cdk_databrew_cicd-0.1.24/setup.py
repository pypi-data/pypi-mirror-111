    ...
    """
{
    ...
    "package_data": {
        "cdk_databrew_cicd._jsii": [
            "cdk-databrew-cicd@0.1.24.jsii.tgz"
        ],
        "cdk_databrew_cicd": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-codecommit>=1.110.1, <2.0.0",
        "aws-cdk.aws-codepipeline-actions>=1.110.1, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.110.1, <2.0.0",
