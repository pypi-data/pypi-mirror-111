...
[boto3.ServiceQuotas 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/service-quotas.html#ServiceQuotas)
...
def get_structure() -> DeleteServiceQuotaIncreaseRequestFromTemplateRequestTypeDef:
    return {
      ...
    }
```
