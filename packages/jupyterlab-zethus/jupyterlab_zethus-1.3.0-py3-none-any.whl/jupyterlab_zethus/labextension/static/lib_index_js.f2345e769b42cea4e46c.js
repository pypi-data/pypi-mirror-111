...
class ZethusWidget extends _jupyterlab_docregistry__WEBPACK_IMPORTED_MODULE_0__.DocumentWidget {
    ...
    loadEditor(state) {
        ...
        if (!this.iframe) {
            ...
            window.document.addEventListener(`ZethusUpdateConfig${this.zethusId}`, (e) => {
                console.log("Zethus config updated: ", e);
                this._saveToContext(e.detail.newConfiguration);
            }, false);
        }
        else {
    ...
    _saveToContext(content) {
        this.context.model.fromString(JSON.stringify(content));
    }
...
//# sourceMappingURL=lib_index_js.f2345e769b42cea4e46c.js.map