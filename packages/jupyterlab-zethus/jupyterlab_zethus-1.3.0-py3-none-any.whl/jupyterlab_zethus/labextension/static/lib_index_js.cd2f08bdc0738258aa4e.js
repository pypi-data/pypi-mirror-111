...
class ZethusWidget extends _jupyterlab_docregistry__WEBPACK_IMPORTED_MODULE_0__.DocumentWidget {
    ...
    _onContextReady() {
        ...
        if (this.context.model.toString() === '') {
            this.context.model.fromString((0,_default_config__WEBPACK_IMPORTED_MODULE_4__.default_config)(this._defaultROSEndpoint, this._defaultROSPKGSEndpoint));
        }
...
function activate(app, browserFactory, restorer, settingRegistry, launcher) {
    ...
    const factory = new _editor__WEBPACK_IMPORTED_MODULE_10__.ZethusFactory({
        name: FACTORY,
        fileTypes: ['zethus'],
        defaultFor: ['zethus']
...
//# sourceMappingURL=lib_index_js.cd2f08bdc0738258aa4e.js.map