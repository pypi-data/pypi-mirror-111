...
def parse_input_path(project_files):
    """
    :param typing.Iterable[str] project_files:
...
def parse_input_subscription_id():
    """
    :rtype: typing.Callable
    """
...
def parse_input_resource_group():
    """
    :rtype: typing.Callable
    """
        ...
        if value is None or (
            ...
            value = click.prompt(
                ...
                type=(click.Choice(resource_group_names)
                      if resource_group_names else str),
            )
...
def parse_input_workspace_name():
    ...
    :rtype: typing.Callable
    """
    def parse_input_workspace_name(ctx, param, value):
        """
        TODO
        """
        ...
        if value is None:
            ...
            value = click.prompt(
                ...
                type=ArbitraryChoice(existing_workspaces) if existing_workspaces else str,  # noqa: E501
            )
...
def parse_input_service_connection():
    """
    :rtype: typing.Callable
    """
    def _parse_input_service_connection(ctx, param, value):
        ...
        if value is None:
            value = click.prompt(
                text='Please enter DevOps Service Connection name',
                type=str,
            )
        return value
...
def parse_input_webapp_kind():
    """
    :rtype: typing.Callable
    """
    def _parse_input_webapp_kind(ctx, param, value):
        """
        TODO
        """
        if value is None:
            ...
            click.echo('')
            click.echo('For apps written in flask, Django, or Falcon select WSGI.')
