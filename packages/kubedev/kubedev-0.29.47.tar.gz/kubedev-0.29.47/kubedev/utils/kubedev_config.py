...
class KubedevConfig:
  ...
  @staticmethod
  def get_all_envs(kubedev, build, container, generics):
  ...
  def get_helm_set_env_args(kubedev: dict, env_accessor: object, variable_overrides: dict = dict(), add_unknown_variable_overrides: bool = False, cmdline_as_list: bool = False) -> dict:
    ...
    '''
    (envs, extraEnvs) = KubedevConfig.prepare_envs(KubedevConfig.get_all_envs(kubedev, False, True, True), env_accessor=env_accessor)
