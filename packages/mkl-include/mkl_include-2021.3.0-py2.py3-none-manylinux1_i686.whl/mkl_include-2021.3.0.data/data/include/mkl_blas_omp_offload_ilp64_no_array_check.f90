...
module onemkl_blas_omp_offload_ilp64_no_array_check

  include "mkl_blas_omp_variant_ilp64_no_array_check.f90"
...
end module onemkl_blas_omp_offload_ilp64_no_array_check
