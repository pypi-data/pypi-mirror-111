...
!*******************************************************************************
   ...
   interface
      ...
      subroutine mkl_lapack_cgetrs_batch_strided_omp_offload_ilp64(    &
                                                         trans,        &
                                                         n, nrhs, a,   &
                                                         lda, stride_a,&
                                                         ipiv,         &
      ...
      subroutine mkl_lapack_dgetrs_batch_strided_omp_offload_ilp64(    &
                                                         trans,        &
                                                         n, nrhs, a,   &
                                                         lda, stride_a,&
                                                         ipiv,         &
      ...
      subroutine mkl_lapack_sgetrs_batch_strided_omp_offload_ilp64(    &
                                                         trans,        &
                                                         n, nrhs, a,   &
                                                         lda, stride_a,&
                                                         ipiv,         &
      ...
      subroutine mkl_lapack_zgetrs_batch_strided_omp_offload_ilp64(    &
                                                         trans,        &
                                                         n, nrhs, a,   &
                                                         lda, stride_a,&
                                                         ipiv,         &
      ...
      subroutine mkl_lapack_cgetrsnp_batch_strided_omp_offload_ilp64(    &
                                                           trans,        &
                                                           n, nrhs, a,   &
                                                           lda, stride_a,&
                                                           b, ldb,       &
      ...
      subroutine mkl_lapack_dgetrsnp_batch_strided_omp_offload_ilp64(  &
                                                         trans,        &
                                                         n, nrhs, a,   &
                                                         lda, stride_a,&
                                                         b, ldb,       &
      ...
      subroutine mkl_lapack_sgetrsnp_batch_strided_omp_offload_ilp64(  &
                                                         trans,        &
                                                         n, nrhs, a,   &
                                                         lda, stride_a,&
                                                         b, ldb,       &
      ...
      subroutine mkl_lapack_zgetrsnp_batch_strided_omp_offload_ilp64(  &
                                                         trans,        &
                                                         n, nrhs, a,   &
                                                         lda, stride_a,&
                                                         b, ldb,       &
