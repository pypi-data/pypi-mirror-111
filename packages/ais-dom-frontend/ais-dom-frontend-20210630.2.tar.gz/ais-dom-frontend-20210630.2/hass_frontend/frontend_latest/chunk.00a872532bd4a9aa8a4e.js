/*! For license information please see chunk.00a872532bd4a9aa8a4e.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[5470],{39841:(e,t,r)=>{"use strict";r(65233),r(65660);var i=r(9672),o=r(87156),n=r(50856),a=r(44181);(0,i.k)({_template:n.d`
    <style>
      :host {
        display: block;
        /**
...
`,is:"app-header-layout",behaviors:[a.Y],properties:{hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0}},observers:["resetLayout(isAttached, hasScrollingRegion)"],get header(){return(0,o.vz)(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function(){var e=this.header;if(this.isAttached&&e){this.$.wrapper.classList.remove("initializing"),e.scrollTarget=this.hasScrollingRegion?this.$.contentContainer:this.ownerDocument.documentElement;var t=e.offsetHeight;this.hasScrollingRegion?(e.style.left="",e.style.right=""):requestAnimationFrame(function(){var t=this.getBoundingClientRect(),r=document.documentElement.clientWidth-t.right;e.style.left=t.left+"px",e.style.right=r+"px"}.bind(this));var r=this.$.contentContainer.style;e.fixed&&!e.condenses&&this.hasScrollingRegion?(r.marginTop=t+"px",r.paddingTop=""):(r.paddingTop=t+"px",r.marginTop="")}}})},25782:(e,t,r)=>{"use strict";r(65233),r(65660),r(70019),r(97968);var i=r(9672),o=r(50856),n=r(33760);(0,i.k)({_template:o.d`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[n.U]})},76666:(e,t,r)=>{"use strict";r.d(t,{$:()=>i.$});var i=r(81471)},27849:(e,t,r)=>{"use strict";r(39841);var i=r(50856);r(28426);class o extends(customElements.get("app-header-layout")){static get template(){return i.d`
      <style>
        :host {
          display: block;
          /**
    ...
    >
      ...
      ${Object.values(l.aisConfigSections).map((e=>o.dy`
          <ha-card>
        ...
        `))}
      ${this.cloudStatus&&(0,a.p)(this.hass,"cloud")?o.dy`
            <ha-card>
              <ha-config-navigation
                .hass=${this.hass}
                .showAdvanced=${this.showAdvanced}
          ...
          `:""}
      ${Object.values(l.configSections).map((e=>o.dy`
          <ha-card>
            <ha-config-navigation
              .hass=${this.hass}
              .showAdvanced=${this.showAdvanced}
    ...
    `:e}},{kind:"get",static:!0,key:"styles",value:function(){return[s.Qx,o.iv`
        app-header {
      ...
      `]}}]}}),o.oi)}}]);
//# sourceMappingURL=chunk.00a872532bd4a9aa8a4e.js.map