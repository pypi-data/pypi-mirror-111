...
`)}},o={};function i(e){if(o[e])return o[e].exports;var t=o[e]={exports:{}};return r[e](t,t.exports,i),t.exports}i.m=r,i.d=(e,t)=>{for(var r in t)i.o(t,r)&&!i.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},i.f={},i.e=e=>Promise.all(Object.keys(i.f).reduce(((t,r)=>(i.f[r](e,t),t)),[])),i.u=e=>"chunk."+{216:"7b1ddf88b78cec6fb475",613:"e8b74323e146be17735e",1479:"86fb31b632f8a9052fd9",2678:"109f4648209bc5be0940",6134:"55732089ac51bda555df",6486:"951eeebf62890f48509b",8498:"cccdcfa5e90e7bc133c7",8811:"42500deffd3da0ab7df3"}[e]+".js",i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),e={},t="home-assistant-frontend:",i.l=(r,o,a,n)=>{if(e[r])e[r].push(o);else{var s,l;if(void 0!==a)for(var c=document.getElementsByTagName("script"),d=0;d<c.length;d++){var h=c[d];if(h.getAttribute("src")==r||h.getAttribute("data-webpack")==t+a){s=h;break}}s||(l=!0,(s=document.createElement("script")).charset="utf-8",s.timeout=120,i.nc&&s.setAttribute("nonce",i.nc),s.setAttribute("data-webpack",t+a),s.src=r),e[r]=[o];var p=(t,o)=>{s.onerror=s.onload=null,clearTimeout(u);var i=e[r];if(delete e[r],s.parentNode&&s.parentNode.removeChild(s),i&&i.forEach((e=>e(o))),t)return t(o)},u=setTimeout(p.bind(null,void 0,{type:"timeout",target:s}),12e4);s.onerror=p.bind(null,s.onerror),s.onload=p.bind(null,s.onload),l&&document.head.appendChild(s)}},i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},i.p="/frontend_latest/",(()=>{var e={8017:0};i.f.j=(t,r)=>{var o=i.o(e,t)?e[t]:void 0;if(0!==o)if(o)r.push(o[2]);else{var a=new Promise(((r,i)=>{o=e[t]=[r,i]}));r.push(o[2]=a);var n=i.p+i.u(t),s=new Error;i.l(n,(r=>{if(i.o(e,t)&&(0!==(o=e[t])&&(e[t]=void 0),o)){var a=r&&("load"===r.type?"missing":r.type),n=r&&r.target&&r.target.src;s.message="Loading chunk "+t+" failed.\n("+a+": "+n+")",s.name="ChunkLoadError",s.type=a,s.request=n,o[1](s)}}),"chunk-"+t,t)}};var t=(t,r)=>{for(var o,a,[n,s,l]=r,c=0,d=[];c<n.length;c++)a=n[c],i.o(e,a)&&e[a]&&d.push(e[a][0]),e[a]=0;for(o in s)i.o(s,o)&&(i.m[o]=s[o]);for(l&&l(i),t&&t(r);d.length;)d.shift()()},r=self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[];r.forEach(t.bind(null,0)),r.push=t.bind(null,r.push.bind(r))})(),(()=>{"use strict";i(37846);var e=i(47181);const t=(e,t,r)=>new Promise(((o,i)=>{const a=document.createElement(e);let n="src",s="body";switch(a.onload=()=>o(t),a.onerror=()=>i(t),e){case"script":a.async=!0,r&&(a.type=r);break;case"link":a.type="text/css",a.rel="stylesheet",n="href",s="head"}a[n]=t,document[s].appendChild(a)})),r=e=>t("script",e),o="customElements"in window&&"content"in document.createElement("template"),a="ha-main-window",n=window.name===a?window:parent.name===a?parent:top;var s=i(11654);const l={},c=e=>{const o=(e=>e.html_url?{type:"html",url:e.html_url}:e.module_url&&e.js_url||e.module_url?{type:"module",url:e.module_url}:{type:"js",url:e.js_url})(e);return"js"===o.type?(o.url in l||(l[o.url]=r(o.url)),l[o.url]):"module"===o.type?(i=o.url,t("script",i,"module")):Promise.reject("No valid url found in panel config.");var i};let d,h;function p(e){h&&((e,t)=>{"setProperties"in e?e.setProperties(t):Object.keys(t).forEach((r=>{e[r]=t[r]}))})(h,e)}function u(t,a){const l=document.createElement("style");l.innerHTML="body { margin:0; } \n  @media (prefers-color-scheme: dark) {\n    body {\n      background-color: #111111;\n      color: #e1e1e1;\n    }\n  }",document.head.appendChild(l);const u=t.config._panel_custom;let v=Promise.resolve();o||(v=v.then((()=>r("/static/polyfills/webcomponents-bundle.js")))),v.then((()=>c(u))).then((()=>d||Promise.resolve())).then((()=>{h=(e=>{const t="html_url"in e?`ha-panel-${e.name}`:e.name;return document.createElement(t)})(u);h.addEventListener("hass-toggle-menu",(t=>{window.parent.customPanel&&(0,e.B)(window.parent.customPanel,t.type,t.detail)})),window.addEventListener("location-changed",(e=>{window.parent.customPanel&&window.parent.customPanel.navigate(window.location.pathname,e.detail)})),p({panel:t,...a}),document.body.appendChild(h)}),(e=>{let r;console.error(e,t),"hassio"===t.url_path?(Promise.all([i.e(613),i.e(216),i.e(8498),i.e(6486),i.e(1479),i.e(6134),i.e(2678)]).then(i.bind(i,82678)),r=document.createElement("supervisor-error-screen")):(Promise.all([i.e(613),i.e(8498),i.e(6486),i.e(6134),i.e(8811)]).then(i.bind(i,48811)),r=document.createElement("hass-error-screen"),r.error=`Unable to load the panel source: ${e}.`);const o=document.createElement("style");o.innerHTML=s.e$.cssText,document.body.appendChild(o),r.hass=a.hass,document.body.appendChild(r)})),document.body.addEventListener("click",(t=>{const r=(e=>{if(e.defaultPrevented||0!==e.button||e.metaKey||e.ctrlKey||e.shiftKey)return;const t=e.composedPath().filter((e=>"A"===e.tagName))[0];if(!t||t.target||t.hasAttribute("download")||"external"===t.getAttribute("rel"))return;let r=t.href;if(!r||-1!==r.indexOf("mailto:"))return;const o=window.location,i=o.origin||o.protocol+"//"+o.host;return 0===r.indexOf(i)&&(r=r.substr(i.length),"#"!==r)?(e.preventDefault(),r):void 0})(t);r&&((t,r)=>{const o=(null==r?void 0:r.replace)||!1;var i;o?n.history.replaceState(null!==(i=n.history.state)&&void 0!==i&&i.root?{root:!0}:null,"",t):n.history.pushState(null,"",t),(0,e.B)(n,"location-changed",{replace:o})})(r)}))}window.loadES5Adapter=()=>(d||(d=r("/static/polyfills/custom-elements-es5-adapter.js").catch()),d),document.addEventListener("DOMContentLoaded",(()=>window.parent.customPanel.registerIframe(u,p)),{once:!0})})()})();
//# sourceMappingURL=custom-panel.0c2c333d.js.map