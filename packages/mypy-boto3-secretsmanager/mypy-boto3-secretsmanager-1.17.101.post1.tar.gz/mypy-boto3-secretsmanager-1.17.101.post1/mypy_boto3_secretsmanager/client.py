...
class SecretsManagerClient:
    ...
    def get_paginator(self, operation_name: Literal["list_secrets"]) -> ListSecretsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/secretsmanager.html#SecretsManager.Paginator.ListSecrets)
