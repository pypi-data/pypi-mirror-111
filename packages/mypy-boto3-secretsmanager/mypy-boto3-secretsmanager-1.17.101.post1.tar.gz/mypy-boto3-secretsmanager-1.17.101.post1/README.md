...
[boto3.SecretsManager 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/secretsmanager.html#SecretsManager)
...
def get_structure() -> CancelRotateSecretRequestTypeDef:
    return {
      ...
    }
```
