...
[boto3.ApplicationCostProfiler 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/applicationcostprofiler.html#ApplicationCostProfiler)
...
def get_structure() -> DeleteReportDefinitionRequestTypeDef:
    return {
      ...
    }
```
