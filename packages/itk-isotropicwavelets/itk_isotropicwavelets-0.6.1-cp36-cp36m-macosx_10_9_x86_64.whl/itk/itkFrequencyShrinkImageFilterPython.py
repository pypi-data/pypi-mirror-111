...
def frequency_shrink_image_filter(*args: itkt.ImageLike,  shrink_factors: Union[int, Sequence[int]]=..., shrink_factor: int=..., apply_band_filter: bool=...,**kwargs)-> itkt.ImageSourceReturn:
