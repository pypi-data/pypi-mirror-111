...
def frequency_shrink_via_inverse_fft_image_filter(*args: itkt.ImageLike,  shrink_factors: Union[int, Sequence[int]]=..., shrink_factor: int=...,**kwargs)-> itkt.ImageSourceReturn:
