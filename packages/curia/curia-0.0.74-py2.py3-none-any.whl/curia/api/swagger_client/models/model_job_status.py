...
class ModelJobStatus(object):
    ...
    def __init__(self, id=None, step_name=None, message=None, log_level=None, metadata=None, order=None, progress=None, model_job_id=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
