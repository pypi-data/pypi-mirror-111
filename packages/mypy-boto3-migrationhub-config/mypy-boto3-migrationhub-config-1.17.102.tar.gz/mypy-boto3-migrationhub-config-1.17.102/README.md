...
[boto3.MigrationHubConfig 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/migrationhub-config.html#MigrationHubConfig)
...
def get_structure() -> CreateHomeRegionControlRequestTypeDef:
    return {
      ...
    }
```
