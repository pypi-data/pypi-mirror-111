...
[boto3.Organizations 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/organizations.html#Organizations)
...
def get_structure() -> AcceptHandshakeRequestTypeDef:
    return {
      ...
    }
```
