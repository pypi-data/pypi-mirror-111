...
# latest_events = client.latest_events(event_type="FL", historical="7d")
# latest_events = client.latest_events(event_type="EQ", historical="24h", limit=1000)
# print(len(latest_events))
...
event = client.get_event(event_type='TC', event_id='1000132', episode_id='8', source_format='shp')
print(event)