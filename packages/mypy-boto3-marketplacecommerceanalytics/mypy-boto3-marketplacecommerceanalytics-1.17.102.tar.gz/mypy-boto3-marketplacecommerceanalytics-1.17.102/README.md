...
[boto3.MarketplaceCommerceAnalytics 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/marketplacecommerceanalytics.html#MarketplaceCommerceAnalytics)
...
def get_structure() -> GenerateDataSetRequestTypeDef:
    return {
      ...
    }
```
