...
from .type_defs import ListHumanLoopsResponseResponseTypeDef, PaginatorConfigTypeDef
...
class ListHumanLoopsPaginator(Boto3Paginator):
    ...
    ) -> Iterator[ListHumanLoopsResponseResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/sagemaker-a2i-runtime.html#AugmentedAIRuntime.Paginator.ListHumanLoops.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_sagemaker_a2i_runtime/paginators.html#listhumanloopspaginator)
        """
