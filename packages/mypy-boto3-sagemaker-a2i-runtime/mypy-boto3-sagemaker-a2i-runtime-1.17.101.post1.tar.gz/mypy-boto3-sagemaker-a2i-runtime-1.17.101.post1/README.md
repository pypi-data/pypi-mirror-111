...
[boto3.AugmentedAIRuntime 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/sagemaker-a2i-runtime.html#AugmentedAIRuntime)
...
def get_structure() -> DeleteHumanLoopRequestTypeDef:
    return {
      ...
    }
```
