...
class MessageStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (int): The sending status of the message: - Success = 0 - Pending = 1 - Fail = 2., must be one of [0, 1, 2, ]  # noqa: E501

        Keyword Args:
            value (int): The sending status of the message: - Success = 0 - Pending = 1 - Fail = 2., must be one of [0, 1, 2, ]  # noqa: E501
