...
class MessageAttemptOut(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, response, response_status_code, timestamp, status, endpoint_id, *args, **kwargs):  # noqa: E501
        """MessageAttemptOut - a model defined in OpenAPI
