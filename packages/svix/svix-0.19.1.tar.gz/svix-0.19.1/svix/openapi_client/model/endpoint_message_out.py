...
class EndpointMessageOut(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_type, payload, id, timestamp, status, *args, **kwargs):  # noqa: E501
        """EndpointMessageOut - a model defined in OpenAPI

        Args:
            event_type (str):
            payload ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}):
            id (str):
            timestamp (datetime):
