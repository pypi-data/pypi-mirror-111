...
def main(raw_args=None):
    ...
    mainSubCommandParser.add_parser("fade_out", aliases=["fo"], help="Fades out the volume to under 5, within about 3 seconds, and returns prompt.")
    ...
    if   args.sub_command in ["current", "c"]:
        ...
        print(client.get_current_status())
    elif args.sub_command in ["fade_out", "fo"]:
        client.fade_out()
