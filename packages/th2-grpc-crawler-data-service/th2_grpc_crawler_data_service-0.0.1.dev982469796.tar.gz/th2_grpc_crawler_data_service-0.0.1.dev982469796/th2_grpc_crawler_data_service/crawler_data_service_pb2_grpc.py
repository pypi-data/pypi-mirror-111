...
class DataServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.crawlerConnect = channel.unary_unary(
                '/th2.dataservice.DataService/crawlerConnect',
                request_serializer=th2__grpc__crawler__data__service_dot_crawler__data__service__pb2.CrawlerInfo.SerializeToString,
                response_deserializer=th2__grpc__crawler__data__service_dot_crawler__data__service__pb2.Check2Info.FromString,
                )
        self.sendEvent = channel.unary_unary(
                '/th2.dataservice.DataService/sendEvent',
        ...
        self.sendMessage = channel.unary_unary(
                '/th2.dataservice.DataService/sendMessage',
...
def add_DataServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'crawlerConnect': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=th2__grpc__crawler__data__service_dot_crawler__data__service__pb2.Check2Info.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'th2.dataservice.DataService', rpc_method_handlers)
...
class DataService(object):
    ...
    def crawlerConnect(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/th2.dataservice.DataService/crawlerConnect',
            th2__grpc__crawler__data__service_dot_crawler__data__service__pb2.CrawlerInfo.SerializeToString,
            th2__grpc__crawler__data__service_dot_crawler__data__service__pb2.Check2Info.FromString,
    ...
    def sendEvent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/th2.dataservice.DataService/sendEvent',
    ...
    def sendMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/th2.dataservice.DataService/sendMessage',
