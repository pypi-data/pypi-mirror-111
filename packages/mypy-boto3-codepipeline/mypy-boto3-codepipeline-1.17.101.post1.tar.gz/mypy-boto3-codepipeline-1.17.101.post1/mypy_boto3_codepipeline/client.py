...
class CodePipelineClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client)
    ...
    def acknowledge_job(self, *, jobId: str, nonce: str) -> AcknowledgeJobOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.acknowledge_job)
    ...
    def acknowledge_third_party_job(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.acknowledge_third_party_job)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.can_paginate)
    ...
    def create_custom_action_type(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.create_custom_action_type)
    ...
    def create_pipeline(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.create_pipeline)
    ...
    def delete_custom_action_type(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.delete_custom_action_type)
    ...
    def delete_pipeline(self, *, name: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.delete_pipeline)
    ...
    def delete_webhook(self, *, name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.delete_webhook)
    ...
    def deregister_webhook_with_third_party(self, *, webhookName: str = None) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.deregister_webhook_with_third_party)
    ...
    def disable_stage_transition(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.disable_stage_transition)
    ...
    def enable_stage_transition(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.enable_stage_transition)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.generate_presigned_url)
    ...
    def get_action_type(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.get_action_type)
    ...
    def get_job_details(self, *, jobId: str) -> GetJobDetailsOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.get_job_details)
    ...
    def get_pipeline(self, *, name: str, version: int = None) -> GetPipelineOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.get_pipeline)
    ...
    def get_pipeline_execution(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.get_pipeline_execution)
    ...
    def get_pipeline_state(self, *, name: str) -> GetPipelineStateOutputResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.get_pipeline_state)
    ...
    def get_third_party_job_details(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.get_third_party_job_details)
    ...
    def list_action_executions(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.list_action_executions)
    ...
    def list_action_types(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.list_action_types)
    ...
    def list_pipeline_executions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.list_pipeline_executions)
    ...
    def list_pipelines(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.list_pipelines)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.list_tags_for_resource)
    ...
    def list_webhooks(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.list_webhooks)
    ...
    def poll_for_jobs(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.poll_for_jobs)
    ...
    def poll_for_third_party_jobs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.poll_for_third_party_jobs)
    ...
    def put_action_revision(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.put_action_revision)
    ...
    def put_approval_result(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.put_approval_result)
    ...
    def put_job_failure_result(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.put_job_failure_result)
    ...
    def put_job_success_result(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.put_job_success_result)
    ...
    def put_third_party_job_failure_result(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.put_third_party_job_failure_result)
    ...
    def put_third_party_job_success_result(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.put_third_party_job_success_result)
    ...
    def put_webhook(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.put_webhook)
    ...
    def register_webhook_with_third_party(self, *, webhookName: str = None) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.register_webhook_with_third_party)
    ...
    def retry_stage_execution(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.retry_stage_execution)
    ...
    def start_pipeline_execution(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.start_pipeline_execution)
    ...
    def stop_pipeline_execution(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.stop_pipeline_execution)
    ...
    def tag_resource(self, *, resourceArn: str, tags: List["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.tag_resource)
    ...
    def untag_resource(self, *, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.untag_resource)
    ...
    def update_action_type(self, *, actionType: "ActionTypeDeclarationTypeDef") -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.update_action_type)
    ...
    def update_pipeline(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Client.update_pipeline)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Paginator.ListActionExecutions)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Paginator.ListActionTypes)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Paginator.ListPipelineExecutions)
    ...
    def get_paginator(self, operation_name: Literal["list_pipelines"]) -> ListPipelinesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Paginator.ListPipelines)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Paginator.ListTagsForResource)
    ...
    def get_paginator(self, operation_name: Literal["list_webhooks"]) -> ListWebhooksPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/codepipeline.html#CodePipeline.Paginator.ListWebhooks)
