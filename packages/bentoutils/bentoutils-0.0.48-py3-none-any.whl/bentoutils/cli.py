...
@click.option('--opts', help='comma separated list of key=val pairs')
@click.option('--update', is_flag=True, help='update opts instead of replace')
@click.option('--no-ssl', is_flag=False, help='do not use SSL')
@click.option('--no-verify-ssl', is_flag=False, help='do not verify SSL')
def pack_from_s3(module, clz, name, bucket, path, labels=None, files=None, opts=None, update=False, use_ssl=True, verify_ssl=None):
