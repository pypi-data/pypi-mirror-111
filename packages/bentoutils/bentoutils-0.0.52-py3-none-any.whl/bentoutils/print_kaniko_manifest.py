...
def gen_manifest(name, pod_name, image_name, version, saved_path, registry='docker-registry.default.svc.cluster.local:5000', s3_endpoint='http://minio.default.svc.cluster.local:9000', insecure=False):
    args = [
