...
class GeoIP:
    ...
    def lookup(self, ip):
        ...
        try:
            ...
            raise ConnectionError("The request failed because it wasn't able to reach the Iploka service. This is most likely due to a networking error of some sort.")

        if resp.status_code != 200:
            raise ServiceError('Received an invalid status code from Iploka:' + str(resp.status_code) + '. The service might be experiencing issues.')
