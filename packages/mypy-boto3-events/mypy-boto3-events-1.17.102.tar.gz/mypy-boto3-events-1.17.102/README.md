...
[boto3.EventBridge 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/events.html#EventBridge)
...
def get_structure() -> ActivateEventSourceRequestTypeDef:
    return {
      ...
    }
```
