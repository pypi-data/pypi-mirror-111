...
setup(
  name = 'rctorch-private',         # How you named your package folder (MyLib)
  packages = ['rctorch-private'],   # Chose the same as "name"
  version = '0.9800',      # Start with a small number and increase it with every change you make
