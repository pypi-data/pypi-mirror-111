# -*- coding: utf-8 -*-
#
# Python Dist Manager documentation build configuration file, created by
...
htmlhelp_basename = 'Python Dist Managerdoc'
...
latex_documents = [
  ('index', 'pydistman.tex', u'Python Dist Manager Documentation',
...
man_pages = [
    ('index', 'pydistman', u'Python Dist Manager Documentation',
     [u'Shlomi Fish'], 1)
]
