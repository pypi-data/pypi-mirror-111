...
class DataExample:
    ...
    def __init__(self, Quaternion = [1,0,0,0]): 
        ...
        def joint_measures(df_first_joint,df_second_joint,patternRoll=False,patternPitch=False,patternYaw=False,
            ...
            if patternRoll:
                if euler:
                    rR,rawRrom = pyjamalib.DataProcessing.pattern_extraction(df['Flex/Ext'],df['Time'],threshold=thre[0], bias=bias, cycle=cycle);
                ...
                if cf:
                    CFR,CFRrom=pyjamalib.DataProcessing.pattern_extraction(df['Flex/Ext_CF'],df['Time'],threshold=thre[3], bias=bias, cycle=cycle);
                ...
                if cf_gd:
                    CFGDR,CFGDRrom=pyjamalib.DataProcessing.pattern_extraction(df['Flex/Ext_CF_GD'],df['Time'],threshold=thre[6], bias=bias, cycle=cycle);
                ...
                if cf_gn:
                    CFGNR,CFGNRrom=pyjamalib.DataProcessing.pattern_extraction(df['Flex/Ext_CF_GN'],df['Time'],threshold=thre[9], bias=bias, cycle=cycle);
                ...
                if k_gd:
                    KGDR,KGDRrom=pyjamalib.DataProcessing.pattern_extraction(df['Flex/Ext_Kalman_GD'],df['Time'],threshold=thre[12], bias=bias, cycle=cycle);
                ...
                if k_gn:
                    KGNR,KGNRRrom=pyjamalib.DataProcessing.pattern_extraction(df['Flex/Ext_Kalman_GN'],df['Time'],threshold=thre[15], bias=bias, cycle=cycle);
                ...
                if mad:
                    MADR,MADRrom=pyjamalib.DataProcessing.pattern_extraction(df['Flex/Ext_Madgwick'],df['Time'],threshold=thre[18], bias=bias, cycle=cycle);
            ...
            if patternPitch:
                if euler:    
                    rP,rawProm=pyjamalib.DataProcessing.pattern_extraction(df['Adu/Abd'],df['Time'],threshold=thre[1], bias=bias, cycle=cycle);
                ...
                if cf: 
                    CFP,CFProm=pyjamalib.DataProcessing.pattern_extraction(df['Adu/Abd_CF'],df['Time'],threshold=thre[4], bias=bias, cycle=cycle);
                ...
                if cf_gd:
                    CFGDP,CFGDProm=pyjamalib.DataProcessing.pattern_extraction(df['Adu/Abd_CF_GD'],df['Time'],threshold=thre[7], bias=bias, cycle=cycle);
                ...
                if cf_gn:
                    CFGNP,CFGNProm=pyjamalib.DataProcessing.pattern_extraction(df['Adu/Abd_CF_GN'],df['Time'],threshold=thre[10], bias=bias, cycle=cycle);
                ...
                if k_gd:
                    KGDP,KGDProm=pyjamalib.DataProcessing.pattern_extraction(df['Adu/Abd_Kalman_GD'],df['Time'],threshold=thre[13], bias=bias, cycle=cycle);
                ...
                if k_gn:
                    KGNP,KGNProm=pyjamalib.DataProcessing.pattern_extraction(df['Adu/Abd_Kalman_GN'],df['Time'],threshold=thre[16], bias=bias, cycle=cycle);
                ...
                if mad:
                    MADP,MADProm=pyjamalib.DataProcessing.pattern_extraction(df['Adu/Abd_Madgwick'],df['Time'],threshold=thre[19], bias=bias, cycle=cycle);
            ...
            if patternYaw:
                if euler:
                    rY,rawYrom=pyjamalib.DataProcessing.pattern_extraction(df['Int/Ext_Rot'],df['Time'],threshold=thre[2], bias=bias, cycle=cycle);
                ...
                if cf:            
                    CFY,CFYrom=pyjamalib.DataProcessing.pattern_extraction(df['Int/Ext_Rot_CF'],df['Time'],threshold=thre[5], bias=bias, cycle=cycle);
                ...
                if cf_gd:
                    CFGDY,CFGDYrom=pyjamalib.DataProcessing.pattern_extraction(df['Int/Ext_Rot_CF_GD'],df['Time'],thre[8], bias=bias, cycle=cycle);
                ...
                if cf_gn:
                    CFGNY,CFGNYrom=pyjamalib.DataProcessing.pattern_extraction(df['Int/Ext_Rot_CF_GN'],df['Time'],threshold=thre[11], bias=bias, cycle=cycle);
                ...
                if k_gd:
                    KGDY,KGDYrom=pyjamalib.DataProcessing.pattern_extraction(df['Int/Ext_Rot_Kalman_GD'],df['Time'],threshold=thre[14], bias=bias, cycle=cycle);
                ...
                if k_gn:
                    KGNY,KGNYrom=pyjamalib.DataProcessing.pattern_extraction(df['Int/Ext_Rot_Kalman_GN'],df['Time'],threshold=thre[17], bias=bias, cycle=cycle);
                ...
                if mad:
                    MADY,MADYrom=pyjamalib.DataProcessing.pattern_extraction(df['Int/Ext_Rot_Madgwick'],df['Time'],threshold=thre[20], bias=bias, cycle=cycle);
