...
from rrunner import __description__, __version__
# from rrunner.compat import ensure_cli_args
# from rrunner.ext.har2case import init_har2case_parser, main_har2case
from rrunner.make import init_make_parser, main_make
from rrunner.scaffold import init_parser_scaffold, main_scaffold
from rrunner.utils import init_sentry_sdk
from rrunner.common.handle_path import REPORT_DIR
...
def main_run(extra_args) -> enum.IntEnum:
    ...
    #     extra_args_new.append("-s")

    # str1 = "--html=" + REPORT_DIR + r"\report.html"

    str2 = "--alluredir=" + REPORT_DIR + r"\allure"

    str3 = "--clean-alluredir"

    # if str1 not in extra_args_new:
    #     extra_args_new.append(str1)
    if str2 not in extra_args_new:
        extra_args_new.append(str2)
    if str3 not in extra_args_new:
        extra_args_new.append(str3)

    extra_args_new.extend(testcase_path_list)
    logger.info(f"start to run tests with pytest. Reqponse version: {__version__}")
