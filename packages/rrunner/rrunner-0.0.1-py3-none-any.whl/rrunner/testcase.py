...
class Config(object):
    ...
    def sheetname(self, sheetname: Text) -> "Config":
...
class RunRequest(object):
    def __init__(self, name: Text, case_id: int):
        self.__step_context = TStep(name=name, case_id=case_id)
