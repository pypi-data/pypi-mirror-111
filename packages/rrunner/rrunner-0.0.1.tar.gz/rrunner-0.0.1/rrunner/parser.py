...
from rrunner import loader, utils, exceptions
from rrunner.models import VariablesMapping, FunctionsMapping
from rrunner.loader import load_project_meta
...
def get_mapping_function(
    ...
    if function_name in functions_mapping:
        ...
        from rrunner.ext import uploader

        return getattr(uploader, function_name)

    try:
        # check if RRun builtin functions
