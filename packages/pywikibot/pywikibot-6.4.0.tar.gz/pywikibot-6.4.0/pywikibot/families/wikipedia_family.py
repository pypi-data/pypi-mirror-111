...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ce', 'ms', 'tt', 'eo', 'he', 'hy', 'bg', 'da', 'azb', 'sk', 'kk',
        'min', 'et', 'hr', 'be', 'lt', 'el', 'simple', 'az', 'gl', 'sl', 'ur',
        'nn', 'ka', 'hi', 'uz', 'ta', 'th', 'la', 'cy', 'ast', 'vo', 'mk',
        'zh-yue', 'bn', 'lv', 'tg', 'my', 'af', 'mg', 'oc', 'bs', 'sq', 'nds',
        'ky', 'mr', 'be-tarask', 'ml', 'new', 'te', 'br', 'vec', 'pms', 'sw',
        'jv', 'pnb', 'ht', 'su', 'lb', 'ba', 'ga', 'szl', 'is', 'tl', 'lmo',
        'cv', 'fy', 'wuu', 'sco', 'an', 'diq', 'ku', 'pa', 'yo', 'ckb', 'ne',
        'bar', 'io', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'si',
        'bat-smg', 'nv', 'xmf', 'or', 'cdo', 'ilo', 'gd', 'yi', 'am', 'avk',
        'nap', 'sd', 'bug', 'hsb', 'mai', 'frr', 'fo', 'os', 'li', 'map-bms',
        'mzn', 'sah', 'eml', 'ps', 'ace', 'gor', 'sa', 'bcl', 'wa', 'crh',
        'zh-classical', 'lij', 'mrj', 'mhr', 'ha', 'hif', 'hak', 'roa-tara',
        'shn', 'hyw', 'pam', 'as', 'zu', 'nso', 'km', 'ban', 'ie', 'rue', 'se',
        'bh', 'vls', 'nds-nl', 'mi', 'sn', 'sc', 'nah', 'vep', 'gan', 'myv',
        'glk', 'kab', 'sat', 'so', 'ab', 'bo', 'tk', 'co', 'fiu-vro', 'kv',
        'csb', 'pcd', 'frp', 'udm', 'ug', 'gv', 'ay', 'zea', 'kw', 'nrm',
        'lez', 'ary', 'gn', 'lfn', 'mni', 'stq', 'mt', 'mwl', 'lo', 'rm',
        'skr', 'bjn', 'olo', 'lad', 'gom', 'koi', 'fur', 'ang', 'dsb', 'dty',
        'ext', 'ln', 'tyv', 'cbk-zam', 'smn', 'dv', 'ksh', 'gag', 'pfl', 'pi',
        'pag', 'av', 'bxr', 'awa', 'tay', 'haw', 'pap', 'ig', 'rw', 'xal',
        'krc', 'za', 'szy', 'pdc', 'kaa', 'inh', 'arc', 'to', 'nov', 'kbp',
        'jam', 'wo', 'tpi', 'na', 'kbd', 'atj', 'ki', 'tet', 'tcy', 'ak',
        'lld', 'lg', 'jbo', 'bi', 'roa-rup', 'lbe', 'kg', 'ty', 'mdf', 'xh',
        'fj', 'srn', 'om', 'trv', 'gcr', 'sm', 'ltg', 'chr', 'nia', 'nqo',
        'mnw', 'pih', 'got', 'st', 'kl', 'mad', 'tw', 'cu', 'ny', 'tn', 'ts',
        'bm', 'rmy', 've', 'chy', 'rn', 'tum', 'iu', 'ss', 'ks', 'ch', 'alt',
        'pnt', 'ady', 'ee', 'ff', 'din', 'ik', 'sg', 'dz', 'ti', 'cr', 'dag',
        'shi',
    ]
