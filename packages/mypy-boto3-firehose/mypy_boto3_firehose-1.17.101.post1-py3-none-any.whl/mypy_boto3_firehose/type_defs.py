...
_RequiredCreateDeliveryStreamInputTypeDef = TypedDict(
    "_RequiredCreateDeliveryStreamInputTypeDef",
    {
        "DeliveryStreamName": str,
    },
)
_OptionalCreateDeliveryStreamInputTypeDef = TypedDict(
    "_OptionalCreateDeliveryStreamInputTypeDef",
    {
...
class CreateDeliveryStreamInputTypeDef(
    _RequiredCreateDeliveryStreamInputTypeDef, _OptionalCreateDeliveryStreamInputTypeDef
):
    pass


CreateDeliveryStreamOutputResponseTypeDef = TypedDict(
    "CreateDeliveryStreamOutputResponseTypeDef",
    {
...
_RequiredDeleteDeliveryStreamInputTypeDef = TypedDict(
    "_RequiredDeleteDeliveryStreamInputTypeDef",
    {
        "DeliveryStreamName": str,
    },
)
_OptionalDeleteDeliveryStreamInputTypeDef = TypedDict(
    "_OptionalDeleteDeliveryStreamInputTypeDef",
    {
...
class DeleteDeliveryStreamInputTypeDef(
    _RequiredDeleteDeliveryStreamInputTypeDef, _OptionalDeleteDeliveryStreamInputTypeDef
):
    pass
...
_RequiredDescribeDeliveryStreamInputTypeDef = TypedDict(
    "_RequiredDescribeDeliveryStreamInputTypeDef",
    {
        "DeliveryStreamName": str,
    },
)
_OptionalDescribeDeliveryStreamInputTypeDef = TypedDict(
    "_OptionalDescribeDeliveryStreamInputTypeDef",
    {
        "Limit": int,
...
class DescribeDeliveryStreamInputTypeDef(
    _RequiredDescribeDeliveryStreamInputTypeDef, _OptionalDescribeDeliveryStreamInputTypeDef
):
    pass


DescribeDeliveryStreamOutputResponseTypeDef = TypedDict(
    "DescribeDeliveryStreamOutputResponseTypeDef",
    {
...
ListDeliveryStreamsInputTypeDef = TypedDict(
    "ListDeliveryStreamsInputTypeDef",
    {
        "Limit": int,
        "DeliveryStreamType": DeliveryStreamTypeType,
...
ListDeliveryStreamsOutputResponseTypeDef = TypedDict(
    "ListDeliveryStreamsOutputResponseTypeDef",
    {
...
_RequiredListTagsForDeliveryStreamInputTypeDef = TypedDict(
    "_RequiredListTagsForDeliveryStreamInputTypeDef",
    {
        "DeliveryStreamName": str,
    },
)
_OptionalListTagsForDeliveryStreamInputTypeDef = TypedDict(
    "_OptionalListTagsForDeliveryStreamInputTypeDef",
    {
...
class ListTagsForDeliveryStreamInputTypeDef(
    _RequiredListTagsForDeliveryStreamInputTypeDef, _OptionalListTagsForDeliveryStreamInputTypeDef
):
    pass


ListTagsForDeliveryStreamOutputResponseTypeDef = TypedDict(
    "ListTagsForDeliveryStreamOutputResponseTypeDef",
    {
        "Tags": List["TagTypeDef"],
        "HasMoreTags": bool,
...
PutRecordBatchInputTypeDef = TypedDict(
    "PutRecordBatchInputTypeDef",
    {
        "DeliveryStreamName": str,
...
PutRecordBatchOutputResponseTypeDef = TypedDict(
    "PutRecordBatchOutputResponseTypeDef",
    {
        "FailedPutCount": int,
        "Encrypted": bool,
...
PutRecordInputTypeDef = TypedDict(
    "PutRecordInputTypeDef",
    {
        "DeliveryStreamName": str,
...
_RequiredStartDeliveryStreamEncryptionInputTypeDef = TypedDict(
    "_RequiredStartDeliveryStreamEncryptionInputTypeDef",
    {
        "DeliveryStreamName": str,
    },
)
_OptionalStartDeliveryStreamEncryptionInputTypeDef = TypedDict(
    "_OptionalStartDeliveryStreamEncryptionInputTypeDef",
    {
        "DeliveryStreamEncryptionConfigurationInput": "DeliveryStreamEncryptionConfigurationInputTypeDef",
    },
    total=False,
...
class StartDeliveryStreamEncryptionInputTypeDef(
    _RequiredStartDeliveryStreamEncryptionInputTypeDef,
    _OptionalStartDeliveryStreamEncryptionInputTypeDef,
):
    pass
...
StopDeliveryStreamEncryptionInputTypeDef = TypedDict(
    "StopDeliveryStreamEncryptionInputTypeDef",
    {
        "DeliveryStreamName": str,
    },
...
TagDeliveryStreamInputTypeDef = TypedDict(
    "TagDeliveryStreamInputTypeDef",
    {
        "DeliveryStreamName": str,
        "Tags": List["TagTypeDef"],
...
UntagDeliveryStreamInputTypeDef = TypedDict(
    "UntagDeliveryStreamInputTypeDef",
    {
        "DeliveryStreamName": str,
        "TagKeys": List[str],
...
_RequiredUpdateDestinationInputTypeDef = TypedDict(
    "_RequiredUpdateDestinationInputTypeDef",
    {
        "DeliveryStreamName": str,
...
_OptionalUpdateDestinationInputTypeDef = TypedDict(
    "_OptionalUpdateDestinationInputTypeDef",
    {
...
class UpdateDestinationInputTypeDef(
    _RequiredUpdateDestinationInputTypeDef, _OptionalUpdateDestinationInputTypeDef
):
    pass
