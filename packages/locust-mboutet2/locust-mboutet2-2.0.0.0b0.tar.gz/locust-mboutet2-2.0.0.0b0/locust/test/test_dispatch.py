...
class TestDispatch(unittest.TestCase):
    ...
    def test_dispatch_from_0_to_25000_users_across_5_user_classes_to_250_workers_and_spawn_rate_of_74(self):
        """25000 users at 74.00 spawn rate to 250 ready clients, 5 user classes (weights: 23, 23, 46, 4. 4)"""
        worker_nodes = [
        ...
        users_dispatcher = UsersDispatcher(
            worker_nodes=worker_nodes, user_classes_count=user_classes_count, spawn_rate=74
        )
    ...
    def test_dispatch_from_0_to_33330_users_across_10_user_classes_to_300_workers_and_spawn_rate_of_200(self):
        worker_nodes = [
            WorkerNode("00{}".format(i) if i < 10 else "0{}".format(i) if i < 100 else str(i)) for i in range(1, 301)
        ]
        ...
        users_dispatcher = UsersDispatcher(
            worker_nodes=worker_nodes, user_classes_count=user_classes_count, spawn_rate=174
        )
