...
[boto3.Support 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/support.html#Support)
...
def get_structure() -> AddAttachmentsToSetRequestTypeDef:
    return {
      ...
    }
```
