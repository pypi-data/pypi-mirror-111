...
class DevOpsGuruClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client)
    ...
    def add_notification_channel(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.add_notification_channel)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.can_paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_devops_guru/client.html#can_paginate)
        """
    def describe_account_health(self) -> DescribeAccountHealthResponseResponseTypeDef:
        """
        Returns the number of open reactive insights, the number of open proactive
        insights, and the number of metrics analyzed in your AWS account.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.describe_account_health)
    ...
    def describe_account_overview(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.describe_account_overview)
        ...
        """
    def describe_anomaly(self, *, Id: str) -> DescribeAnomalyResponseResponseTypeDef:
        """
        Returns details about an anomaly that you specify using its ID.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.describe_anomaly)
    ...
    def describe_feedback(
        self, *, InsightId: str = None
    ) -> DescribeFeedbackResponseResponseTypeDef:
        """
        Returns the most recent feedback submitted in the current AWS account and
        Region.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.describe_feedback)
        ...
        """
    def describe_insight(self, *, Id: str) -> DescribeInsightResponseResponseTypeDef:
        """
        Returns details about an insight that you specify using its ID.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.describe_insight)
    ...
    def describe_resource_collection_health(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.describe_resource_collection_health)
        ...
        """
    def describe_service_integration(self) -> DescribeServiceIntegrationResponseResponseTypeDef:
        """
        Returns the integration status of services that are integrated with DevOps Guru.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.describe_service_integration)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.generate_presigned_url)
    ...
    def get_cost_estimation(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.get_cost_estimation)
    ...
    def get_resource_collection(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.get_resource_collection)
    ...
    def list_anomalies_for_insight(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.list_anomalies_for_insight)
    ...
    def list_events(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.list_events)
    ...
    def list_insights(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.list_insights)
    ...
    def list_notification_channels(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.list_notification_channels)
    ...
    def list_recommendations(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.list_recommendations)
    ...
    def put_feedback(self, *, InsightFeedback: "InsightFeedbackTypeDef" = None) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.put_feedback)
    ...
    def remove_notification_channel(self, *, Id: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.remove_notification_channel)
    ...
    def search_insights(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.search_insights)
    ...
    def start_cost_estimation(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.start_cost_estimation)
    ...
    def update_resource_collection(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.update_resource_collection)
    ...
    def update_service_integration(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Client.update_service_integration)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Paginator.DescribeResourceCollectionHealth)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Paginator.GetCostEstimation)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Paginator.GetResourceCollection)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Paginator.ListAnomaliesForInsight)
    ...
    def get_paginator(self, operation_name: Literal["list_events"]) -> ListEventsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Paginator.ListEvents)
    ...
    def get_paginator(self, operation_name: Literal["list_insights"]) -> ListInsightsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Paginator.ListInsights)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Paginator.ListNotificationChannels)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Paginator.ListRecommendations)
    ...
    def get_paginator(self, operation_name: Literal["search_insights"]) -> SearchInsightsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru.Paginator.SearchInsights)
