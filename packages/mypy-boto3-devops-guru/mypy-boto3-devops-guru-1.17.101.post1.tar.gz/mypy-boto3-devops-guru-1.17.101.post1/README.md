...
[boto3.DevOpsGuru 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/devops-guru.html#DevOpsGuru)
...
def get_structure() -> AddNotificationChannelRequestTypeDef:
    return {
      ...
    }
```
