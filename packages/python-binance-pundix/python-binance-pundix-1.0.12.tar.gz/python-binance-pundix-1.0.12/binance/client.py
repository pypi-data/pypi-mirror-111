...
class Client(BaseClient):
    ...
    def futures_get_commission_rate(self, **params):
        """Get future account commission rate
    ...
    def futures_coin_get_commission_rate(self, **params):
        """Get user account's commission rate

        https://binance-docs.github.io/apidocs/delivery/en/#user-commission-rate-user_data

        """
        return self._request_futures_coin_api("get", "commissionRate", True, data=params)
