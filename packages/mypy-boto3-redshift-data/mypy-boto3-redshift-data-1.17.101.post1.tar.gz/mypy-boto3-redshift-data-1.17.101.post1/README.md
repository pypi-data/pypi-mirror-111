...
[boto3.RedshiftDataAPIService 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/redshift-data.html#RedshiftDataAPIService)
...
def get_structure() -> CancelStatementRequestTypeDef:
    return {
      ...
    }
```
