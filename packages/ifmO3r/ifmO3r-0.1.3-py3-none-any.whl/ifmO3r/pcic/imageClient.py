...
class ImageClient(PCICV3Client):
    ...
    def readNextFrame(self):
        ...
        # Timestamp might not be included in the data and therefore cause problems if referenced
        timeStampSec = None
        timeStampNsec = None
        imageWidth = None
        imageHeight = None
	...
	Frame counter: %d"""
        ...
        result["time_stamp_sec"] = timeStampSec
        result["time_stamp_nsec"] = timeStampNsec
        return result
