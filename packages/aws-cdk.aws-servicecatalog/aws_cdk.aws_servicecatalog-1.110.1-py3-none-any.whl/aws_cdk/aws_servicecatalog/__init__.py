...
@jsii.enum(jsii_type="@aws-cdk/aws-servicecatalog.AcceptLanguage")
...
class CfnServiceAction(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        definition: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union["CfnServiceAction.DefinitionParameterProperty", aws_cdk.core.IResolvable]]],
...
class IPortfolio(aws_cdk.core.IResource, typing_extensions.Protocol):
    ...
    def share_with_account(
        ...
        account_id: builtins.str,
        *,
        accept_language: typing.Optional[AcceptLanguage] = None,
        ...
        :param accept_language: (experimental) The accept language of the share. Default: - accept language not specified
    ...
    def share_with_account(
        ...
        *,
        ...
        options = PortfolioShareOptions(
            accept_language=accept_language, share_tag_options=share_tag_options
        )
...
class Portfolio(
    ...
    def __init__(
        ...
        *,
        ...
        :param accept_language: (experimental) The accept language. Default: - No accept language provided
        ...
        jsii.create(Portfolio, self, [scope, id, props])
...
class PortfolioProps:
    ...
    @builtins.property
    def accept_language(self) -> typing.Optional[AcceptLanguage]:
        ...
        '''
        result = self._values.get("accept_language")
        return typing.cast(typing.Optional[AcceptLanguage], result)
