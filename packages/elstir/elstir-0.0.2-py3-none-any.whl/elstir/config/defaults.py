...
DEFAULT_SCHEMA = (
    ...
    # The elstir theme for the documentation.
    ('theme', config_options.Theme(default='elstir')),
    ...
    # this should look like, ['UA-27795084-5', 'elstir.org']
    ...
    # enabling strict mode causes elstir to stop the build when a problem is
    ...
    # elstir itself. A good example here would be including the current
    # project version.
