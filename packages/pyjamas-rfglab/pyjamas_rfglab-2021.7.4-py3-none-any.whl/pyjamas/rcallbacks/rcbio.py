...
class RCBIO(RCallback):
    ...
    def cbLoadTimeSeries(self, filename: str = None, channel_method: rimutils.ChannelMethod = None, index: int = -1) -> bool:
        """
        ...
        if filename is None or filename is False:
            fname = QtWidgets.QFileDialog.getOpenFileName(None, 'Load image ...', self.pjs.cwd,
        ...
        # Read image.
        self.pjs.slices = rimutils.read_stack(filename, channel_method, index)
