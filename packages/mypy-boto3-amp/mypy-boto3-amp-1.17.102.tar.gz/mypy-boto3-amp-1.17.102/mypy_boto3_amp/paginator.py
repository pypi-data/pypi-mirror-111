...
from .type_defs import ListWorkspacesResponseResponseTypeDef, PaginatorConfigTypeDef
...
class ListWorkspacesPaginator(Boto3Paginator):
    ...
    ) -> Iterator[ListWorkspacesResponseResponseTypeDef]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/amp.html#PrometheusService.Paginator.ListWorkspaces.paginate)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_amp/paginators.html#listworkspacespaginator)
        """
