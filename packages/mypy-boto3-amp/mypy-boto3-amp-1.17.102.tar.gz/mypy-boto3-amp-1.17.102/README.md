...
[boto3.PrometheusService 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/amp.html#PrometheusService)
...
def get_structure() -> CreateWorkspaceRequestTypeDef:
    return {
      ...
    }
```
