...
[boto3.TimestreamQuery 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/timestream-query.html#TimestreamQuery)
...
def get_structure() -> CancelQueryRequestTypeDef:
    return {
      ...
    }
```
