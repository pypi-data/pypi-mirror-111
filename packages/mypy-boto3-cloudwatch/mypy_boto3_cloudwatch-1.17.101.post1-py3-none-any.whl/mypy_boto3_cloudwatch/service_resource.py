...
class ServiceResourceAlarmsCollection(ResourceCollection):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.ServiceResource.alarms)
...
class ServiceResourceMetricsCollection(ResourceCollection):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.ServiceResource.metrics)
...
class MetricAlarmsCollection(ResourceCollection):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Metric.alarms)
...
class Alarm(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.ServiceResource.Alarm)
    ...
    def delete(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Alarm.delete)
    ...
    def describe_history(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Alarm.describe_history)
    ...
    def disable_actions(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Alarm.disable_actions)
    ...
    def enable_actions(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Alarm.enable_actions)
    ...
    def get_available_subresources(self) -> List[str]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Alarm.get_available_subresources)
    ...
    def load(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Alarm.load)
    ...
    def reload(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Alarm.reload)
    ...
    def set_state(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Alarm.set_state)
...
class Metric(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.ServiceResource.Metric)
    ...
    def get_available_subresources(self) -> List[str]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Metric.get_available_subresources)
    ...
    def get_statistics(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Metric.get_statistics)
    ...
    def load(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Metric.load)
    ...
    def put_alarm(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Metric.put_alarm)
    ...
    def put_data(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Metric.put_data)
    ...
    def reload(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.Metric.reload)
...
class CloudWatchServiceResource(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.ServiceResource)
    ...
    def get_available_subresources(self) -> List[str]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/cloudwatch.html#CloudWatch.ServiceResource.get_available_subresources)
