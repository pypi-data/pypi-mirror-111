...
async def generate_directs(url):
    ...
    #mediafire.com
        ...
        try:
            ...
            return "**ERROR:** can't download, double check your mediafire link!"
    ...
    #disk.yandex.com    
        ...
        try:
            ...
            return "**ERROR:** can't download, the yadisk file not found or dowmload limit reached!" 
    ...
    #zippyshare.com
        ...
        try:
            ...
            return "**ERROR:** can't download, double check your zippyshare link!"
    ...
    #racaty.net
        ...
        try:
            ...
            return "**ERROR:** can't download, double check your racaty link!"
        ...
        if restext["success"]:
            ...
            return "**ERROR:** can't download, {}.".format(restext["value"])