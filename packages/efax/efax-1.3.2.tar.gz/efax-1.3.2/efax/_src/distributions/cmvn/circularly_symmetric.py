...
class ComplexCircularlySymmetricNormalNP(
    ...
    def log_normalizer(self) -> RealArray:
        ...
        log_det_h = jnp.log(jnp.linalg.det(-self.negative_precision).real)
        return -log_det_h + num_parameters * math.log(math.pi)
...
class ComplexCircularlySymmetricNormalEP(
    ...
    def sample(self, rng: Generator, shape: Optional[Shape] = None) -> ComplexArray:
        ...
        return jax.random.multivariate_normal(rng.key, mean, self.variance, shape[:-1])
