...
class DataExchangeClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.can_paginate)
    ...
    def cancel_job(self, *, JobId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.cancel_job)
    ...
    def create_data_set(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.create_data_set)
    ...
    def create_job(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.create_job)
    ...
    def create_revision(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.create_revision)
    ...
    def delete_asset(self, *, AssetId: str, DataSetId: str, RevisionId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.delete_asset)
    ...
    def delete_data_set(self, *, DataSetId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.delete_data_set)
    ...
    def delete_revision(self, *, DataSetId: str, RevisionId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.delete_revision)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.generate_presigned_url)
    ...
    def get_asset(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.get_asset)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_dataexchange/client.html#get_asset)
        """
    def get_data_set(self, *, DataSetId: str) -> GetDataSetResponseResponseTypeDef:
        """
        This operation returns information about a data set.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.get_data_set)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_dataexchange/client.html#get_data_set)
        """
    def get_job(self, *, JobId: str) -> GetJobResponseResponseTypeDef:
        """
        This operation returns information about a job.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.get_job)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_dataexchange/client.html#get_job)
        """
    def get_revision(
        self, *, DataSetId: str, RevisionId: str
    ) -> GetRevisionResponseResponseTypeDef:
        """
        This operation returns information about a revision.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.get_revision)
    ...
    def list_data_set_revisions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.list_data_set_revisions)
    ...
    def list_data_sets(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.list_data_sets)
    ...
    def list_jobs(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.list_jobs)
    ...
    def list_revision_assets(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.list_revision_assets)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.list_tags_for_resource)
    ...
    def start_job(self, *, JobId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.start_job)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: Dict[str, str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeys: List[str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.untag_resource)
    ...
    def update_asset(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.update_asset)
    ...
    def update_data_set(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.update_data_set)
    ...
    def update_revision(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Client.update_revision)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Paginator.ListDataSetRevisions)
    ...
    def get_paginator(self, operation_name: Literal["list_data_sets"]) -> ListDataSetsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Paginator.ListDataSets)
    ...
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Paginator.ListJobs)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/dataexchange.html#DataExchange.Paginator.ListRevisionAssets)
