...
{Fore.GREEN}REST{Style.RESET_ALL} for {Fore.YELLOW}{timer_val}{Style.RESET_ALL} minutes""")
        ...
        print(f"{Fore.BLUE}Q - to return to main menu{Style.RESET_ALL}")
...
Total work time:    {Fore.YELLOW}{int(durations.total_work_mins)} minutes{Style.RESET_ALL}
Total rest time:    {Fore.YELLOW}{int(durations.total_rest_mins)} minutes{Style.RESET_ALL}
