...
class ACMPCAClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.can_paginate)
    ...
    def create_certificate_authority(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.create_certificate_authority)
    ...
    def create_certificate_authority_audit_report(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.create_certificate_authority_audit_report)
    ...
    def create_permission(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.create_permission)
    ...
    def delete_certificate_authority(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.delete_certificate_authority)
    ...
    def delete_permission(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.delete_permission)
    ...
    def delete_policy(self, *, ResourceArn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.delete_policy)
    ...
    def describe_certificate_authority(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.describe_certificate_authority)
    ...
    def describe_certificate_authority_audit_report(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.describe_certificate_authority_audit_report)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.generate_presigned_url)
    ...
    def get_certificate(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.get_certificate)
    ...
    def get_certificate_authority_certificate(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.get_certificate_authority_certificate)
    ...
    def get_certificate_authority_csr(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.get_certificate_authority_csr)
    ...
    def get_policy(self, *, ResourceArn: str) -> GetPolicyResponseResponseTypeDef:
        """
        Retrieves the resource-based policy attached to a private CA.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.get_policy)
    ...
    def import_certificate_authority_certificate(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.import_certificate_authority_certificate)
    ...
    def issue_certificate(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.issue_certificate)
    ...
    def list_certificate_authorities(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.list_certificate_authorities)
    ...
    def list_permissions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.list_permissions)
    ...
    def list_tags(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.list_tags)
    ...
    def put_policy(self, *, ResourceArn: str, Policy: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.put_policy)
    ...
    def restore_certificate_authority(self, *, CertificateAuthorityArn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.restore_certificate_authority)
    ...
    def revoke_certificate(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.revoke_certificate)
    ...
    def tag_certificate_authority(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.tag_certificate_authority)
    ...
    def untag_certificate_authority(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.untag_certificate_authority)
    ...
    def update_certificate_authority(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Client.update_certificate_authority)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Paginator.ListCertificateAuthorities)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Paginator.ListPermissions)
    ...
    def get_paginator(self, operation_name: Literal["list_tags"]) -> ListTagsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Paginator.ListTags)
    ...
    def get_waiter(self, waiter_name: Literal["audit_report_created"]) -> AuditReportCreatedWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Waiter.AuditReportCreated)
    ...
    def get_waiter(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Waiter.CertificateAuthorityCSRCreated)
    ...
    def get_waiter(self, waiter_name: Literal["certificate_issued"]) -> CertificateIssuedWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/acm-pca.html#ACMPCA.Waiter.CertificateIssued)
