...
enum : int {
    ...
    SBK_QT3DANIMATION_QCHANNELMAPPER_IDX                     = 19,
    SBK_QT3DANIMATION_QCHANNELMAPPING_IDX                    = 20,
    SBK_QT3DANIMATION_QCLIPANIMATOR_IDX                      = 21,
    SBK_QT3DANIMATION_QCLIPBLENDVALUE_IDX                    = 22,
    SBK_QT3DANIMATION_QCLOCK_IDX                             = 23,
    SBK_QT3DANIMATION_QKEYFRAME_INTERPOLATIONTYPE_IDX        = 25,
    SBK_QT3DANIMATION_QKEYFRAME_IDX                          = 24,
    SBK_QT3DANIMATION_QKEYFRAMEANIMATION_REPEATMODE_IDX      = 27,
    SBK_QT3DANIMATION_QKEYFRAMEANIMATION_IDX                 = 26,
    SBK_QT3DANIMATION_QLERPCLIPBLEND_IDX                     = 28,
    SBK_QT3DANIMATION_QMORPHTARGET_IDX                       = 29,
    SBK_QT3DANIMATION_QMORPHINGANIMATION_METHOD_IDX          = 31,
    SBK_QT3DANIMATION_QMORPHINGANIMATION_IDX                 = 30,
    SBK_QT3DANIMATION_QSKELETONMAPPING_IDX                   = 32,
    SBK_QT3DANIMATION_QVERTEXBLENDANIMATION_IDX              = 33,
    SBK_Qt3DAnimation_IDX_COUNT                              = 34
};
