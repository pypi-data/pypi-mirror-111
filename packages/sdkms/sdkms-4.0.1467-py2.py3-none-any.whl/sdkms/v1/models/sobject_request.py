...
class SobjectRequest(object):
    ...
    def __init__(self, name=None, description=None, key_size=None, pub_exponent=None, elliptic_curve=None, rsa=None, dsa=None, fpe=None, group_id=None, obj_type=None, key_ops=None, custom_metadata=None, value=None, enabled=None, transient=None, deterministic_signatures=None, state=None, deactivation_date=None):
        """
