...
@qparam(
    ...
    " with the user. Specifying any non-empty value will activate this flag.",
)
@status(
    200,
...
@qparam(
    ...
    " user. Specifying any non-empty value will activate this flag.",
)
@status(
    200,
...
@qparam(
    ...
    " group membership. Specifying any non-empty value will activate this flag.",
)
@status(
    200,
