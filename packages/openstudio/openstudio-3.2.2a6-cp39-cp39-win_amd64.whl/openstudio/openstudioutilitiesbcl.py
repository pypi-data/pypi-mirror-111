...
class RemoteBCL(BCL):
    ...
    def timeOutSeconds(self) -> "unsigned int":
        return _openstudioutilitiesbcl.RemoteBCL_timeOutSeconds(self)

    def setTimeOutSeconds(self, timeOutSeconds: "unsigned int") -> "bool":
        return _openstudioutilitiesbcl.RemoteBCL_setTimeOutSeconds(self, timeOutSeconds)

    def waitForComponentDownload(self, *args) -> "boost::optional< openstudio::BCLComponent >":
        return _openstudioutilitiesbcl.RemoteBCL_waitForComponentDownload(self, *args)

    def waitForMeasureDownload(self, *args) -> "boost::optional< openstudio::BCLMeasure >":
        return _openstudioutilitiesbcl.RemoteBCL_waitForMeasureDownload(self, *args)

    def waitForMetaSearch(self, *args) -> "boost::optional< openstudio::BCLMetaSearchResult >":
        return _openstudioutilitiesbcl.RemoteBCL_waitForMetaSearch(self, *args)

    def waitForSearch(self, *args) -> "std::vector< openstudio::BCLSearchResult,std::allocator< openstudio::BCLSearchResult > >":
