...
class OutputEnvironmentalImpactFactors(openstudiomodelcore.ModelObject):
    ...
    def __init__(self, model: "Model"):
        _openstudiomodelsimulation.OutputEnvironmentalImpactFactors_swiginit(self, _openstudiomodelsimulation.new_OutputEnvironmentalImpactFactors(model))
...
class FuelFactors(openstudiomodelcore.ModelObject):
    ...
    def __init__(self, model: "Model"):
        _openstudiomodelsimulation.FuelFactors_swiginit(self, _openstudiomodelsimulation.new_FuelFactors(model))
