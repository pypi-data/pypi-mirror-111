...
class RadianceParameters(ModelObject):
    ...
    def setSkyDiscretizationResolution(self, skyDiscretizationResolution: "std::string const &") -> "bool":
...
class ScheduleTypeLimits(ResourceObject):
    ...
    def setNumericType(self, numericType: "std::string const &") -> "bool":
    ...
    def setUnitType(self, unitType: "std::string const &") -> "bool":
...
class ExternalInterfaceFunctionalMockupUnitImport(ModelObject):
    ...
    def setFMUFileName(self, fMUName: "std::string const &") -> "bool":
