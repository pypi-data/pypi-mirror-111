...
[boto3.CloudWatchLogs 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/logs.html#CloudWatchLogs)
...
def get_structure() -> AssociateKmsKeyRequestTypeDef:
    return {
      ...
    }
```
