...
class RDKitMolecule(AbstractMolecule):
    ...
    @classmethod
    def from_mol_block(cls, mol: str) -> Optional[RDKitMolecule]:
    ...
    @classmethod
    def from_inchi(cls, inchi: str) -> Optional[RDKitMolecule]:
    ...
    @classmethod
    def from_smiles(cls, smiles: str) -> Optional[RDKitMolecule]:
