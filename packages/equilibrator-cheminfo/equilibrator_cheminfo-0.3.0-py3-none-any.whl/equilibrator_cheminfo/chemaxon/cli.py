...
from .dissociation_constant import DissociationConstant
...
def summarize_molecular_entities(args: argparse.Namespace):
    ...
    num_with_error_but_major_ms = (
        base_query.join(orm.ErrorMessage).join(orm.Microspecies).distinct().count()
    )
    logger.info(
...
def parse_argv() -> argparse.Namespace:
    ...
    summary_parser.set_defaults(func=summarize_molecular_entities)
