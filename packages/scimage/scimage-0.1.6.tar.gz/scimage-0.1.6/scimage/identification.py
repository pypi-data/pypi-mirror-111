...
def find_local_maxima_at_selected_indexes(array, selected_indexes, \
    ...
    return values_of_local_maxima, indexes_of_local_maxima, values_of_peak_points
...
def detect_sheet_regions(current_density, indexes_of_local_maxima,ratio_of_jzboundary_to_jzmax):
