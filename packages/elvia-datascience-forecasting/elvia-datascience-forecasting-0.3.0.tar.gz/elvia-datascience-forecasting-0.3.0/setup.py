...
def get_package_string(rel_path, variable_name):
    ...
    raise RuntimeError(
        f"Unable to find the {variable_name} package definition string.")
