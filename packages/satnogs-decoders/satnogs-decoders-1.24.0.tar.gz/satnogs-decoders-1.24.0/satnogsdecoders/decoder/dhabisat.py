...
class Dhabisat(KaitaiStruct):
    ...
    :field data_type: ax25_frame.payload.ax25_info.beacon_type.data_type
    :field time_stamp: ax25_frame.payload.ax25_info.beacon_type.time_stamp
    :field file_index: ax25_frame.payload.ax25_info.beacon_type.file_index
    :field interval: ax25_frame.payload.ax25_info.beacon_type.interval
    :field total_packets: ax25_frame.payload.ax25_info.beacon_type.total_packets
    :field current_packet: ax25_frame.payload.ax25_info.beacon_type.current_packet
