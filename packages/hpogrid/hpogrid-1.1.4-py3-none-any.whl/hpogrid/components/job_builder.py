...
#           lru_evict=True      
            ...
            print("--------------------------------------------------------------------------------")
            print("INFO: Begin hyperparameter optimization with the following settings")
            print("Project Name            : {}".format(self.project_name))
            print("Search Algorithm        : {}".format(self.algorithm))
            print("Trial Scheduler         : {}".format(self.scheduler))
            print("Number of Search Points : {}".format(num_samples))
            print("--------------------------------------------------------------------------------")
            analysis = tune.run(
                model,
