...
setup(
  ...
  description = 'Advanced Detection(Face and Hands) Functions',   # Give a short description about your library
  ...
  download_url = 'https://github.com/roshaan55/pycamdetector/archive/refs/tags/v_01.tar.gz',    # I explain this later on
  keywords = ['pycamdetector', 'handtracking', 'facelandmarks'],   # Keywords that define your package best
