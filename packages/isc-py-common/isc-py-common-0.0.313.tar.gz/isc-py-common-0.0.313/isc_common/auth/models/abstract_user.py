...
from django.db.models import EmailField, ManyToManyField, DateField
...
class AbstractUser(AbstractBaseUser, Crypto_file):
    username_validator = UnicodeUsernameValidator()

    birtdate = DateField(blank=True, null=True)
