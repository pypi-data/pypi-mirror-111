...
setup(
    ...
    description="Type annotations for boto3.Proton 1.17.103 service, generated by mypy-boto3-buider 4.22.1",
    classifiers=[
    ...
    keywords="boto3 proton type-annotations boto3-stubs mypy typeshed autocomplete auto-generated",
