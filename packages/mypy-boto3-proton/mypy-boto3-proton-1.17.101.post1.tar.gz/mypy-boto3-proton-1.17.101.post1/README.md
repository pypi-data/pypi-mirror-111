...
[boto3.Proton 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/proton.html#Proton)
...
def get_structure() -> AcceptEnvironmentAccountConnectionInputTypeDef:
    return {
      ...
    }
```
