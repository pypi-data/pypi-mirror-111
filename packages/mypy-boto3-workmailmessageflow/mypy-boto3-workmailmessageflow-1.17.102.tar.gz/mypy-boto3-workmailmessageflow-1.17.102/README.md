...
[boto3.WorkMailMessageFlow 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/workmailmessageflow.html#WorkMailMessageFlow)
...
def get_structure() -> GetRawMessageContentRequestTypeDef:
    return {
      ...
    }
```
