...
def main():
    ...
    fontvar = 'Cascadia Code'
    sizevar = 14
    bgvar = "white"
    fgvar = "black"
    selectbgvar = "#F9C500"
    selectfgvar = "black"
    # authorvar = Profile["authorvar"]
    # projectnamevar = Profile["projectnamevar"]
    # linkvar = Profile["linkvar"]
    ...
    def openFile(e):
        try:
            ...
            file = filedialog.askopenfilename(initialdir="C:/", title="Choose A File", filetypes=(("All Files", "*.*"),("Text Files", "*.txt"), ("Python Files", "*.py"), ("Config Files", "*.ini") ,("Ruby Files", "*.rb"), ("HTML Files", "*.html"), ("JSON Files", "*.json"), ("Javascript Files", "*.js"), ("CSS Files", "*.css"), ("Shell Files", "*.sh"), ("Batch Files", "*.bat")))
            if file:
                global openFilename
                openFilename = file
            name = file
    ...
    def saveAs(e):
        try:
            file = filedialog.asksaveasfilename(defaultextension=".*", initialdir="C:/", title="Save file as", filetypes=(("All Files", "*.*"),("Text Files", "*.txt"), ("Python Files", "*.py"), ("Config Files", "*.ini") ,("Ruby Files", "*.rb"), ("HTML Files", "*.html"), ("JSON Files", "*.json"), ("Javascript Files", "*.js"), ("CSS Files", "*.css"), ("Shell Files", "*.sh"), ("Batch Files", "*.bat")))
            if file:
                name = file
                status_bar.config(text=f'{name}  opened')
    ...
    # toolsMenu.add_command(label="Insert Profile", command=writer_profile)
