...
[boto3.Kafka 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/kafka.html#Kafka)
...
def get_structure() -> BatchAssociateScramSecretRequestTypeDef:
    return {
      ...
    }
```
