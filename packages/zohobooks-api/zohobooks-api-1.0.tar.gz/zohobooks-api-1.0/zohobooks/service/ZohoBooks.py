...
from zohobooks.api.BankAccountsApi import BankAccountsApi
from zohobooks.api.BankRulesApi import BankRulesApi
from zohobooks.api.BankTransactionsApi import BankTransactionsApi
from zohobooks.api.BaseCurrencyAdjustmentApi import BaseCurrencyAdjustmentApi
from zohobooks.api.BillsApi import BillsApi
from zohobooks.api.ChartOfAccountsApi import ChartOfAccountsApi
from zohobooks.api.ContactPersonsApi import ContactPersonsApi
from zohobooks.api.ContactsApi import ContactsApi
from zohobooks.api.CreditNotesApi import CreditNotesApi
from zohobooks.api.CustomerPaymentsApi import CustomerPaymentsApi
from zohobooks.api.EstimatesApi import EstimatesApi
from zohobooks.api.ExpensesApi import ExpensesApi
from zohobooks.api.InvoicesApi import InvoicesApi
from zohobooks.api.ItemsApi import ItemsApi
from zohobooks.api.JournalsApi import JournalsApi
from zohobooks.api.OrganizationsApi import OrganizationsApi
from zohobooks.api.ProjectsApi import ProjectsApi
from zohobooks.api.RecurringExpensesApi import RecurringExpensesApi
from zohobooks.api.RecurringInvoicesApi import RecurringInvoicesApi
from zohobooks.api.SettingsApi import SettingsApi
from zohobooks.api.UsersApi import UsersApi
from zohobooks.api.VendorPaymentsApi import VendorPaymentsApi


class ZohoBooks:
    """
    This class is used to create an object for zohobooks service and to provide instance for all APIs.
    """

    def __init__(self, authtoken, organization_id):
        """Initialize the parameters for Zoho zohobooks.
