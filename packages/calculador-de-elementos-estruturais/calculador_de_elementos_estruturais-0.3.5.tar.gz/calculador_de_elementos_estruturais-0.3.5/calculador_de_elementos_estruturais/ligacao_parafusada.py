...
class LigacaoParafusada:
    def __init__(self):
        ...
        self.fy_chapa, self.fu_chapa = request_resistencia_chapas(self.especificacao_chapa) if self.especificacao_chapa != 'Outro' else PegadorParafusada.pega_fy_e_fu()
        self.fy_chapa, self.fu_chapa = 340, 450
