...
[boto3.NimbleStudio 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/nimble.html#NimbleStudio)
...
def get_structure() -> AcceptEulasRequestTypeDef:
    return {
      ...
    }
```
