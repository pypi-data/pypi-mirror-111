...
CV2_MODELS = '{}/cv2'.format(MODELS)
TFL_MODELS = '{}/TFL'.format(MODELS)
...
def classFPS_test():
    ...
    for t in range(3):
        ...
        # fps.so_far(tabs)  # will fail on t==0
        # do_work of round t
