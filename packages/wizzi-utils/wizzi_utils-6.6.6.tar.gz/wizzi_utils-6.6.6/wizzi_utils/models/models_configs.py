...
MODELS_CONFIG = {
    ...
    'pose_landmark_full': {
        ...
        'joint_names': {
            ...
            30: 'rightHeel', 31: 'leftFoot', 32: 'rightFoot', 33: 'midHip',
            # don't think those are supported
            # 34: 'forehead',35: 'leftThumb',36: 'leftHand',37: 'rightThumb',38: 'rightHand',
        },
        'pairs_indices': [
    ...
    'openpose_pose_mpi': {
        ...
        'family': DnnFamily.Caffe.value,
        'joint_names': {
            0: 'Head', 1: 'Neck', 2: 'RShoulder', 3: 'RElbow', 4: 'RWrist', 5: 'LShoulder', 6: 'LElbow', 7: 'LWrist',
            8: 'RHip', 9: 'RKnee', 10: 'RAnkle', 11: 'LHip', 12: 'LKnee', 13: 'LAnkle', 14: 'Chest', 15: 'Background'
        },
        'pairs_indices': [
            [0, 1], [1, 2], [2, 3], [3, 4], [1, 5], [5, 6], [6, 7], [1, 14], [14, 8], [8, 9], [9, 10], [14, 11],
            [11, 12], [12, 13]
        ],
        'in_dims': (368, 368),
        'scalefactor': 1 / 255,
    ...
    'openpose_pose_coco': {
        ...
        'pairs_indices': [
            [1, 0], [1, 2], [1, 5], [2, 3], [3, 4], [5, 6], [6, 7], [1, 8], [8, 9], [9, 10], [1, 11], [11, 12],
    ...
    'body25': {
        ...
        'pairs_indices': [
            [1, 0], [1, 2], [1, 5], [2, 3], [3, 4], [5, 6], [6, 7], [0, 15], [15, 17], [0, 16], [16, 18], [1, 8],
            [8, 9], [9, 10], [10, 11], [11, 22], [22, 23], [11, 24], [8, 12], [12, 13], [13, 14], [14, 19], [19, 20],
            [14, 21]
        ],
        'in_dims': (368, 368),
        'scalefactor': 1 / 255,
