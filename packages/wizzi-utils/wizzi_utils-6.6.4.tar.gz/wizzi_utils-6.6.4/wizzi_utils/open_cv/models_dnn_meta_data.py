...
MODELS_DNN_OBJECT_DETECTION_META_DATA = {
    ...
    'opencv_face_detector': {
        ...
        'URL': {
            ...
            'info2': 'https://www.pyimagesearch.com/2018/02/26/face-detection-with-opencv-and-deep-learning/',
        },
        'info': {
            'web_name': 'res10_300x300_ssd_iter_140000',
            'size': 'caffemodel({}), prototxt({})'.format(mt.add_color('10.17 MB', ops='c'),
                                                          mt.add_color('27.45 KB', ops='c')),
...
MODELS_OPEN_POSE_META_DATA = {
    'openpose_pose_mpi': {
        ...
        'threshold': 0.1,
        'URL': {
            'prototxt': 'https://raw.githubusercontent.com/CMU-Perceptual-Computing-Lab/openpose/master/models/' +
        ...
        'info': {
            ...
            'size': 'caffemodel({}), prototxt({})'.format(mt.add_color('196.41 MB', ops='c'),
                                                          mt.add_color('45.83 KB', ops='c')),
            'fps': 'TODO {}'.format(fps_info),
    ...
    'openpose_pose_coco': {
        ...
        'threshold': 0.1,
        'URL': {
            'prototxt': 'https://raw.githubusercontent.com/CMU-Perceptual-Computing-Lab/openpose/master/models/pose/' +
        ...
        'info': {
            ...
            'size': 'caffemodel({}), prototxt({})'.format(mt.add_color('199.58 MB', ops='c'),
                                                          mt.add_color('45.78 KB', ops='c')),
            'fps': 'TODO {}'.format(fps_info),
            'info': 'TODO',
        },
    },
    'body25': {
        ...
        'threshold': 0.1,
        'URL': {
            'prototxt': 'https://raw.githubusercontent.com/CMU-Perceptual-Computing-Lab/' +
                        'openpose/master/models/pose/body_25/pose_deploy.prototxt',
            'caffemodel': 'http://posefs1.perception.cs.cmu.edu/OpenPose/models/pose/body_25/' +
        ...
        'info': {
            ...
            'size': 'caffemodel({}), prototxt({})'.format(mt.add_color('99.86 MB', ops='c'),
                                                          mt.add_color('41.34 KB', ops='c')),
            'fps': 'TODO {}'.format(fps_info),
            'info': 'TODO',
        },
    },
    'hand_pose': {
        ...
        'URL': {
            ...
            'caffemodel': 'http://posefs1.perception.cs.cmu.edu/OpenPose/models/hand/pose_iter_102000.caffemodel',
            'prototxt_download_style': DownloadStyle.Direct.value,
            'caffemodel_download_style': DownloadStyle.Direct.value,
        ...
        'info': {
            ...
            'size': 'caffemodel({}), prototxt({})'.format(mt.add_color('140.52 MB', ops='c'),
                                                          mt.add_color('25.83 KB', ops='c')),
            'fps': 'TODO {}'.format(fps_info),
            'info': 'TODO',
        },
    },
