...
[boto3.EMRContainers 1.17.102](https://boto3.amazonaws.com/v1/documentation/api/1.17.102/reference/services/emr-containers.html#EMRContainers)
...
def get_structure() -> CancelJobRunRequestTypeDef:
    return {
      ...
    }
```
