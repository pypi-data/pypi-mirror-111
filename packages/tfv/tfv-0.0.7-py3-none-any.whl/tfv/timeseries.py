...
class FvTimeSeries(TimeSeries):
    ...
    def get_data(self, variable, site, datum='sigma', limits=(0, 1)):
        ...
        dims = self.nc[site][variable].dimensions
        ...
        elif dims[-1] != 'time':  # Data is 1D in z but has 2 dims (e.g. BED_MASS (time, SEDIMENT_FRACTION))
            print("Warning: Data is a 1D variable with a secondary dimension: {0}".format(dims[-1]))
