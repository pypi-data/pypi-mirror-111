...
with elapsed_timer() as elapsed:
    ...
    sherlock.explore_object("TIC 206584346", auto_detrend_periodic_signals=False, smooth=False,
                            input_lc_file="TIC206584346_zoom/P5.500000000000001_R5.0_1355.4516558948574.csv", cadence=1800)
