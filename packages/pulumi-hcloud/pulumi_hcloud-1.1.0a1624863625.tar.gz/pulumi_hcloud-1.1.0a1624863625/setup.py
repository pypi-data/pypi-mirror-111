...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '1.1.0-alpha.1624863625+9be44fbf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 1.1.0-alpha.1624863625+9be44fbf`
                """)
            else:
                raise
