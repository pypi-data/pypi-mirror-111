...
def CollectionProperty(type=None,
                       ...
                       description: str = "",
                       options: set = {'ANIMATABLE'},
                       tags: set = {}) -> 'bpy.types.CollectionProperty':
