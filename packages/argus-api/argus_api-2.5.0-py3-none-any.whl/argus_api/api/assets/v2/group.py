...
def reindex_asset_group(
    ...
    """Re-indexes specified Asset Groups (DEV)
    
    :param list groupID: A set of asset group IDs to be re-indexed 
    :param str recursive: Enumerated type of chosen recursivity (none - reindex just asset groups, asset - reindex asset groups and associated assets, all - reindex asset groups, associated assets and vulnerabilities, asset groups also include their children groups, default: none) 
    :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
