...
def simple_search(
    ...
    :param list tlp: A set of TLP criteria to apply to submissions, analyses, and links 
    ...
    :param int startTimestamp: Restrict the search to resources (indicated by timeFieldStrategy) timestamped after this timestamp 
    :param int endTimestamp: Restrict the search to resources (indicated by timeFieldStrategy) timestamped before this timestamp 
    :param int indexStartTimestamp: Restrict search to data after this time (default now - 1 month)
    :param int indexEndTimestamp: Restrict search to data before this time (default now)
    ...
    # Only send classification if the argument was provided, dont send null values
    if classification is not None:
        body.update({"classification": classification})
    # Only send submission if the argument was provided, dont send null values
    ...
    # Only send userMatchStrategy if the argument was provided, dont send null values
    if userMatchStrategy is not None:
        body.update({"userMatchStrategy": userMatchStrategy})
    # Only send tlp if the argument was provided, dont send null values
    if tlp is not None:
        body.update({"tlp": tlp})
    # Only send analysis if the argument was provided, dont send null values
    if analysis is not None:
        body.update({"analysis": analysis})
    # Only send link if the argument was provided, dont send null values
    if link is not None:
