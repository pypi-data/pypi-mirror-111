...
def create_prepared_case(
    ...
    """Create a prepared case. This finalizes the creation of the case prepared using /case/prepare (DEV)
...
def prepare_case(
    ...
    """Prepare a new case object, to allow adding collections before properly creating it (DEV)
...
def update_case(
    ...
    body = body or {}
    # Only send customerDueTimestamp if the argument was provided, dont send null values
    if customerDueTimestamp is not None:
        body.update({"customerDueTimestamp": customerDueTimestamp})
    # Only send techDueTimestamp if the argument was provided, dont send null values
