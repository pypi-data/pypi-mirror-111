...
def reindex_asset(
    ...
    """Re-indexes specified Assets (DEV)
    
    :param list assetID: A set of asset IDs to be re-indexed 
    :param str recursive: Enumerated type of chosen recursivity (none - reindex just assets, all - reindex assets and associated vulnerabilities, default: none) 
    :param json:
    :param verify: path to a certificate bundle or boolean indicating whether SSL
    verification should be performed.
    :param apiKey: Argus API key.
