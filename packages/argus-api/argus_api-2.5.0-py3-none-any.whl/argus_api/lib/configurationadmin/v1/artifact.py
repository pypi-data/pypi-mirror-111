...
def download_code_artifact_by_g_a_v(
    groupID: str,
    artifactID: str,
    version: str,
    json: bool = True,
...
def get_code_artifact_by_g_a_v(
    groupID: str,
    artifactID: str,
    version: str,
...
#: "download_by_g_a_v" is an alias for "download_code_artifact_by_g_a_v"
download_by_g_a_v = deprecated_alias("download_by_g_a_v")(download_code_artifact_by_g_a_v)
...
#: "get_by_g_a_v" is an alias for "get_code_artifact_by_g_a_v"
get_by_g_a_v = deprecated_alias("get_by_g_a_v")(get_code_artifact_by_g_a_v)
