...
def add_mitre_category_relationship(
    ...
    :param str idOrExtIdOrShortName: ID\, ExtID or short name of source MITRE category
    :param str externalId: External ID of the MITRE category relationship 
    :param str targetCategory: ID\, external ID or short name of the target MITRE category 
    ...
    route = "/alarms/v1/mitre/{idOrExtIdOrShortName}/relations".format(idOrExtIdOrShortName=idOrExtIdOrShortName)
    ...
    if externalId is not None:
        body.update({"externalId": externalId})
    # Only send targetCategory if the argument was provided, dont send null values
...
def delete_mitre_category_relationship(
    ...
    :param str idOrExtId: ID or ExtID of MITRE category relationship
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def get_mitre_category_relationship(
    ...
    """Gets an existing MITRE category relationship (DEV)
...
def list_mitre_category_relationships(
    ...
    :param str idOrExtIdOrShortName: ID\, ExtID or short name of source or target MITRE category
    :param bool includeDeleted: To include deleted MITRE category relationships or not \(not included by default\)
    :param list sortBy: Field\(s\) to sort results by \(without sign is ascending\, with \'\-\' sign is descending\)
    :param int limit: The max amount of items to return \(25 by default\, 0 means no limit\)
    :param int offset: The amount of items to skip from the beginning \(0 by default\)
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
