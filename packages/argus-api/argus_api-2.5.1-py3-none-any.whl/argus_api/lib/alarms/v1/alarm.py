...
def add_alarm_mitre_relationship(
    ...
    """Adds a new relationship between alarm and MITRE category (DEV)
    
    :param str idOrShortName: ID or short name of alarm
    :param str mitreCategory: ID\, external ID or short name of the MITRE category 
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
    ...
    body = body or {}
    # Only send mitreCategory if the argument was provided, dont send null values
...
def delete_alarm_mitre_relationship(
    ...
    """Deletes an existing relationship between alarm and MITRE category (DEV)
    ...
    route = "/alarms/v1/alarm/{idOrShortName}/mitre/{idOrExtIdOrShortName}".format(idOrShortName=idOrShortName,
        idOrExtIdOrShortName=idOrExtIdOrShortName)
...
def list_alarm_mitre_relationships(
    ...
    """List relationships between alarm and MITRE category (DEV)
...
def update_alarm(
    ...
    :param int id: ID of Alarm
    :param str shortName: Update short name of the alarm  \=\> \[a\-zA\-Z0\-9\_\\\-\\.\]\*
