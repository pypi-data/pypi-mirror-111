...
class LocalPorvider(BaseProvider):
    ...
    def col_oriented_index(self,univ = "all",start_date = 20070101,end_date = 2007):
        """
    ...
    def daily_barra_dly_data(self,instruments:list,fields:list,start_date:str,end_date:str):
        """
    ...
    def suntime_repofc_stk_tc(self,instruments = None,start_date = None,end_date = None):
        """
            table_name: 'RPT_FORECAST_STK_TC'
        """
        return CDP.suntime_repofc_stk_tc(instruments,start_date,end_date)
    
    def suntime_earning_adj(self,instruments = None,start_date = None,end_date = None):
        """
            table_name: 'RPT_EARNINGS_ADJUST'
        """
        return CDP.suntime_earning_adj(instruments,start_date,end_date)
