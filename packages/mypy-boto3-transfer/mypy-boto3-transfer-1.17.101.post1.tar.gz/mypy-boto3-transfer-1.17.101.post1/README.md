...
[boto3.Transfer 1.17.101](https://boto3.amazonaws.com/v1/documentation/api/1.17.101/reference/services/transfer.html#Transfer)
...
def get_structure() -> CreateAccessRequestTypeDef:
    return {
      ...
    }
```
